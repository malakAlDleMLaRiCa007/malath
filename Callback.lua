...
if plugin and plugin.Themalath and msg then
results = plugin.Themalath(msg)
end
end
...
if data.actor_user_id == UserCheck and tonumber(Themalath) ~= UserCheck then
local Get_Chat = bot.getChat(data.chat_id)
local Info_Chats = bot.getSupergroupFullInfo(data.chat_id)
local UserInfo = bot.getUser(data.actor_user_id)
...
if not Redis:get(Themalath.."gdbye"..data.chat_id) then
if data.actor_user_id == UserCheck and tonumber(Themalath) ~= UserCheck then
local Get_Chat = bot.getChat(data.chat_id)
local Info_Chats = bot.getSupergroupFullInfo(data.chat_id)
local UserInfo = bot.getUser(data.actor_user_id)
...
if data.new_chat_member.member_id.user_id == tonumber(Themalath) or data.old_chat_member.member_id.user_id == tonumber(Themalath) then
...
--code start
if Redis:sismember(Themalath..'Black:listBan:',chat_id) then ---check if ban
...
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Themalath..'malath:Num:Add:Bot') or 0)) then
send(chat_id,0,'• عدد الاعضاء قليل لا يمكن تفعيل القروب\n يجب ان يكون اكثر من '..Redis:get(Themalath..'malath:Num:Add:Bot'),"md",true)
bot.leaveChat(chat_id)
...
if not Redis:sismember(Themalath.."malath:ChekBotAdd", chat_id) then ---done active
...
-----
Redis:set(Themalath.."malath:Alzwag:Chat"..chat_id,"true")
Redis:set(Themalath.."malath:Aldel:Chat"..chat_id,"true")
Redis:set(Themalath.."NSFW:"..chat_id,"true")
Redis:set(Themalath..'tagallgroup'..chat_id,'open') 
Redis:set(Themalath.."malath:Status:Link"..chat_id,true) 
Redis:set(Themalath.."malath:Status:Games"..chat_id,true) 
Redis:set(Themalath.."replayallbot"..chat_id,true)
Redis:set(Themalath.."rebomsg"..chat_id,true)
Redis:set(Themalath.."malath:AlThther:Chat"..chat_id,"true")
Redis:set(Themalath.."malath:Status:Welcome"..chat_id,true) 
Redis:set(Themalath.."malath:AlThther:Chat"..chat_id,"true")
Redis:set(Themalath..'tagall@all'..chat_id,'open') 
Redis:set(Themalath.."malath:Status:IdPhoto"..chat_id,true) 
Redis:del(Themalath.."spammkick"..chat_id)
Redis:set(Themalath.."malath:Lock:edit"..chat_id,true) 
Redis:sadd(Themalath.."malath:ChekBotAdd",chat_id)
Redis:set(Themalath.."malath:Status:Id"..chat_id,true)
Redis:set(Themalath.."malath:Status:Reply"..chat_id,true)
Redis:set(Themalath.."malath:Status:ReplySudo"..chat_id,true)
Redis:set(Themalath.."malath:Status:BanId"..chat_id,true)
Redis:set(Themalath.."malath:Status:SetId"..chat_id,true) 
-----
...
Redis:sadd(Themalath.."malath:TheBasicsQ:Group"..chat_id ,v.member_id.user_id) 
else
Redis:sadd(Themalath.."malath:Addictive:Group"..chat_id ,v.member_id.user_id) 
end
end
end
-----
...
local inget = Redis:get(Themalath..'hmsabots'..ramsesadd[3]..data.sender_user_id)
...
Redis:set(Themalath..'hmsabots'..idnum..UserId_Info.id,username[1])
Redis:set(Themalath..'hmsabots'..idnum..data.sender_user_id,username[1])
end
end
end
...
Redis:sadd(Themalath.."malath:all:sticker"..msg.chat_id, msg.id)
Redis:scard(Themalath.."malath:all:sticker"..msg.chat_id)  
end
if msg.content.video_note or msg.content.video then
Redis:sadd(Themalath.."malath:all:video"..msg.chat_id, msg.id)
Redis:scard(Themalath.."malath:all:video"..msg.chat_id)  
end
if msg.content.document then
Redis:sadd(Themalath.."malath:all:docu"..msg.chat_id, msg.id)
Redis:scard(Themalath.."malath:all:docu"..msg.chat_id)  
end
if msg.content.audio then
Redis:sadd(Themalath.."malath:all:audio"..msg.chat_id, msg.id)
Redis:scard(Themalath.."malath:all:audio"..msg.chat_id)  
end
if msg.content.voice_note then
Redis:sadd(Themalath.."malath:all:voice"..msg.chat_id, msg.id)
Redis:scard(Themalath.."malath:all:voice"..msg.chat_id)  
end
if msg.content.photo then
Redis:sadd(Themalath.."malath:all:photo"..msg.chat_id, msg.id)
Redis:scard(Themalath.."malath:all:photo"..msg.chat_id)  
end
if msg.content.animation then
Redis:sadd(Themalath.."malath:all:anim"..msg.chat_id, msg.id)
Redis:scard(Themalath.."malath:all:anim"..msg.chat_id)  
end
...
local Numbardel = Redis:get(Themalath.."malath:allM:numdel"..msg.chat_id) or 200
...
if tonumber(data.message.sender_user_id) == tonumber(Themalath) then
return false
end
if chat_type(data.message.chat_id) == "GroupBot" and Redis:sismember(Themalath.."malath:ChekBotAdd",data.message.chat_id) then
 msg = data.message
...
if tonumber(msg.sender_id.user_id) == tonumber(Themalath) then
print('This is reply for Bot')
return false
end
if msg.sender_id.luatele == "messageSenderChat" then
if Redis:sismember(Themalath.."malath:SilentGroup:Group"..msg_chat_id,msg.sender_id.chat_id) then
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
end
if Redis:get(Themalath.."malath:Lock:SenderChat"..msg_chat_id) then
local m = Redis:get(Themalath.."chadmin"..msg_chat_id) 
...
elseif Redis:sismember(Themalath.."malath:DevelopersQ:Groups",msg.sender_id.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'Myth🎖️️'
elseif Redis:sismember(Themalath.."malath:Developers:Groups",msg.sender_id.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(Themalath..'malath:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Themalath.."malath:Developer:Bot:Reply"..msg.chat_id) or 'Myth'
elseif Redis:sismember(Themalath.."malath:MalekAsase:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 444
msg.Name_Controller = Redis:get(Themalath..'malath:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Themalath.."malath:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(Themalath.."malath:TheBasicsQ:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(Themalath..'malath:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Themalath.."malath:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(Themalath.."malath:TheBasics:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(Themalath..'malath:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Themalath.."malath:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(Themalath.."malath:Originators:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(Themalath..'malath:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Themalath.."malath:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ'
elseif Redis:sismember(Themalath.."malath:Managers:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(Themalath..'malath:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Themalath.."malath:Manager:Group:Reply"..msg.chat_id) or 'المدير'
elseif Redis:sismember(Themalath.."malath:Addictive:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(Themalath..'malath:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Themalath.."malath:Admin:Group:Reply"..msg.chat_id) or 'الادمن'
elseif Redis:sismember(Themalath.."malath:Distinguished:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(Themalath..'malath:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Themalath.."malath:Vip:Group:Reply"..msg.chat_id) or 'مميز'
elseif tonumber(msg.sender_id.user_id) == tonumber(Themalath) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(Themalath..'malath:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Themalath.."malath:Mempar:Group:Reply"..msg.chat_id) or 'عضو'
end  
...
if Message_Edit.sender_id.user_id == Themalath then
...
data.The_Controller = 1
elseif Redis:sismember(Themalath.."malath:DevelopersQ:Groups",Message_Edit.sender_id.user_id) == true then
data.The_Controller = 2
elseif Redis:sismember(Themalath.."malath:Developers:Groups",Message_Edit.sender_id.user_id) == true then
data.The_Controller = 3
elseif Redis:sismember(Themalath.."malath:TheBasicsQ:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 44
elseif Redis:sismember(Themalath.."malath:TheBasics:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 4
elseif Redis:sismember(Themalath.."malath:Originators:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 5
elseif Redis:sismember(Themalath.."malath:Managers:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 6
elseif Redis:sismember(Themalath.."malath:Addictive:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 7
elseif Redis:sismember(Themalath.."malath:Distinguished:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 8
elseif tonumber(Message_Edit.sender_id.user_id) == tonumber(Themalath) then
...
local monsha = Redis:smembers(Themalath.."malath:TheBasicsQ:Group"..data.chat_id) 
Redis:incr(Themalath..'malath:Num:Message:Edit'..data.chat_id..Message_Edit.sender_id.user_id)
if Message_Edit.content.luatele == "messageText" then
if Redis:get(Themalath.."malath:Lock:edittext"..data.chat_id) then
if not data.Distinguished then
bot.deleteMessages(data.chat_id,{[1]= data.message_id})
if Redis:get(Themalath..'malath:AlThther:Chat'..data.chat_id)  then
local UserInfo = bot.getUser(Message_Edit.sender_id.user_id)
...
if not data.Originators and Message_Edit.sender_id.user_id ~= tonumber(Themalath) then
...
data.The_Controller = 1
elseif Redis:sismember(Themalath.."malath:DevelopersQ:Groups",IdUser) == true then
data.The_Controller = 2
elseif Redis:sismember(Themalath.."malath:Developers:Groups",IdUser) == true then
data.The_Controller = 3
elseif Redis:sismember(Themalath.."malath:TheBasicsQ:Group"..ChatId,IdUser) == true then
data.The_Controller = 44
elseif Redis:sismember(Themalath.."malath:TheBasics:Group"..ChatId,IdUser) == true then
data.The_Controller = 4
elseif Redis:sismember(Themalath.."malath:Originators:Group"..ChatId,IdUser) == true then
data.The_Controller = 5
elseif Redis:sismember(Themalath.."malath:Managers:Group"..ChatId,IdUser) == true then
data.The_Controller = 6
elseif Redis:sismember(Themalath.."malath:Addictive:Group"..ChatId,IdUser) == true then
data.The_Controller = 7
elseif Redis:sismember(Themalath.."malath:Distinguished:Group"..ChatId,IdUser) == true then
data.The_Controller = 8
elseif tonumber(IdUser) == tonumber(Themalath) then
data.The_Controller = 9
else
data.The_Controller = 10
end  
...
local get = Redis:get(Themalath..IdUser..ChatId.."num")
if get then
tf = get 
else
tf = "" 
...
local txx = tf..num
Redis:set(Themalath..IdUser..ChatId.."num",txx)
...
if tonumber(IdUser) == tonumber(sendrr) then
local math = Redis:get(Themalath..IdUser..ChatId.."num")
if math then
...
Redis:del(Themalath..IdUser..ChatId.."num")
else
bot.answerCallbackQuery(data.id, "• الامر لا يخصك", true)
end
end
...
Redis:set(Themalath..IdUser..ChatId.."num",gxx)
...
local chat_id = Redis:get(Themalath.."hms:"..anubis[2].."chat_id")
local to_id = Redis:get(Themalath.."hms:"..anubis[2].."to")
local msg_id = Redis:get(Themalath.."hms:"..anubis[2].."msg_id")
...
Redis:del(Themalath.."hms:"..anubis[1])
end
end
if Text and Text:match('(.*)hms_no(.*)') then
local anubis = {Text:match('(.*)hms_no(.*)')}
if tonumber(IdUser) == tonumber(anubis[1]) then
Redis:del(Themalath.."hms:"..anubis[2].."chat_id")
Redis:del(Themalath.."hms:"..anubis[2].."to")
Redis:del(Themalath.."hms:"..anubis[2].."msg_id")
Redis:del(Themalath.."hms:"..anubis[1])
...
local hmsa = Redis:get(Themalath.."hms:"..anubis[3].."text:")
...
var(UserId)
Redis:set(Themalath.."zogte"..ChatId..UserId[1],UserId[2])
Redis:set(Themalath.."zogte"..ChatId..UserId[2],UserId[1])
Redis:sadd(Themalath.."zogatall"..ChatId,UserId[1])
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:del(Themalath.."zogte"..ChatId..UserId[1])
Redis:del(Themalath.."zogte"..ChatId..UserId[2])
Redis:srem(Themalath.."zogatall"..ChatId,UserId[1])
local UserInfo = bot.getUser(UserId[1])
...
Redis:srem(Themalath.."malath:Distinguished:Group"..ChatId,IdUser)
Redis:srem(Themalath.."malath:Addictive:Group"..ChatId,IdUser)
Redis:srem(Themalath.."malath:Managers:Group"..ChatId,IdUser)
Redis:srem(Themalath.."malath:Originators:Group"..ChatId,IdUser)
Redis:srem(Themalath.."malath:TheBasics:Group"..ChatId,IdUser)
Redis:srem(Themalath.."malath:Developers:Groups",IdUser) 
Redis:srem(Themalath.."malath:TheBasicsQ:Group"..ChatId,IdUser)
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Themalath.."malath:TheBasics:Group"..ChatId,UserId[2]) then
Redis:srem(Themalath.."malath:TheBasics:Group"..ChatId,UserId[2])
else
Redis:sadd(Themalath.."malath:TheBasics:Group"..ChatId,UserId[2])
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then 
if Redis:sismember(Themalath.."malath:Originators:Group"..ChatId,UserId[2]) then
Redis:srem(Themalath.."malath:Originators:Group"..ChatId,UserId[2])
else
Redis:sadd(Themalath.."malath:Originators:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Themalath.."malath:Managers:Group"..ChatId,UserId[2]) then
Redis:srem(Themalath.."malath:Managers:Group"..ChatId,UserId[2])
else
if not data.Originators and not Redis:get(Themalath.."malath:Status:SetId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ تم تعطيل ( الرفع ) من قبل المنشئين",true)
end 
Redis:sadd(Themalath.."malath:Managers:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Themalath.."malath:Addictive:Group"..ChatId,UserId[2]) then
Redis:srem(Themalath.."malath:Addictive:Group"..ChatId,UserId[2])
else
if not data.Originators and not Redis:get(Themalath.."malath:Status:SetId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ تم تعطيل ( الرفع ) من قبل المنشئين",true)
end 
Redis:sadd(Themalath.."malath:Addictive:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Themalath.."malath:Distinguished:Group"..ChatId,UserId[2]) then
Redis:srem(Themalath.."malath:Distinguished:Group"..ChatId,UserId[2])
else
if not data.Originators and not Redis:get(Themalath.."malath:Status:SetId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ تم تعطيل ( الرفع ) من قبل المنشئين",true)
end 
Redis:sadd(Themalath.."malath:Distinguished:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:srem(Themalath.."malath:Originators:Group"..ChatId,UserId[2])
Redis:srem(Themalath.."malath:TheBasics:Group"..ChatId,UserId[2])
Redis:srem(Themalath.."malath:SilentGroup:Group"..ChatId,UserId[2])
Redis:srem(Themalath.."malath:BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(Themalath.."malath:BanGroup:Group"..ChatId,UserId[2]) then
Redis:srem(Themalath.."malath:BanGroup:Group"..ChatId,UserId[2])
bot.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
else
if not data.Originators and not Redis:get(Themalath.."malath:Status:BanId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ ( الحظر - الطرد - التقييد ) معطل من قبل المنشئين",true)
end 
Redis:sadd(Themalath.."malath:BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(Themalath.."malath:SilentGroup:Group"..ChatId,UserId[2]) then
Redis:srem(Themalath.."malath:SilentGroup:Group"..ChatId,UserId[2])
else
if not data.Originators and not Redis:get(Themalath.."malath:Status:BanId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ ( الحظر - الطرد - التقييد ) معطل من قبل المنشئين",true)
end 
Redis:sadd(Themalath.."malath:SilentGroup:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
if Text and Text:match('/keyhzr') then
local list = Redis:smembers(Themalath..'List_hzr'..ChatId) 
nameko = list[#list]
playerhzr = Redis:get(Themalath..'playerhzr'..ChatId)
klmahzr = Redis:get(Themalath..'klmahzr'..ChatId)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Themalath.."malath:Command:Reids:Group:Del"..ChatId..":"..IdUser)
Redis:del(Themalath.."malath:Command:Reids:Group"..ChatId..":"..IdUser)
Redis:del(Themalath.."malath:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Themalath.."malath:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Themalath.."malath:Set:Rd"..IdUser..":"..ChatId)
Redis:del(Themalath.."malath:Set:On"..IdUser..":"..ChatId)
Redis:del(Themalath.."Set:array:Ssd"..IdUser..":"..ChatId)
Redis:del(Themalath.."Set:array:rd"..IdUser..":"..ChatId)
Redis:del(Themalath.."Set:array"..IdUser..":"..ChatId)
Redis:del(Themalath.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Themalath.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Themalath.."Set:Rd"..IdUser..":"..ChatId)
Redis:del(Themalath.."Set:On"..IdUser..":"..ChatId)
Redis:del(Themalath.."Set:Manager:rd:inline"..IdUser..":"..ChatId)
Redis:del(Themalath.."Set:On:mz"..IdUser..":"..ChatId)
Redis:del(Themalath.."Set:Rd:mz"..IdUser..":"..ChatId)
Redis:del(Themalath.."Set:Onmzch"..IdUser..":"..ChatId)
Redis:del(Themalath.."Set:Rdmzch"..IdUser..":"..ChatId)
Redis:del(Themalath.."Set:Manager:rd:inline3am"..IdUser..":"..ChatId)
...
if Redis:get(Themalath..'Set:arrayy'..IdUser..':'..ChatId) == 'true1' then
Redis:del(Themalath..'Set:arrayy'..IdUser..':'..ChatId)
...
if Redis:get(Themalath..'Set:array'..IdUser..':'..ChatId) == 'true1' then
Redis:del(Themalath..'Set:array'..IdUser..':'..ChatId)
edit(ChatId,Msg_id,"⇜ تم حفظ الردود ", 'md', true, false, reply_markup)
else
edit(ChatId,Msg_id,"⇜ تم تنفيذ الامر سابقاًً", 'md', true, false, reply_markup)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Themalath.."trfeh"..ChatId)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Themalath.."spammkick"..ChatId)
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Themalath.."kadmeat"..ChatId)
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Themalath.."knele"..ChatId)
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Themalath.."brjj"..ChatId)
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Themalath..'lock_geamsAudio1'..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Themalath..'lock_geamsAudio'..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Themalath..'tagall@all'..ChatId,'open')
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Themalath..'lock_chengname'..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Themalath.."trfeh"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Themalath.."spammkick"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Themalath.."kadmeat"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Themalath.."knele"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Themalath.."brjj"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Themalath..'lock_geamsAudio1'..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Themalath..'lock_geamsAudio'..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Themalath..'tagall@all'..ChatId,'close')
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Themalath..'lock_chengname'..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
Redis:incrby(Themalath.."malath:Num:Add:Games"..ChatId..IdUser,3)  
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(Themalath.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(Themalath.."meza:type"..meza_name, "photo")
Redis:sadd(Themalath.."meza:names:", meza_name)
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(Themalath.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(Themalath.."meza:type"..meza_name, "video")
Redis:sadd(Themalath.."meza:names:", meza_name)
return edit(ChatId, Msg_id, "⇜ تم حفظ الميزة","md",false)
end end
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(Themalath.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(Themalath.."meza:type"..meza_name, "audio")
Redis:sadd(Themalath.."meza:names:", meza_name)
return edit(ChatId, Msg_id, "⇜ تم حفظ الميزة","md",false)
end end
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(Themalath.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(Themalath.."meza:type"..meza_name, "animation")
Redis:sadd(Themalath.."meza:names:", meza_name)
return edit(ChatId, Msg_id, "⇜ تم حفظ الميزة","md",false)
end end
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(Themalath.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(Themalath.."meza:type"..meza_name, "sticker")
Redis:sadd(Themalath.."meza:names:", meza_name)
return edit(ChatId, Msg_id, "⇜ تم حفظ الميزة","md",false)
end end
if Text == '/joineloceagin' then
local list = Redis:smembers(Themalath..'loce:list'..ChatId) 
...
Redis:set(Themalath..'loce:listset1'..ChatId,xxffxx1)
Redis:srem(Themalath..'loce:list'..ChatId,name1)
Redis:incrby(Themalath.."malath:Num:Add:Games"..ChatId..name1,3)  
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local get1 = Redis:get(Themalath..'loce:listset'..ChatId)
local get2 = Redis:get(Themalath..'loce:listset1'..ChatId)

Redis:del(Themalath..'loce:list'..ChatId) 
Redis:del(Themalath..'loce:listset'..ChatId)
Redis:del(Themalath..'loce:listset1'..ChatId)
return edit(ChatId,Msg_id,get1..'\n'..get2..'\n'..xxffxx1..'\n', 'md', true)
end
if Text == '/joineloce' then
if not Redis:sismember(Themalath..'loce:list'..ChatId,IdUser) then 
Redis:sadd(Themalath..'loce:list'..ChatId,IdUser)
local list = Redis:smembers(Themalath..'loce:list'..ChatId) 
if #list == 3 then
name1 = list[math.random(#list)]
local UserInfo1 = bot.getUser(name1)
...
Redis:set(Themalath..'loce:listset'..ChatId,xxffxx1)
Redis:srem(Themalath..'loce:list'..ChatId,name1)
Redis:incrby(Themalath.."malath:Num:Add:Games"..ChatId..name1,5)  
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local list = Redis:smembers(Themalath..'rolet:list'..ChatId)
name = list[math.random(#list)]
local UserInfo = bot.getUser(name)
local Teext = '- ['..UserInfo.first_name..'](tg://user?id='..name..')'
Redis:srem(Themalath..'rolet:list'..ChatId,name)
if #list == 1 then
Redis:srem(Themalath..'rolet:list'..ChatId,name)
Redis:incrby(Themalath.."malath:Num:Add:Games"..ChatId..IdUser,10)  
...
if not Redis:sismember(Themalath..'rolet:list'..ChatId,IdUser) then 
Redis:sadd(Themalath..'rolet:list'..ChatId,IdUser)
local list = Redis:smembers(Themalath..'rolet:list'..ChatId) 
if #list == 3 then
...
Redis:sadd(Themalath.."malath:SilentGroup:Group"..ChatId,GetUserReply[1]) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local UserInfo = bot.getUser(GetUserReply[1])
local Teext = ' ['..UserInfo.first_name..'](tg://user?id='..GetUserReply[1]..')'
Redis:sadd(Themalath.."malath:BanGroup:Group"..ChatId,GetUserReply[1]) 
...
Redis:srem(Themalath.."malath:Distinguished:Group"..ChatId,GetUserReply[1]) 
...
Redis:srem(Themalath.."malath:BanGroup:Group"..ChatId,GetUserReply[1]) 
Redis:srem(Themalath.."malath:SilentGroup:Group"..ChatId,GetUserReply[1]) 
...
if Redis:sismember(Themalath.."malath:Num:okiktm"..ChatId, IdUser) then
return bot.answerCallbackQuery(data.id, "⇜ قمت بالتصويت مسبقاً", true)
end
Redis:sadd(Themalath.."malath:Num:okiktm"..ChatId, IdUser)  
local list = Redis:smembers(Themalath.."malath:Num:okiktm"..ChatId)
if #list >= tonumber(3) then
Redis:del(Themalath.."malath:Num:okiktm"..ChatId)
...
Redis:sadd(Themalath.."malath:SilentGroup:Group"..ChatId,GetUserReply) 
end
...
local UserInfo = bot.getUser(GetUserReply)
local Teext = ' ['..UserInfo.first_name..'](tg://user?id='..GetUserReply..')'
if Redis:sismember(Themalath.."malath:Num:noiktm"..ChatId, IdUser) then
return bot.answerCallbackQuery(data.id, "⇜ قمت بالتصويت مسبقاً", true)
end
Redis:sadd(Themalath.."malath:Num:noiktm"..ChatId, IdUser)  
local list = Redis:smembers(Themalath.."malath:Num:noiktm"..ChatId)
if #list >= tonumber(3) then
Redis:del(Themalath.."malath:Num:noiktm"..ChatId)
Redis:srem(Themalath.."malath:SilentGroup:Group"..ChatId,GetUserReply) 
...
if Text and Text:match('(.*)/yes_z/(.*)') then
  ...
  if tonumber(zwga_id) == tonumber(IdUser) then
    ...
    Redis:set(Themalath..ChatId..zwga_id.."mtzwga:", zwg_id)
    Redis:set(Themalath..ChatId..zwg_id.."mtzwga:", zwga_id)
...
if Text and Text:match('(%d+)/zeng') then
  ...
  if tonumber(UserId) == tonumber(IdUser) then
    Redis:set(Themalath..ChatId..IdUser.."zkrf:", "zeng")
...
if Redis:get(Themalath.."zwag_request:"..Data[1]) then
...
ballancee = Redis:get(Themalath.."boob"..zwg_id) or 0
ballanceea = Redis:get(Themalath.."boob"..zwga_id) or 0
zogtea = ballanceea + ballanceekkk
zeugh = ballancee - tonumber(coniss)
Redis:set(Themalath.."boob"..zwg_id , math.floor(zeugh))
Redis:sadd(Themalath.."roogg1",zwg_id)
Redis:sadd(Themalath.."roogga1",zwga_id)
Redis:set(Themalath.."roog1"..zwg_id,zwg_id)
Redis:set(Themalath.."rooga1"..zwg_id,zwga_id)
Redis:set(Themalath.."roogte1"..zwga_id,zwga_id)
Redis:set(Themalath.."rahr1"..zwg_id,tonumber(coniss))
Redis:set(Themalath.."rahr1"..zwga_id,tonumber(coniss))
Redis:set(Themalath.."roog1"..zwga_id,zwg_id)
Redis:set(Themalath.."rahrr1"..zwg_id,math.floor(ballanceekkk))
Redis:set(Themalath.."rooga1"..zwga_id,zwga_id)
Redis:set(Themalath.."rahrr1"..zwga_id,math.floor(ballanceekkk))
...
Redis:del(Themalath.."zwag_request:"..UserId[1])
Redis:del(Themalath.."zwag_request:"..UserId[2])
...
Redis:set(Themalath..data.sender_user_id.."first_name:", F_Name)
...
ballancee = Redis:get(Themalath.."tabbroat"..data.sender_user_id) or 0
...
zrfee = Redis:get(Themalath.."rrfff"..data.sender_user_id) or 0
...
ballancee = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
doltebank = "🇸🇾"
Redis:set(Themalath.."doltebank"..data.sender_user_id,doltebank)
cccall = Redis:get(Themalath.."boobb"..data.sender_user_id)
ccctype = Redis:get(Themalath.."bbobb"..data.sender_user_id)
shakse = Redis:get(Themalath.."shkse"..data.sender_user_id)
if shakse == "طيبة" then
shakseshakse = "طيبة 😇"
else
shakseshakse = "شريرة 😈"
...
Redis:del(Themalath..'SetChannelVip'..IdUser)
...
Redis:set(Themalath..'SetChannelVip'..IdUser,true)
...
if Redis:get(Themalath..'SetChannelVip'..IdUser) then 
if text =='الغاء' then 
...
Redis:del(Themalath..'SetChannelVip'..IdUser)
Redis:set(Themalath..'SOFI:Channel:Vip'..IdUser,text)
...
Redis:del(Themalath..'SOFI:Channel:Vip'..IdUser)
Text = "⇜ تم حذف قناتك"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
shakse = "طيبة"
Redis:set(Themalath.."shkse"..data.sender_user_id,shakse)
ttshakse = '⇜ اختر دولتك'
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
Redis:set(Themalath.."bobna"..data.sender_user_id,news)
Redis:set(Themalath.."boob"..data.sender_user_id,balas)
Redis:set(Themalath.."boobb"..data.sender_user_id,creditcc)
Redis:set(Themalath.."bbobb"..data.sender_user_id,mast)
Redis:set(Themalath.."boballname"..creditcc,news)
Redis:set(Themalath.."boballbalc"..creditcc,balas)
Redis:set(Themalath.."boballcc"..creditcc,creditcc)
Redis:set(Themalath.."boballban"..creditcc,mast)
Redis:set(Themalath.."boballid"..creditcc,banid)
Redis:sadd(Themalath.."booob",data.sender_user_id)
...
Redis:set(Themalath.."bobna"..data.sender_user_id,news)
Redis:set(Themalath.."boob"..data.sender_user_id,balas)
Redis:set(Themalath.."boobb"..data.sender_user_id,creditvi)
Redis:set(Themalath.."bbobb"..data.sender_user_id,visssa)
Redis:set(Themalath.."boballname"..creditvi,news)
Redis:set(Themalath.."boballbalc"..creditvi,balas)
Redis:set(Themalath.."boballcc"..creditvi,creditvi)
Redis:set(Themalath.."boballban"..creditvi,visssa)
Redis:set(Themalath.."boballid"..creditvi,banid)
Redis:sadd(Themalath.."booob",data.sender_user_id)
ttshakse = '⇜ اختر شخصيتك في اللعبة'
local reply_markup = bot.replyMarkup{
type = 'inline',
...
Redis:set(Themalath.."bobna"..data.sender_user_id,news)
Redis:set(Themalath.."boob"..data.sender_user_id,balas)
Redis:set(Themalath.."boobb"..data.sender_user_id,creditex)
Redis:set(Themalath.."bbobb"..data.sender_user_id,exprs)
Redis:set(Themalath.."boballname"..creditex,news)
Redis:set(Themalath.."boballbalc"..creditex,balas)
Redis:set(Themalath.."boballcc"..creditex,creditex)
Redis:set(Themalath.."boballban"..creditex,exprs)
Redis:set(Themalath.."boballid"..creditex,banid)
Redis:sadd(Themalath.."booob",data.sender_user_id)
ttshakse = '⇜ اختر شخصيتك في اللعبة'
local reply_markup = bot.replyMarkup{
type = 'inline',
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
cccall = Redis:get(Themalath.."tdbelballance"..data.sender_user_id) or 0
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
if tonumber(ballance) < tonumber(cccall) then
return edit(ChatId,Msg_id, "⇜ فلوسك ماتكفي","md",true)
end
Redis:setex(Themalath.."iioood" .. data.sender_user_id,920, true)
local list = {"1", "2", "3"}
local rand = list[math.random(#list)]
if rand == "1" then -- 1 con
cccallcc = tonumber(ballance) + tonumber(cccall)
Redis:set(Themalath.."boob"..data.sender_user_id,cccallcc)
Redis:del(Themalath.."tdbelballance"..data.sender_user_id)
...
cccallcc = tonumber(ballance) - tonumber(cccall)
Redis:set(Themalath.."boob"..data.sender_user_id,cccallcc)
cccall = Redis:get(Themalath.."tdbelballance"..data.sender_user_id)
Redis:del(Themalath.."tdbelballance"..data.sender_user_id)
local convert_mony = string.format("%.0f",cccall)
local convert_monyy = string.format("%.0f",cccallcc)
msalm = "⌯ خسرت بالسحب ☹️\n\n⇜ المبلغ : "..convert_mony.."\nرصيدك الان : `"..convert_monyy.."`\n✧"
...
Redis:set(Themalath.."boob"..data.sender_user_id,cccallcc)
namefram = Redis:get(Themalath.."namefram"..data.sender_user_id)
Redis:sadd(Themalath.."farmarname", namefram)
Redis:set(Themalath.."sizefram"..data.sender_user_id,50000)
Redis:sadd(Themalath.."ownerfram",data.sender_user_id)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
...
namefram = Redis:get(Themalath.."namefram"..data.sender_user_id)
Redis:sadd(Themalath.."farmarname", namefram)
Redis:set(Themalath.."sizefram"..data.sender_user_id,100000)
Redis:sadd(Themalath.."ownerfram",data.sender_user_id)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 8×8\n⇜ السعر : 100000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
namefram = Redis:get(Themalath.."namefram"..data.sender_user_id)
Redis:sadd(Themalath.."farmarname", namefram)
Redis:set(Themalath.."sizefram"..data.sender_user_id,200000)
Redis:sadd(Themalath.."ownerfram",data.sender_user_id)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 12×12\n⇜ السعر : 1000000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
namefram = Redis:get(Themalath.."namefram"..data.sender_user_id)
Redis:sadd(Themalath.."farmarname", namefram)
Redis:set(Themalath.."sizefram"..data.sender_user_id,300000)
Redis:sadd(Themalath.."ownerfram",data.sender_user_id)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 16×16\n⇜ السعر : 5000000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
namefram = Redis:get(Themalath.."namefram"..data.sender_user_id)
Redis:sadd(Themalath.."farmarname", namefram)
Redis:set(Themalath.."sizefram"..data.sender_user_id,400000)
Redis:sadd(Themalath.."ownerfram",data.sender_user_id)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 32×32\n⇜ السعر : 10000000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
if Redis:get(Themalath.."mrkzplayer".."1"..data.sender_user_id) then
...
mrkzplayer = "مهاجم"
cityplayer = "🇺🇦 اوكرانيا"
Redis:set(Themalath.."nameplayer".."1"..data.sender_user_id,nameplayer)
Redis:set(Themalath.."energyplayer".."1"..data.sender_user_id,energyplayer)
Redis:set(Themalath.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."1"..data.sender_user_id,39000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
if Redis:get(Themalath.."mrkzplayer".."4"..data.sender_user_id) then
...
mrkzplayer = "مدافع"
cityplayer = "البرازيل 🇧🇷"
Redis:set(Themalath.."nameplayer".."4"..data.sender_user_id,nameplayer)
Redis:set(Themalath.."energyplayer".."4"..data.sender_user_id,energyplayer)
Redis:set(Themalath.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."4"..data.sender_user_id,50000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
if Redis:get(Themalath.."mrkzplayer".."3"..data.sender_user_id) then
...
Redis:set(Themalath.."nameplayer".."3"..data.sender_user_id,nameplayer)
Redis:set(Themalath.."energyplayer".."3"..data.sender_user_id,energyplayer)
Redis:set(Themalath.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."3"..data.sender_user_id,70000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."4"..data.sender_user_id,40000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."3"..data.sender_user_id,20000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : خوان ماتا\n⇜ مركزه : وسط\n⇜ طاقة اللاعب : 81\n⇜ الجنسية : إسبانيا 🇪🇸 \n⇜ السعر : 20000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Themalath.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."4"..data.sender_user_id,15000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."1"..data.sender_user_id,100000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."4"..data.sender_user_id,20000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."4"..data.sender_user_id,30000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
if Redis:get(Themalath.."mrkzplayer".."5"..data.sender_user_id) then
...
mrkzplayer = "حارس"
cityplayer = "ألمانيا 🇩🇪 "
Redis:set(Themalath.."nameplayer".."5"..data.sender_user_id,nameplayer)
Redis:set(Themalath.."energyplayer".."5"..data.sender_user_id,energyplayer)
Redis:set(Themalath.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."5"..data.sender_user_id,110000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : تير شتيجن\n⇜ مركزه : حارس\n⇜ طاقة اللاعب : 91\n⇜ الجنسية : ألمانيا 🇩🇪 \n⇜ السعر : 110000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
if Redis:get(Themalath.."mrkzplayer".."2"..data.sender_user_id) then
...
mrkzplayer = "جناح"
cityplayer = "فرنسا 🇫🇷 "
Redis:set(Themalath.."nameplayer".."2"..data.sender_user_id,nameplayer)
Redis:set(Themalath.."energyplayer".."2"..data.sender_user_id,energyplayer)
Redis:set(Themalath.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."2"..data.sender_user_id,45000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."2"..data.sender_user_id,78000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : رودريغو\n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : البرازيل 🇧🇷\n⇜ السعر : 78000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Themalath.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."4"..data.sender_user_id,65000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : ميليتاو\n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : البرازيل 🇧🇷\n⇜ السعر : 65000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Themalath.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."4"..data.sender_user_id,73000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : الابا\n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : النمسا 🇦🇹 \n⇜ السعر : 73000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Themalath.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."2"..data.sender_user_id,180000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : فينيسيوس \n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 94\n⇜ الجنسية : البرازيل 🇧🇷 \n⇜ السعر : 180000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Themalath.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."2"..data.sender_user_id,55000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : دي ماريا \n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 85\n⇜ الجنسية : الأرجنتين 🇦🇷 \n⇜ السعر : 55000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Themalath.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."4"..data.sender_user_id,38000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : دانييلي \n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 84\n⇜ الجنسية : إيطاليا 🇮🇹 \n⇜ السعر : 38000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Themalath.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."1"..data.sender_user_id,55000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."5"..data.sender_user_id,99000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : دوناروما \n⇜ مركزه : حارس\n⇜ طاقة اللاعب : 89\n⇜ الجنسية : إيطاليا 🇮🇹 \n⇜ السعر : 99000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Themalath.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."4"..data.sender_user_id,55000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."2"..data.sender_user_id,59000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."4"..data.sender_user_id,170000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : ايدن ازارد \n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 93\n⇜ الجنسية : اسبانيا 🇪🇸 \n⇜ السعر : 170000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Themalath.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."1"..data.sender_user_id,60000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : فرمينو \n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 86\n⇜ الجنسية : البرازيل 🇧🇷 \n⇜ السعر : 60000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Themalath.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."1"..data.sender_user_id,19000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : جاك كلارك \n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 81\n⇜ الجنسية : إنجلترا 🏴󠁧󠁢󠁥󠁮󠁧󠁿 \n⇜ السعر : 19000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Themalath.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."1"..data.sender_user_id,53000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."1"..data.sender_user_id,41000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : توريس \n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 84\n⇜ الجنسية : اسبانيا 🇪🇸 \n⇜ السعر : 41000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Themalath.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."3"..data.sender_user_id,41000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."3"..data.sender_user_id,74000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."3"..data.sender_user_id,78000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : بول بوجبا \n⇜ مركزه : وسط\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : فرنسا 🇫🇷 \n⇜ السعر : 78000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Themalath.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."3"..data.sender_user_id,90000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."5"..data.sender_user_id,80000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."5"..data.sender_user_id,70000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."5"..data.sender_user_id,52000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."5"..data.sender_user_id,20000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."5"..data.sender_user_id,40000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."1"..data.sender_user_id,20000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."2"..data.sender_user_id,100000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : محمد صلاح\n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 91\n⇜ الجنسية : مصر 🇪🇬 \n⇜ السعر : 100000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Themalath.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."2"..data.sender_user_id,90000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : نيمار\n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 90\n⇜ الجنسية : السنغال 🇸🇳 \n⇜ السعر : 90000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Themalath.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Themalath.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Themalath.."priceplayer".."2"..data.sender_user_id,80000)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."boob"..data.sender_user_id,cccallcc)
lkbnade = Redis:get(Themalath.."lkbnade"..data.sender_user_id)
Redis:sadd(Themalath.."lkbnadesadd", lkbnade)
namenade = "ريال مدريد"
Redis:set(Themalath.."namenade"..data.sender_user_id,namenade)
Redis:set(Themalath.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Themalath.."ownernade",data.sender_user_id)
Redis:set(Themalath.."energynade"..data.sender_user_id,50)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Themalath.."ownernade",data.sender_user_id)
Redis:set(Themalath.."energynade"..data.sender_user_id,45)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : برشلونة\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 150000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Themalath.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Themalath.."ownernade",data.sender_user_id)
Redis:set(Themalath.."energynade"..data.sender_user_id,40)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : تشيلسي\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 90000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Themalath.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Themalath.."ownernade",data.sender_user_id)
Redis:set(Themalath.."energynade"..data.sender_user_id,35)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Themalath.."ownernade",data.sender_user_id)
Redis:set(Themalath.."energynade"..data.sender_user_id,30)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : ليفربول\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 120000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Themalath.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Themalath.."ownernade",data.sender_user_id)
Redis:set(Themalath.."energynade"..data.sender_user_id,25)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Themalath.."ownernade",data.sender_user_id)
Redis:set(Themalath.."energynade"..data.sender_user_id,20)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Themalath.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Themalath.."ownernade",data.sender_user_id)
Redis:set(Themalath.."energynade"..data.sender_user_id,15)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : يوفنتوس\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 40000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Themalath.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Themalath.."ownernade",data.sender_user_id)
Redis:set(Themalath.."energynade"..data.sender_user_id,10)
ballance = Redis:get(Themalath.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : ارسنال\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 20000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
if Redis:get(Themalath.."hazrlock"..ChatId) == UserId then
if Redis:sismember(Themalath.."listhzerid"..ChatId, IdUser) then
return bot.answerCallbackQuery(data.id, "⇜ لقد انضممت الى اللعبة مسبقاً ", true)
end
if tonumber(Redis:get(Themalath.."hazrmalek"..ChatId)) == IdUser then
return bot.answerCallbackQuery(data.id, "⇜ انتا مالك اللعبة حاليا", true)
end
Redis:sadd(Themalath.."listhzerid"..ChatId, IdUser)
...
if Redis:get(Themalath.."soundidche"..ChatId..IdUser) == UserId[1] then
...
sleep(1)
os.remove(""..title..".mp3")
Redis:del(Themalath.."soundidche"..ChatId..IdUser)
else
Redis:del(Themalath.."soundidche"..ChatId..IdUser)
...
if Redis:get(Themalath.."youtidche"..ChatId..IdUser) == UserId[1] then
...
sleep(1)
os.remove(""..title..".mp3")
Redis:del(Themalath.."youtidche"..ChatId..IdUser)
else
Redis:del(Themalath.."youtidche"..ChatId..IdUser)
return edit(ChatId,Msg_id,'\n⇜ لا استطيع تحميل اكثر من 25 ميغا',"md",true)
end
...
local kk_id = Redis:get(Themalath.."kk_Akab"..ChatId)
if Redis:sismember(Themalath..'members_Ahkamm'..ChatId,IdUser) then
Redis:sadd(Themalath.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
local kk_id = Redis:get(Themalath.."kk_Akab"..ChatId)
if Redis:sismember(Themalath..'members_Ahkamm'..ChatId,IdUser) then
Redis:srem(Themalath.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{{text = 'Louis', url = 't.me/Y88F8'},},}}
...
local ff_id = Redis:get(Themalath.."ff_Ahkam"..ChatId)
local kk_id = Redis:get(Themalath.."kk_Ahkam"..ChatId)
...
local ff_id = Redis:get(Themalath.."ff_Ahkkam"..ChatId)
local kk_id = Redis:get(Themalath.."kk_Ahkkam"..ChatId)
if tonumber(IdUser) == tonumber(ff_id) then
Redis:sadd(Themalath.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
...
local kk_id = Redis:get(Themalath.."kk_koorsi"..ChatId)
if Redis:sismember(Themalath..'List_Koorsi'..ChatId,IdUser) then
Redis:sadd(Themalath.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
local ff_id = Redis:get(Themalath.."ff_saraha"..ChatId)
local kk_id = Redis:get(Themalath.."kk_saraha"..ChatId)
if tonumber(IdUser) == tonumber(ff_id) then
Redis:sadd(Themalath.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
...
if not Redis:sismember(Themalath..'List_Aktooh'..ChatId,IdUser) then 
Redis:sadd(Themalath..'List_Aktooh'..ChatId,IdUser)
Redis:setex(Themalath.."Witting_StartGameAk"..ChatId,1400,true)
local list = Redis:smembers(Themalath..'List_Aktooh'..ChatId) 
if #list == 2 then
for k,v in pairs(list) do
if k == 1 then
...
if k == #list then
local Ak_Tm = Redis:get(Themalath.."Ak_Tmooh"..ChatId)
local ban = bot.getUser(Ak_Tm)
local AkName = '['..ban.first_name..'](tg://user?id='..ban.id..')' or 'لا يوجد اسم'
local message = '*✦┊عـدد المصـوتين ⇜*'..#list..' \n*✦┊اسمـاء المصـوتين ⇩*\n'..name1..'\n'..name2..'\n'..name3..'\n\n*✦┊المستخـدم* '..AkName..'\n*✦┊تم كتمـه .. بنجـاح ✓*'
Redis:sadd(Themalath.."SilentGroup:Group"..ChatId,Ak_Tm) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
---------------------- Dev ZilZal ----------------------
if Text == '/Unaktmooh' and Redis:get(Themalath.."Witting_StartGameAk"..ChatId) then
local raeaktooh = Redis:get(Themalath.."raeaktooh"..ChatId)
...
Redis:srem(Themalath.."SilentGroup:Group"..ChatId,Ak_Tm)
Redis:srem(Themalath..'List_Aktooh'..ChatId,UserName) 
Redis:del(Themalath..'raeaktooh'..ChatId) 
Redis:del(Themalath..'List_Aktooh'..ChatId) 
Redis:del(Themalath.."Witting_StartGameAk"..ChatId)
Redis:del(Themalath.."Start_Aktmooh"..ChatId)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(Themalath..'List_Ahkkam'..ChatId,IdUser) then 
Redis:sadd(Themalath..'List_Ahkkam'..ChatId,IdUser)
Redis:setex(Themalath.."Witting_StartGameeh"..ChatId,1400,true)
local list = Redis:smembers(Themalath..'List_Ahkkam'..ChatId) 
if #list == 2 then
local UserInfo = bot.getUser(IdUser)
...
---------------------- Dev ZilZal ----------------------
if Text == '/startahkam' and Redis:get(Themalath.."Witting_StartGameeh"..ChatId) then
local rarahkam = Redis:get(Themalath.."raeahkkam"..ChatId)
...
Redis:set(Themalath.."kk_Ahkkam"..ChatId,UserId_Info.id)
Redis:srem(Themalath..'List_Ahkkam'..ChatId,UserName) 
local liiist = Redis:smembers(Themalath..'List_Ahkkam'..ChatId) 
...
Redis:set(Themalath.."ff_Ahkkam"..ChatId,UserId2_Info.id)
local GetLike = Redis:incrby(Themalath.."Num:Add:Ahkam"..ChatId..UserId2_Info.id, 5) 
Redis:hset(Themalath..':GroupUserCountAhkam:'..ChatId,UserId2_Info.id,GetLike)
...
NameLUser = NameLUser:gsub("[[]","")
Redis:hset(Themalath..':GroupAhkamNameUser:'..ChatId,UserrInfo.id,NameLUser)
Redis:del(Themalath..'raeahkkam'..ChatId) 
Redis:del(Themalath..'List_Ahkkam'..ChatId) 
Redis:del(Themalath.."Witting_StartGameeh"..ChatId)
Redis:del(Themalath.."Start_Ahkkam"..ChatId)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
---------------------- Dev ZilZal ----------------------
if Text == '/Koorsy' then
if not Redis:sismember(Themalath..'List_Koorsi'..ChatId,IdUser) then 
Redis:sadd(Themalath..'List_Koorsi'..ChatId,IdUser)
Redis:setex(Themalath.."Witting_StartGameek"..ChatId,1400,true)
local list = Redis:smembers(Themalath..'List_Koorsi'..ChatId) 
if #list == 2 then
local UserInfo = bot.getUser(IdUser)
local Teext = '- ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..IdUser..')'
...
---------------------- Dev ZilZal ----------------------
if Text == '/startkoorsi' and Redis:get(Themalath.."Witting_StartGameek"..ChatId) then
local rarahkam = Redis:get(Themalath.."raekoorsi"..ChatId)
if tonumber(IdUser) == tonumber(rarahkam) then
local list = Redis:smembers(Themalath..'List_Koorsi'..ChatId) 
local UserName = list[math.random(#list)]
local UserId_Info = bot.getUser(UserName)
...
Redis:set(Themalath.."koorsi:"..testkoorsi.."chat_id", ChatId)
Redis:set(Themalath.."koorsi:"..testkoorsi.."to", UserId_Info.id)
Redis:set(Themalath.."koorsi:"..testkoorsi.."msg_id",Msg_id)
if UserId_Info.username and UserId_Info.username ~= "" then
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
else
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
end
Redis:set(Themalath.."kk_koorsi"..ChatId,UserId_Info.id)
Redis:srem(Themalath..'List_Koorsi'..ChatId,UserName) 
Redis:del(Themalath..'raekoorsi'..ChatId) 
Redis:del(Themalath..'List_Koorsi'..ChatId) 
Redis:del(Themalath.."Witting_StartGameek"..ChatId)
Redis:del(Themalath.."Start_Koorsi"..ChatId)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(Themalath..'List_Saraha'..ChatId,IdUser) then 
Redis:sadd(Themalath..'List_Saraha'..ChatId,IdUser)
Redis:setex(Themalath.."Witting_StartGameS"..ChatId,1400,true)
local list = Redis:smembers(Themalath..'List_Saraha'..ChatId) 
if #list == 2 then
local UserInfo = bot.getUser(IdUser)
local Teext = '- ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..IdUser..')'
local zzllzz = '*✦┊عـدد اللاعبيـن ⇜*'..#list..' \n*✦┊لقـد انضـم للعبـة كرسـي ⇩*\n'..Teext
...
---------------------- صراحه ----------------------
if Text == '/startsaraha' and Redis:get(Themalath.."Witting_StartGameS"..ChatId) then
local rarahkam = Redis:get(Themalath.."raesaraha"..ChatId)
if tonumber(IdUser) == tonumber(rarahkam) then
local list = Redis:smembers(Themalath..'List_Saraha'..ChatId) 
local UserName = list[math.random(#list)]
local UserId_Info = bot.getUser(UserName)
local testsaraha = math.random(1,9999999999999)
Redis:set(Themalath.."saraha:"..testsaraha.."chat_id", ChatId)
Redis:set(Themalath.."saraha:"..testsaraha.."to", UserId_Info.id)
Redis:set(Themalath.."saraha:"..testsaraha.."msg_id",Msg_id)
if UserId_Info.username and UserId_Info.username ~= "" then
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
else
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
end
Redis:set(Themalath.."kk_saraha"..ChatId,UserId_Info.id)
Redis:srem(Themalath..'List_Saraha'..ChatId,UserName) 
local liiiist = Redis:smembers(Themalath..'List_Saraha'..ChatId) 
local User2Name = liiiist[math.random(#liiiist)]
local UserId2_Info = bot.getUser(User2Name)
Redis:incrby(Themalath..'Num:Add:Games'..ChatId..UserId2_Info.id,5)
Redis:set(Themalath.."ff_saraha"..ChatId,UserId2_Info.id)
Redis:del(Themalath..'raesaraha'..ChatId) 
Redis:del(Themalath..'List_Saraha'..ChatId) 
Redis:del(Themalath.."Witting_StartGameS"..ChatId)
Redis:del(Themalath.."Start_Saraha"..ChatId)
local liiist = Redis:sismember(Themalath..'List_Saraha'..ChatId,IdUser)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:sismember(Themalath..'List_Ahkamm'..ChatId,IdUser) then
return bot.answerCallbackQuery(data.id, "✦┊انت منضـم مسبقـاً .. الـى اللعبـه", true)
end
bot.answerCallbackQuery(data.id, "✦ تم ضفتك للعبـة ⛓ ✓", true)
Redis:sadd(Themalath..'List_Ahkamm'..ChatId,IdUser)
Redis:sadd(Themalath..'members_Ahkamm'..ChatId,IdUser)
Redis:setex(Themalath.."Witting_StartGamehh"..ChatId,1400,true)
end
if Text and Text:match('/Ahkam(.*)') then
local UserId = Text:match('/Ahkam(.*)')
if Redis:sismember(Themalath..'List_Ahkam'..ChatId,IdUser) then
return bot.answerCallbackQuery(data.id, "✦┊انت منضـم مسبقـاً .. الـى اللعبـه", true)
end
bot.answerCallbackQuery(data.id, "✦ تم ضفتك للعبـة 👩🏻‍⚖⚖ ✓", true)
Redis:sadd(Themalath..'List_Ahkam'..ChatId,IdUser)
Redis:setex(Themalath.."Witting_StartGameh"..ChatId,1400,true)
end
if Text and Text:match('/Korsy(.*)') then
local UserId = Text:match('/Korsy(.*)')
if Redis:sismember(Themalath..'List_Korsi'..ChatId,IdUser) then
return bot.answerCallbackQuery(data.id, "✦┊انت منضـم مسبقـاً .. الـى اللعبـه", true)
end
bot.answerCallbackQuery(data.id, "✦ تم ضفتك للعبـة ⛓ ✓", true)
Redis:sadd(Themalath..'List_Korsi'..ChatId,IdUser)
Redis:setex(Themalath.."Witting_StartGamek"..ChatId,1400,true)
end
if Text and Text:match('/Sarahy(.*)') then
local UserId = Text:match('/Sarahy(.*)')
if Redis:sismember(Themalath..'List_Saraha'..ChatId,IdUser) then
return bot.answerCallbackQuery(data.id, "✦┊انت منضـم مسبقـاً .. الـى اللعبـه", true)
end
bot.answerCallbackQuery(data.id, "✦ تم ضفتك للعبـة ⛓ ✓", true)
Redis:sadd(Themalath..'List_Saraha'..ChatId,IdUser)
...
if Text and Text:match('(%d+)/startttahkam') and Redis:get(Themalath.."Witting_StartGameh"..ChatId) then
local UserId = Text:match('(%d+)/startttahkam')
local rarahkam = Redis:get(Themalath.."raeahkam"..ChatId)
if tonumber(IdUser) ~= tonumber(rarahkam) then
return bot.answerCallbackQuery(data.id, "✦┊الامـر للي بـدأ اللعبـه ...", true)
else
local list = Redis:smembers(Themalath..'List_Ahkam'..ChatId) 
local UserName = list[math.random(#list)]
local UserId_Info = bot.getUser(UserName)
if UserId_Info.username and UserId_Info.username ~= "" then
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
...
Redis:set(Themalath.."kk_Ahkam"..ChatId,UserId_Info.id)
Redis:srem(Themalath..'List_Ahkam'..ChatId,UserId_Info.id) 
...
Redis:set(Themalath.."ff_Ahkam"..ChatId,UserId2_Info.id)
Redis:incrby(Themalath..'Num:Add:Ahkam'..ChatId..UserId2_Info.id,5)
Redis:del(Themalath..'raeahkam'..ChatId) 
Redis:del(Themalath..'List_Ahkam'..ChatId) 
Redis:del(Themalath.."Witting_StartGameh"..ChatId)
Redis:del(Themalath.."Start_Ahkam"..ChatId)
local Themalath = '*⚖┊تم إختيار الشخـص ⇜* '..ls..'\n*👩🏻‍⚖┊ليتـم الحكـم عليـه من قبـل ⇜* '..Hs..'\n\n*🎁┊وتم اضـافـة 5 نقـاط للحـاكـم*'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹𓌗 قنـاة البـوت 𓌗.',url='http://t.me/'..chsource..''}},
}
local msg_idd = Msg_id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token..'/editMessageText?chat_id='..data.id..'&text='..URL.escape(Themalath)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Themalath.."malath:lockpin"..ChatId,(bot.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'ا','ايدي')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'م','رفع مميز')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'اد', 'رفع ادمن')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'مد','رفع مدير')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'منش', 'رفع منشئ')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'اس', 'رفع منشئ اساسي')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'مط','رفع M')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'تن','تنزيل الكل')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'را','الرابط')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'رر','الردود')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'،،','مسح المكتومين')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'رد','اضف رد')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'غ','غنيلي')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'رس','رسائلي')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'ثانوي','رفع مطور ثانوي')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'مس','مسح تعديلاتي')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'ن','نقاطي')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'س','اسالني')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'ل','لغز')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'مع','معاني')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'ح','حزوره')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'رف','رفع القيود')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'الغ','الغاء حظر')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'ث','تثبيت')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'ك','كشف')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'تت','تاك')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'تك','تاك للكل')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'تغ','تغيير الايدي')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'تنز','تنزيل جميع الرتب')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'قق','قفل الاشعارات')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'فف','فتح الاشعارات')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'مر','مسح رد')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'امر','اضف امر')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'ش','شعر')
Redis:set(Themalath.."malath:Get:Reides:Commands:Group"..UserId[2]..":"..'غغ','اغنيه')
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Themalath.."malath:Lock:farsia"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Themalath.."malath:Lock:tphlesh"..ChatId)  
Redis:del(Themalath.."malath:Status:IdPhoto"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Themalath.."malath:Lock:phshar"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Themalath.."malath:Lock:farsia"..ChatId,true)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Themalath.."malath:Lock:tphlesh"..ChatId,true)
Redis:set(Themalath.."malath:Status:IdPhoto"..ChatId,true)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Themalath.."malath:Lock:phshar"..ChatId,true)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Themalath.."malath:ControlAll:Groups") 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Themalath.."malath:MalekAsase:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Themalath.."malath:KtmAll:Groups") 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
