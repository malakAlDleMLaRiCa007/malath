...
Bot_Name = (Redis:get(Themalath.."malath:Name:Bot") or "لويس")
if text and text:match('^'..Bot_Name..' ') then
text = text:gsub('^'..Bot_Name..' ','')
end
if text then
local NewCmmd = Redis:get(Themalath.."All:Get:Reides:Commands:Group"..text) or Redis:get(Themalath.."malath:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
local bank_users = Redis:smembers(Themalath.."booob")
if #bank_users == 0 then
return send(msg.chat_id,msg.id,"⇜ لا يوجد حسابات في البنك","md",true)
end
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(Themalath.."boob"..v)
...
local emo = emoji[k]
num = num + 1
Redis:set(Themalath.."medal"..v[2],convert_mony)
Redis:set(Themalath.."medal2"..v[2],emo)
Redis:set(Themalath.."medal3"..v[2],local_time)
Redis:sadd(Themalath.."medalid",v[2])
Redis:set(Themalath.."medal"..v[2],convert_mony)
Redis:set(Themalath.."medal2"..v[2],emo)
Redis:set(Themalath.."medal3"..v[2],local_time)
Redis:sadd(Themalath.."medalid",v[2])
...
if msg.ControllerBot then
Redis:del(Themalath.."rrfffid")
Redis:del(Themalath.."booob")
Redis:del(Themalath.."taza")
Redis:del(Themalath.."ownerfram")
Redis:del(Themalath.."farmarname")
Redis:setex(Themalath.."deletbank" .. 111,1123200, true)
send(msg.chat_id,msg.id, "⇜ حذفت لعبه البنك 🏦","md",true)
end
end
if text == 'مسح لعبه المزرعه' then
if msg.ControllerBot then
for k,v in pairs(Redis:smembers(Themalath.."booob")) do 
Redis:del(Themalath.."toplvfarm"..v)
Redis:del(Themalath.."btatatime"..v)
Redis:del(Themalath.."btatanum"..v)
Redis:del(Themalath.."btataname"..v)
Redis:del(Themalath.."lemontime"..v)
Redis:del(Themalath.."lemonnum"..v)
Redis:del(Themalath.."lemonname"..v)
Redis:del(Themalath.."khesstime"..v)
Redis:del(Themalath.."khessnum"..v)
Redis:del(Themalath.."khessname"..v)
Redis:del(Themalath.."kheartime"..v)
Redis:del(Themalath.."khearnum"..v)
Redis:del(Themalath.."khearname"..v)
Redis:del(Themalath.."jzartime"..v)
Redis:del(Themalath.."jzarnum"..v)
Redis:del(Themalath.."jzarname"..v)
Redis:del(Themalath.."fleflatime"..v)
Redis:del(Themalath.."fleflanum"..v)
Redis:del(Themalath.."fleflaname"..v)
Redis:del(Themalath.."freaztime"..v)
Redis:del(Themalath.."freaznum"..v)
Redis:del(Themalath.."freazname"..v)
Redis:del(Themalath.."doratime"..v)
Redis:del(Themalath.."doranum"..v)
Redis:del(Themalath.."doraname"..v)
Redis:del(Themalath.."tomtime"..v)
Redis:del(Themalath.."tomnum"..v)
Redis:del(Themalath.."tomname"..v)
Redis:del(Themalath.."ftrtime"..v)
Redis:del(Themalath.."ftrnum"..v)
Redis:del(Themalath.."ftrname"..v)
Redis:del(Themalath.."tfahtime"..v)
Redis:del(Themalath.."tfahnum"..v)
Redis:del(Themalath.."tfahname"..v)
Redis:del(Themalath.."enabtime"..v)
Redis:del(Themalath.."enabnum"..v)
Redis:del(Themalath.."enabname"..v)
Redis:del(Themalath.."zetontime"..v)
Redis:del(Themalath.."zetonnum"..v)
Redis:del(Themalath.."zetonname"..v)
Redis:del(Themalath.."mozztime"..v)
Redis:del(Themalath.."mozznum"..v)
Redis:del(Themalath.."mozzname"..v)
Redis:del(Themalath.."mangatime"..v)
Redis:del(Themalath.."manganum"..v)
Redis:del(Themalath.."manganame"..v)
Redis:del(Themalath.."sizefram"..v)
Redis:del(Themalath.."namefram"..v)
Redis:del(Themalath.."mzroatsize"..v)
end
Redis:del(Themalath.."ownerfram")
Redis:del(Themalath.."farmarname")
...
if msg.ControllerBot then
for k,v in pairs(Redis:smembers(Themalath.."booob")) do 
Redis:del(Themalath.."namenade"..v)
Redis:del(Themalath.."nokatnade"..v)
Redis:del(Themalath.."energynade"..v)
Redis:del(Themalath.."traningnade"..v)
Redis:del(Themalath.."lkbnade"..v)
Redis:del(Themalath.."nameplayer".."1"..v)
Redis:del(Themalath.."nameplayer".."2"..v)
Redis:del(Themalath.."nameplayer".."3"..v)
Redis:del(Themalath.."nameplayer".."4"..v)
Redis:del(Themalath.."nameplayer".."5"..v)
Redis:del(Themalath.."energyplayer".."1"..v)
Redis:del(Themalath.."energyplayer".."2"..v)
Redis:del(Themalath.."energyplayer".."3"..v)
Redis:del(Themalath.."energyplayer".."4"..v)
Redis:del(Themalath.."energyplayer".."5"..v)
Redis:del(Themalath.."mrkzplayer".."1"..v)
Redis:del(Themalath.."mrkzplayer".."2"..v)
Redis:del(Themalath.."mrkzplayer".."3"..v)
Redis:del(Themalath.."mrkzplayer".."4"..v)
Redis:del(Themalath.."mrkzplayer".."5"..v)
Redis:del(Themalath.."cityplayer".."1"..v)
Redis:del(Themalath.."cityplayer".."2"..v)
Redis:del(Themalath.."cityplayer".."3"..v)
Redis:del(Themalath.."cityplayer".."4"..v)
Redis:del(Themalath.."cityplayer".."5"..v)
Redis:del(Themalath.."priceplayer".."1"..v)
Redis:del(Themalath.."priceplayer".."2"..v)
Redis:del(Themalath.."priceplayer".."3"..v)
Redis:del(Themalath.."priceplayer".."4"..v)
Redis:del(Themalath.."priceplayer".."5"..v)
end
Redis:del(Themalath.."lkbnadesadd")
Redis:del(Themalath.."ownernade")
...
local bank_users = Redis:smembers(Themalath.."booob")
for k,v in pairs(bank_users) do
Redis:del(Themalath.."boob"..v)
Redis:del(Themalath.."kreednum"..v)
Redis:del(Themalath.."kreed"..v)
Redis:del(Themalath.."rrfff"..v)
Redis:del(Themalath.."numattack"..v)
Redis:del(Themalath.."tabbroat"..v)
Redis:del(Themalath.."shkse"..v)
Redis:del(Themalath.."doltebank"..v)
Redis:del(Themalath.."ratbinc"..v)
Redis:del(Themalath.."ratbtrans"..v)
Redis:del(Themalath.."mgrmasname"..v)
Redis:del(Themalath.."mgrmasnum"..v)
Redis:del(Themalath.."mgrkldname"..v)
Redis:del(Themalath.."mgrkldnum"..v)
Redis:del(Themalath.."mgrswrname"..v)
Redis:del(Themalath.."mgrswrnum"..v)
Redis:del(Themalath.."mgrktmname"..v)
Redis:del(Themalath.."mgrktmnum"..v)
Redis:del(Themalath.."akrksrname"..v)
Redis:del(Themalath.."akrksrnum"..v)
Redis:del(Themalath.."akrfelname"..v)
Redis:del(Themalath.."akrfelnum"..v)
Redis:del(Themalath.."akrmnzname"..v)
Redis:del(Themalath.."akrmnznum"..v)
Redis:del(Themalath.."airshbhname"..v)
Redis:del(Themalath.."airshbhnum"..v)
Redis:del(Themalath.."airsfarname"..v)
Redis:del(Themalath.."airsfarnum"..v)
Redis:del(Themalath.."airkhasname"..v)
Redis:del(Themalath.."airkhasnum"..v)
Redis:del(Themalath.."carrangname"..v)
Redis:del(Themalath.."carrangnum"..v)
Redis:del(Themalath.."caraccename"..v)
Redis:del(Themalath.."caraccenum"..v)
Redis:del(Themalath.."carcamrname"..v)
Redis:del(Themalath.."carcamrnum"..v)
Redis:del(Themalath.."caralntrname"..v)
Redis:del(Themalath.."caralntrnum"..v)
Redis:del(Themalath.."carhilxname"..v)
Redis:del(Themalath.."carhilxnum"..v)
Redis:del(Themalath.."carsonaname"..v)
Redis:del(Themalath.."carsonanum"..v)
Redis:del(Themalath.."carcoroname"..v)
Redis:del(Themalath.."carcoronum"..v)
Redis:del(Themalath.."rotpa"..v)
Redis:del(Themalath.."rddd"..v)
Redis:del(Themalath.."rotpagrid"..v)
Redis:del(Themalath.."rotpaid"..v)
Redis:del(Themalath.."rdddgr"..v)
Redis:del(Themalath.."rdddid"..v)
Redis:del(Themalath.."rdddtex"..v)
end
for k,v in pairs(Redis:smembers(Themalath.."company_owners:")) do 
local Cname = Redis:get(Themalath.."companys_name:"..v)
Redis:del(Themalath.."companys_owner:"..Cname)
Redis:del(Themalath.."companys_id:"..Cname)
Redis:del(Themalath.."company:mem:"..Cname)
Redis:del(Themalath.."companys_name:"..v)
end
Redis:del(Themalath.."company_owners:")
Redis:del(Themalath.."companys:")
Redis:del(Themalath.."in_company:")
local bank_usersr = Redis:smembers(Themalath.."rrfffid")
for k,v in pairs(bank_usersr) do
Redis:del(Themalath.."boob"..v)
Redis:del(Themalath.."rrfff"..v)
end
for k,v in pairs(Redis:smembers(Themalath.."ownerfram")) do 
Redis:del(Themalath.."toplvfarm"..v)
Redis:del(Themalath.."btatatime"..v)
Redis:del(Themalath.."btatanum"..v)
Redis:del(Themalath.."btataname"..v)
...
if msg.ControllerBot then
local zwag_users = Redis:smembers(Themalath.."roogg1")
for k,v in pairs(zwag_users) do
Redis:del(Themalath.."roog1"..v)
Redis:del(Themalath.."rooga1"..v)
Redis:del(Themalath.."rahr1"..v)
Redis:del(Themalath.."rahrr1"..v)
Redis:del(Themalath.."roogte1"..v)
end
local zwaga_users = Redis:smembers(Themalath.."roogga1")
...
Redis:del(Themalath.."roogga1")
Redis:del(Themalath.."roogg1")
send(msg.chat_id,msg.id, "⇜ مسحت لعبه الزواج","md",true)
end
end
if text == 'ميدالياتي' or text == 'ميداليات' then

if Redis:sismember(Themalath.."medalid",msg.sender_id.user_id) then
local medaa2 = Redis:get(Themalath.."medal2"..msg.sender_id.user_id)
if medaa2 == "🥇" then
local medaa = Redis:get(Themalath.."medal"..msg.sender_id.user_id)
local medaa2 = Redis:get(Themalath.."medal2"..msg.sender_id.user_id)
local medaa3 = Redis:get(Themalath.."medal3"..msg.sender_id.user_id)
...
if text == Redis:get(Themalath..'klmahzr'..msg.chat_id) and msg.sender_id.user_id == Redis:get(Themalath..'playerhzr'..msg.chat_id) then
if not Redis:get(Themalath.."playerhzrktm"..msg.chat_id..msg.sender_id.user_id) then
playerhzr = Redis:get(Themalath..'playerhzr'..msg.chat_id)
Redis:srem(Themalath.."malath:SilentGroup:Group"..msg.chat_id,playerhzr) 
Redis:del(Themalath.."playerhzrktm"..msg.chat_id..playerhzr)
end
end
if text and Redis:get(Themalath.."Start_egabahzr"..msg.chat_id) then
playerhzr = Redis:get(Themalath..'playerhzr'..msg.chat_id)
klmahzr = Redis:get(Themalath..'klmahzr'..msg.chat_id)
...
Redis:del(Themalath.."Start_egabahzr"..msg.chat_id)
Redis:del(Themalath.."playerhzrktm"..msg.chat_id..msg.sender_id.user_id)
Redis:srem(Themalath.."malath:SilentGroup:Group"..msg.chat_id,msg.sender_id.user_id) 
send(msg.chat_id,msg.id,"「 "..news.." 」\n⇜ كفو عليك حزرت الاجابة ( "..klmahzr.." )\n⇜ تم فك الكتم عنك \n✧ ","md",true)
end
end
end

if not Redis:get(Themalath.."lock_getpankiuserall") or not Redis:get(Themalath.."lock_getpankiuser"..msg.chat_id) then
...
cobnum = tonumber(Redis:get(Themalath.."bandid"..msg.sender_id.user_id))
if cobnum == msg.sender_id.user_id then
return send(msg.chat_id,msg.id, "⇜ حسابك محظور من لعبة البنك","md",true)
end
if Redis:sismember(Themalath.."booob",msg.sender_id.user_id) then
...
Redis:srem(Themalath.."booob", msg.sender_id.user_id)
Redis:srem(Themalath.."taza", msg.sender_id.user_id)
Redis:del(Themalath.."boob"..msg.sender_id.user_id)
Redis:del(Themalath.."boobb"..msg.sender_id.user_id)
Redis:del(Themalath.."rrfff"..msg.sender_id.user_id)
Redis:srem(Themalath.."rrfffid", msg.sender_id.user_id)
Redis:srem(Themalath.."roogg1", msg.sender_id.user_id)
Redis:srem(Themalath.."roogga1", msg.sender_id.user_id)
Redis:del(Themalath.."roog1"..msg.sender_id.user_id)
Redis:del(Themalath.."rooga1"..msg.sender_id.user_id)
Redis:del(Themalath.."rahr1"..msg.sender_id.user_id)
Redis:del(Themalath.."rahrr1"..msg.sender_id.user_id)
Redis:del(Themalath.."tabbroat"..msg.sender_id.user_id)
Redis:del(Themalath.."shkse"..msg.sender_id.user_id)
Redis:del(Themalath.."doltebank"..msg.sender_id.user_id)
Redis:del(Themalath.."ratbinc"..msg.sender_id.user_id)
Redis:del(Themalath.."ratbtrans"..msg.sender_id.user_id)
Redis:del(Themalath.."mgrmasname"..msg.sender_id.user_id)
Redis:del(Themalath.."mgrmasnum"..msg.sender_id.user_id)
Redis:del(Themalath.."mgrkldname"..msg.sender_id.user_id)
Redis:del(Themalath.."mgrkldnum"..msg.sender_id.user_id)
Redis:del(Themalath.."mgrswrname"..msg.sender_id.user_id)
Redis:del(Themalath.."mgrswrnum"..msg.sender_id.user_id)
Redis:del(Themalath.."mgrktmname"..msg.sender_id.user_id)
Redis:del(Themalath.."mgrktmnum"..msg.sender_id.user_id)
Redis:del(Themalath.."akrksrname"..msg.sender_id.user_id)
Redis:del(Themalath.."akrksrnum"..msg.sender_id.user_id)
Redis:del(Themalath.."akrfelname"..msg.sender_id.user_id)
Redis:del(Themalath.."akrfelnum"..msg.sender_id.user_id)
Redis:del(Themalath.."akrmnzname"..msg.sender_id.user_id)
Redis:del(Themalath.."akrmnznum"..msg.sender_id.user_id)
Redis:del(Themalath.."airshbhname"..msg.sender_id.user_id)
Redis:del(Themalath.."airshbhnum"..msg.sender_id.user_id)
Redis:del(Themalath.."airsfarname"..msg.sender_id.user_id)
Redis:del(Themalath.."airsfarnum"..msg.sender_id.user_id)
Redis:del(Themalath.."airkhasname"..msg.sender_id.user_id)
Redis:del(Themalath.."airkhasnum"..msg.sender_id.user_id)
Redis:del(Themalath.."carrangname"..msg.sender_id.user_id)
Redis:del(Themalath.."carrangnum"..msg.sender_id.user_id)
Redis:del(Themalath.."caraccename"..msg.sender_id.user_id)
Redis:del(Themalath.."caraccenum"..msg.sender_id.user_id)
Redis:del(Themalath.."carcamrname"..msg.sender_id.user_id)
Redis:del(Themalath.."carcamrnum"..msg.sender_id.user_id)
Redis:del(Themalath.."caralntrname"..msg.sender_id.user_id)
Redis:del(Themalath.."caralntrnum"..msg.sender_id.user_id)
Redis:del(Themalath.."carhilxname"..msg.sender_id.user_id)
Redis:del(Themalath.."carhilxnum"..msg.sender_id.user_id)
Redis:del(Themalath.."carsonaname"..msg.sender_id.user_id)
Redis:del(Themalath.."carsonanum"..msg.sender_id.user_id)
Redis:del(Themalath.."carcoroname"..msg.sender_id.user_id)
Redis:del(Themalath.."carcoronum"..msg.sender_id.user_id)
namfra = Redis:get(Themalath.."namefram"..msg.sender_id.user_id)
Redis:del(Themalath.."toplvfarm"..msg.sender_id.user_id)
Redis:del(Themalath.."btatatime"..msg.sender_id.user_id)
Redis:del(Themalath.."btatanum"..msg.sender_id.user_id)
Redis:del(Themalath.."btataname"..msg.sender_id.user_id)
Redis:del(Themalath.."lemontime"..msg.sender_id.user_id)
Redis:del(Themalath.."lemonnum"..msg.sender_id.user_id)
Redis:del(Themalath.."lemonname"..msg.sender_id.user_id)
Redis:del(Themalath.."khesstime"..msg.sender_id.user_id)
Redis:del(Themalath.."khessnum"..msg.sender_id.user_id)
Redis:del(Themalath.."khessname"..msg.sender_id.user_id)
Redis:del(Themalath.."kheartime"..msg.sender_id.user_id)
Redis:del(Themalath.."khearnum"..msg.sender_id.user_id)
Redis:del(Themalath.."khearname"..msg.sender_id.user_id)
Redis:del(Themalath.."jzartime"..msg.sender_id.user_id)
Redis:del(Themalath.."jzarnum"..msg.sender_id.user_id)
Redis:del(Themalath.."jzarname"..msg.sender_id.user_id)
Redis:del(Themalath.."fleflatime"..msg.sender_id.user_id)
Redis:del(Themalath.."fleflanum"..msg.sender_id.user_id)
Redis:del(Themalath.."fleflaname"..msg.sender_id.user_id)
Redis:del(Themalath.."freaztime"..msg.sender_id.user_id)
Redis:del(Themalath.."freaznum"..msg.sender_id.user_id)
Redis:del(Themalath.."freazname"..msg.sender_id.user_id)
Redis:del(Themalath.."doratime"..msg.sender_id.user_id)
Redis:del(Themalath.."doranum"..msg.sender_id.user_id)
Redis:del(Themalath.."doraname"..msg.sender_id.user_id)
Redis:del(Themalath.."tomtime"..msg.sender_id.user_id)
Redis:del(Themalath.."tomnum"..msg.sender_id.user_id)
Redis:del(Themalath.."tomname"..msg.sender_id.user_id)
Redis:del(Themalath.."ftrtime"..msg.sender_id.user_id)
Redis:del(Themalath.."ftrnum"..msg.sender_id.user_id)
Redis:del(Themalath.."ftrname"..msg.sender_id.user_id)
Redis:del(Themalath.."tfahtime"..msg.sender_id.user_id)
Redis:del(Themalath.."tfahnum"..msg.sender_id.user_id)
Redis:del(Themalath.."tfahname"..msg.sender_id.user_id)
Redis:del(Themalath.."enabtime"..msg.sender_id.user_id)
Redis:del(Themalath.."enabnum"..msg.sender_id.user_id)
Redis:del(Themalath.."enabname"..msg.sender_id.user_id)
Redis:del(Themalath.."zetontime"..msg.sender_id.user_id)
Redis:del(Themalath.."zetonnum"..msg.sender_id.user_id)
Redis:del(Themalath.."zetonname"..msg.sender_id.user_id)
Redis:del(Themalath.."mozztime"..msg.sender_id.user_id)
Redis:del(Themalath.."mozznum"..msg.sender_id.user_id)
Redis:del(Themalath.."mozzname"..msg.sender_id.user_id)
Redis:del(Themalath.."mangatime"..msg.sender_id.user_id)
Redis:del(Themalath.."manganum"..msg.sender_id.user_id)
Redis:del(Themalath.."manganame"..msg.sender_id.user_id)
Redis:del(Themalath.."sizefram"..msg.sender_id.user_id)
Redis:del(Themalath.."namefram"..msg.sender_id.user_id)
Redis:del(Themalath.."mzroatsize"..msg.sender_id.user_id)
Redis:srem(Themalath.."farmarname", namfra)
Redis:srem(Themalath.."ownerfram",msg.sender_id.user_id)
namenad = Redis:get(Themalath.."lkbnade"..msg.sender_id.user_id)
Redis:del(Themalath.."namenade"..msg.sender_id.user_id)
Redis:del(Themalath.."nokatnade"..msg.sender_id.user_id)
Redis:del(Themalath.."energynade"..msg.sender_id.user_id)
Redis:del(Themalath.."traningnade"..msg.sender_id.user_id)
Redis:del(Themalath.."nameplayer".."1"..msg.sender_id.user_id)
Redis:del(Themalath.."nameplayer".."2"..msg.sender_id.user_id)
Redis:del(Themalath.."nameplayer".."3"..msg.sender_id.user_id)
Redis:del(Themalath.."nameplayer".."4"..msg.sender_id.user_id)
Redis:del(Themalath.."nameplayer".."5"..msg.sender_id.user_id)
Redis:del(Themalath.."energyplayer".."1"..msg.sender_id.user_id)
Redis:del(Themalath.."energyplayer".."2"..msg.sender_id.user_id)
Redis:del(Themalath.."energyplayer".."3"..msg.sender_id.user_id)
Redis:del(Themalath.."energyplayer".."4"..msg.sender_id.user_id)
Redis:del(Themalath.."energyplayer".."5"..msg.sender_id.user_id)
Redis:del(Themalath.."mrkzplayer".."1"..msg.sender_id.user_id)
Redis:del(Themalath.."mrkzplayer".."2"..msg.sender_id.user_id)
Redis:del(Themalath.."mrkzplayer".."3"..msg.sender_id.user_id)
Redis:del(Themalath.."mrkzplayer".."4"..msg.sender_id.user_id)
Redis:del(Themalath.."mrkzplayer".."5"..msg.sender_id.user_id)
Redis:del(Themalath.."cityplayer".."1"..msg.sender_id.user_id)
Redis:del(Themalath.."cityplayer".."2"..msg.sender_id.user_id)
Redis:del(Themalath.."cityplayer".."3"..msg.sender_id.user_id)
Redis:del(Themalath.."cityplayer".."4"..msg.sender_id.user_id)
Redis:del(Themalath.."cityplayer".."5"..msg.sender_id.user_id)
Redis:del(Themalath.."priceplayer".."1"..msg.sender_id.user_id)
Redis:del(Themalath.."priceplayer".."2"..msg.sender_id.user_id)
Redis:del(Themalath.."priceplayer".."3"..msg.sender_id.user_id)
Redis:del(Themalath.."priceplayer".."4"..msg.sender_id.user_id)
Redis:del(Themalath.."priceplayer".."5"..msg.sender_id.user_id)
Redis:srem(Themalath.."lkbnadesadd", namenad)
Redis:srem(Themalath.."ownernade",msg.sender_id.user_id)
Redis:del(Themalath.."lkbnade"..msg.sender_id.user_id)
else
...
if Redis:sismember(Themalath.."booob",msg.sender_id.user_id) then
ballancee = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
...
if Redis:sismember(Themalath.."booob",UserId_Info.id) then
ballanceed = Redis:get(Themalath.."boob"..UserId_Info.id) or 0
...
if Redis:sismember(Themalath.."booob",Remsg.sender_id.user_id) then
ballanceed = Redis:get(Themalath.."boob"..Remsg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballanceed)
send(msg.chat_id,msg.id, "⇜ فلوسه `"..convert_mony.."` ريال 💵","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعنده حساب بنكي ","md",true)
...
if Redis:sismember(Themalath.."booob",msg.sender_id.user_id) then
cccc = Redis:get(Themalath.."boobb"..msg.sender_id.user_id)
uuuu = Redis:get(Themalath.."bbobb"..msg.sender_id.user_id)
pppp = Redis:get(Themalath.."rrfff"..msg.sender_id.user_id) or 0
ballancee = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
shkse = Redis:get(Themalath.."shkse"..msg.sender_id.user_id)
doltebank = Redis:get(Themalath.."doltebank"..msg.sender_id.user_id)
local convert_mony = string.format("%.0f",ballancee)
if shkse == "طيبة" then
shkseemg = "طيبة 😇"
else
...
if Redis:sismember(Themalath.."booob",Remsg.sender_id.user_id) then
local Cname = Redis:get(Themalath.."in_company:name:"..msg.sender_id.user_id) or 0
Redis:srem(Themalath.."company:mem:"..Cname, msg.sender_id.user_id)
Redis:srem(Themalath.."in_company:", msg.sender_id.user_id)
Redis:del(Themalath.."in_company:name:"..msg.sender_id.user_id, Cname)
ccccc = Redis:get(Themalath.."boobb"..Remsg.sender_id.user_id)
uuuuu = Redis:get(Themalath.."bbobb"..Remsg.sender_id.user_id)
ppppp = Redis:get(Themalath.."rrfff"..Remsg.sender_id.user_id) or 0
ballanceed = Redis:get(Themalath.."boob"..Remsg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballanceed)
Redis:srem(Themalath.."booob", Remsg.sender_id.user_id)
Redis:srem(Themalath.."taza", Remsg.sender_id.user_id)
namfra = Redis:get(Themalath.."namefram"..Remsg.sender_id.user_id)
Redis:del(Themalath.."boob"..Remsg.sender_id.user_id)
Redis:del(Themalath.."boobb"..Remsg.sender_id.user_id)
Redis:del(Themalath.."rrfff"..Remsg.sender_id.user_id)
Redis:del(Themalath.."numattack"..Remsg.sender_id.user_id)
Redis:srem(Themalath.."rrfffid", Remsg.sender_id.user_id)
Redis:srem(Themalath.."roogg1", Remsg.sender_id.user_id)
Redis:srem(Themalath.."roogga1", Remsg.sender_id.user_id)
Redis:del(Themalath.."roog1"..Remsg.sender_id.user_id)
Redis:del(Themalath.."rooga1"..Remsg.sender_id.user_id)
Redis:del(Themalath.."rahr1"..Remsg.sender_id.user_id)
Redis:del(Themalath.."rahrr1"..Remsg.sender_id.user_id)
Redis:del(Themalath.."tabbroat"..Remsg.sender_id.user_id)
Redis:del(Themalath.."shkse"..Remsg.sender_id.user_id)
Redis:del(Themalath.."doltebank"..Remsg.sender_id.user_id)
Redis:del(Themalath.."ratbinc"..Remsg.sender_id.user_id)
Redis:del(Themalath.."ratbtrans"..Remsg.sender_id.user_id)
Redis:del(Themalath.."mgrmasname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."mgrmasnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."mgrkldname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."mgrkldnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."mgrswrname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."mgrswrnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."mgrktmname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."mgrktmnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."akrksrname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."akrksrnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."akrfelname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."akrfelnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."akrmnzname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."akrmnznum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."airshbhname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."airshbhnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."airsfarname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."airsfarnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."airkhasname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."airkhasnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."carrangname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."carrangnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."caraccename"..Remsg.sender_id.user_id)
Redis:del(Themalath.."caraccenum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."carcamrname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."carcamrnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."caralntrname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."caralntrnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."carhilxname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."carhilxnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."carsonaname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."carsonanum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."carcoroname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."carcoronum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."rotpa"..Remsg.sender_id.user_id)
Redis:del(Themalath.."rddd"..Remsg.sender_id.user_id)
Redis:del(Themalath.."rotpagrid"..Remsg.sender_id.user_id)
Redis:del(Themalath.."rotpaid"..Remsg.sender_id.user_id)
Redis:del(Themalath.."rdddgr"..Remsg.sender_id.user_id)
Redis:del(Themalath.."rdddid"..Remsg.sender_id.user_id)
Redis:del(Themalath.."rdddtex"..Remsg.sender_id.user_id)
Redis:del(Themalath.."toplvfarm"..Remsg.sender_id.user_id)
Redis:del(Themalath.."btatatime"..Remsg.sender_id.user_id)
Redis:del(Themalath.."btatanum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."btataname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."lemontime"..Remsg.sender_id.user_id)
Redis:del(Themalath.."lemonnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."lemonname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."khesstime"..Remsg.sender_id.user_id)
Redis:del(Themalath.."khessnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."khessname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."kheartime"..Remsg.sender_id.user_id)
Redis:del(Themalath.."khearnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."khearname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."jzartime"..Remsg.sender_id.user_id)
Redis:del(Themalath.."jzarnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."jzarname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."fleflatime"..Remsg.sender_id.user_id)
Redis:del(Themalath.."fleflanum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."fleflaname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."freaztime"..Remsg.sender_id.user_id)
Redis:del(Themalath.."freaznum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."freazname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."doratime"..Remsg.sender_id.user_id)
Redis:del(Themalath.."doranum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."doraname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."tomtime"..Remsg.sender_id.user_id)
Redis:del(Themalath.."tomnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."tomname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."ftrtime"..Remsg.sender_id.user_id)
Redis:del(Themalath.."ftrnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."ftrname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."tfahtime"..Remsg.sender_id.user_id)
Redis:del(Themalath.."tfahnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."tfahname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."enabtime"..Remsg.sender_id.user_id)
Redis:del(Themalath.."enabnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."enabname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."zetontime"..Remsg.sender_id.user_id)
Redis:del(Themalath.."zetonnum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."zetonname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."mozztime"..Remsg.sender_id.user_id)
Redis:del(Themalath.."mozznum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."mozzname"..Remsg.sender_id.user_id)
Redis:del(Themalath.."mangatime"..Remsg.sender_id.user_id)
Redis:del(Themalath.."manganum"..Remsg.sender_id.user_id)
Redis:del(Themalath.."manganame"..Remsg.sender_id.user_id)
Redis:del(Themalath.."sizefram"..Remsg.sender_id.user_id)
Redis:del(Themalath.."namefram"..Remsg.sender_id.user_id)
Redis:del(Themalath.."mzroatsize"..Remsg.sender_id.user_id)
Redis:srem(Themalath.."farmarname", namfra)
Redis:srem(Themalath.."ownerfram",Remsg.sender_id.user_id)
namenad = Redis:get(Themalath.."lkbnade"..Remsg.sender_id.user_id)
Redis:del(Themalath.."namenade"..Remsg.sender_id.user_id)
Redis:del(Themalath.."nokatnade"..Remsg.sender_id.user_id)
Redis:del(Themalath.."energynade"..Remsg.sender_id.user_id)
Redis:del(Themalath.."traningnade"..Remsg.sender_id.user_id)
Redis:del(Themalath.."nameplayer".."1"..Remsg.sender_id.user_id)
Redis:del(Themalath.."nameplayer".."2"..Remsg.sender_id.user_id)
Redis:del(Themalath.."nameplayer".."3"..Remsg.sender_id.user_id)
Redis:del(Themalath.."nameplayer".."4"..Remsg.sender_id.user_id)
Redis:del(Themalath.."nameplayer".."5"..Remsg.sender_id.user_id)
Redis:del(Themalath.."energyplayer".."1"..Remsg.sender_id.user_id)
Redis:del(Themalath.."energyplayer".."2"..Remsg.sender_id.user_id)
Redis:del(Themalath.."energyplayer".."3"..Remsg.sender_id.user_id)
Redis:del(Themalath.."energyplayer".."4"..Remsg.sender_id.user_id)
Redis:del(Themalath.."energyplayer".."5"..Remsg.sender_id.user_id)
Redis:del(Themalath.."mrkzplayer".."1"..Remsg.sender_id.user_id)
Redis:del(Themalath.."mrkzplayer".."2"..Remsg.sender_id.user_id)
Redis:del(Themalath.."mrkzplayer".."3"..Remsg.sender_id.user_id)
Redis:del(Themalath.."mrkzplayer".."4"..Remsg.sender_id.user_id)
Redis:del(Themalath.."mrkzplayer".."5"..Remsg.sender_id.user_id)
Redis:del(Themalath.."cityplayer".."1"..Remsg.sender_id.user_id)
Redis:del(Themalath.."cityplayer".."2"..Remsg.sender_id.user_id)
Redis:del(Themalath.."cityplayer".."3"..Remsg.sender_id.user_id)
Redis:del(Themalath.."cityplayer".."4"..Remsg.sender_id.user_id)
Redis:del(Themalath.."cityplayer".."5"..Remsg.sender_id.user_id)
Redis:del(Themalath.."priceplayer".."1"..Remsg.sender_id.user_id)
Redis:del(Themalath.."priceplayer".."2"..Remsg.sender_id.user_id)
Redis:del(Themalath.."priceplayer".."3"..Remsg.sender_id.user_id)
Redis:del(Themalath.."priceplayer".."4"..Remsg.sender_id.user_id)
Redis:del(Themalath.."priceplayer".."5"..Remsg.sender_id.user_id)
Redis:srem(Themalath.."lkbnadesadd", namenad)
Redis:srem(Themalath.."ownernade",Remsg.sender_id.user_id)
Redis:del(Themalath.."lkbnade"..Remsg.sender_id.user_id)
...
ppppp = Redis:get(Themalath.."rrfff"..Remsg.sender_id.user_id) or 0
ballanceed = Redis:get(Themalath.."boob"..Remsg.sender_id.user_id) or 0
shkse = Redis:get(Themalath.."shkse"..Remsg.sender_id.user_id)
doltebank = Redis:get(Themalath.."doltebank"..Remsg.sender_id.user_id)
local convert_mony = string.format("%.0f",ballanceed)
if shkse == "طيبة" then
shkseemg = "طيبة 😇"
else
...
if Redis:sismember(Themalath.."booob",coniss) then
local Cname = Redis:get(Themalath.."in_company:name:"..coniss) or 0
Redis:srem(Themalath.."company:mem:"..Cname, coniss)
Redis:srem(Themalath.."in_company:", coniss)
Redis:del(Themalath.."in_company:name:"..coniss, Cname)
ccccc = Redis:get(Themalath.."boobb"..coniss)
uuuuu = Redis:get(Themalath.."bbobb"..coniss)
ppppp = Redis:get(Themalath.."rrfff"..coniss) or 0
ballanceed = Redis:get(Themalath.."boob"..coniss) or 0
local convert_mony = string.format("%.0f",ballanceed)
namfra = Redis:get(Themalath.."namefram"..coniss)
Redis:srem(Themalath.."booob", coniss)
Redis:srem(Themalath.."taza", coniss)
Redis:del(Themalath.."boob"..coniss)
Redis:del(Themalath.."boobb"..coniss)
Redis:del(Themalath.."rrfff"..coniss)
Redis:srem(Themalath.."roogg1", coniss)
Redis:srem(Themalath.."roogga1", coniss)
Redis:del(Themalath.."roog1"..coniss)
Redis:del(Themalath.."rooga1"..coniss)
Redis:del(Themalath.."rahr1"..coniss)
Redis:del(Themalath.."rahrr1"..coniss)
Redis:del(Themalath.."tabbroat"..coniss)
Redis:del(Themalath.."shkse"..coniss)
Redis:del(Themalath.."doltebank"..coniss)
Redis:del(Themalath.."ratbinc"..coniss)
Redis:del(Themalath.."ratbtrans"..coniss)
Redis:del(Themalath.."numattack"..coniss)
Redis:del(Themalath.."mgrmasname"..coniss)
Redis:del(Themalath.."mgrmasnum"..coniss)
Redis:del(Themalath.."mgrkldname"..coniss)
Redis:del(Themalath.."mgrkldnum"..coniss)
Redis:del(Themalath.."mgrswrname"..coniss)
Redis:del(Themalath.."mgrswrnum"..coniss)
Redis:del(Themalath.."mgrktmname"..coniss)
Redis:del(Themalath.."mgrktmnum"..coniss)
Redis:del(Themalath.."akrksrname"..coniss)
Redis:del(Themalath.."akrksrnum"..coniss)
Redis:del(Themalath.."akrfelname"..coniss)
Redis:del(Themalath.."akrfelnum"..coniss)
Redis:del(Themalath.."akrmnzname"..coniss)
Redis:del(Themalath.."akrmnznum"..coniss)
Redis:del(Themalath.."airshbhname"..coniss)
Redis:del(Themalath.."airshbhnum"..coniss)
Redis:del(Themalath.."airsfarname"..coniss)
Redis:del(Themalath.."airsfarnum"..coniss)
Redis:del(Themalath.."airkhasname"..coniss)
Redis:del(Themalath.."airkhasnum"..coniss)
Redis:del(Themalath.."carrangname"..coniss)
Redis:del(Themalath.."carrangnum"..coniss)
Redis:del(Themalath.."caraccename"..coniss)
Redis:del(Themalath.."caraccenum"..coniss)
Redis:del(Themalath.."carcamrname"..coniss)
Redis:del(Themalath.."carcamrnum"..coniss)
Redis:del(Themalath.."caralntrname"..coniss)
Redis:del(Themalath.."caralntrnum"..coniss)
Redis:del(Themalath.."carhilxname"..coniss)
Redis:del(Themalath.."carhilxnum"..coniss)
Redis:del(Themalath.."carsonaname"..coniss)
Redis:del(Themalath.."carsonanum"..coniss)
Redis:del(Themalath.."carcoroname"..coniss)
Redis:del(Themalath.."carcoronum"..coniss)
Redis:srem(Themalath.."rrfffid", coniss)
Redis:del(Themalath.."rotpa"..coniss)
Redis:del(Themalath.."rddd"..coniss)
Redis:del(Themalath.."rotpagrid"..coniss)
Redis:del(Themalath.."rotpaid"..coniss)
Redis:del(Themalath.."rdddgr"..coniss)
Redis:del(Themalath.."rdddid"..coniss)
Redis:del(Themalath.."rdddtex"..coniss)
Redis:del(Themalath.."toplvfarm"..coniss)
Redis:del(Themalath.."btatatime"..coniss)
Redis:del(Themalath.."btatanum"..coniss)
Redis:del(Themalath.."btataname"..coniss)
Redis:del(Themalath.."lemontime"..coniss)
Redis:del(Themalath.."lemonnum"..coniss)
Redis:del(Themalath.."lemonname"..coniss)
Redis:del(Themalath.."khesstime"..coniss)
Redis:del(Themalath.."khessnum"..coniss)
Redis:del(Themalath.."khessname"..coniss)
Redis:del(Themalath.."kheartime"..coniss)
Redis:del(Themalath.."khearnum"..coniss)
Redis:del(Themalath.."khearname"..coniss)
Redis:del(Themalath.."jzartime"..coniss)
Redis:del(Themalath.."jzarnum"..coniss)
Redis:del(Themalath.."jzarname"..coniss)
Redis:del(Themalath.."fleflatime"..coniss)
Redis:del(Themalath.."fleflanum"..coniss)
Redis:del(Themalath.."fleflaname"..coniss)
Redis:del(Themalath.."freaztime"..coniss)
Redis:del(Themalath.."freaznum"..coniss)
Redis:del(Themalath.."freazname"..coniss)
Redis:del(Themalath.."doratime"..coniss)
Redis:del(Themalath.."doranum"..coniss)
Redis:del(Themalath.."doraname"..coniss)
Redis:del(Themalath.."tomtime"..coniss)
Redis:del(Themalath.."tomnum"..coniss)
Redis:del(Themalath.."tomname"..coniss)
Redis:del(Themalath.."ftrtime"..coniss)
Redis:del(Themalath.."ftrnum"..coniss)
Redis:del(Themalath.."ftrname"..coniss)
Redis:del(Themalath.."tfahtime"..coniss)
Redis:del(Themalath.."tfahnum"..coniss)
Redis:del(Themalath.."tfahname"..coniss)
Redis:del(Themalath.."enabtime"..coniss)
Redis:del(Themalath.."enabnum"..coniss)
Redis:del(Themalath.."enabname"..coniss)
Redis:del(Themalath.."zetontime"..coniss)
Redis:del(Themalath.."zetonnum"..coniss)
Redis:del(Themalath.."zetonname"..coniss)
Redis:del(Themalath.."mozztime"..coniss)
Redis:del(Themalath.."mozznum"..coniss)
Redis:del(Themalath.."mozzname"..coniss)
Redis:del(Themalath.."mangatime"..coniss)
Redis:del(Themalath.."manganum"..coniss)
Redis:del(Themalath.."manganame"..coniss)
Redis:del(Themalath.."sizefram"..coniss)
Redis:del(Themalath.."namefram"..coniss)
Redis:del(Themalath.."mzroatsize"..coniss)
Redis:srem(Themalath.."farmarname", namfra)
Redis:srem(Themalath.."ownerfram",coniss)
namenad = Redis:get(Themalath.."lkbnade"..coniss)
Redis:del(Themalath.."namenade"..coniss)
Redis:del(Themalath.."nokatnade"..coniss)
Redis:del(Themalath.."energynade"..coniss)
Redis:del(Themalath.."traningnade"..coniss)
Redis:del(Themalath.."nameplayer".."1"..coniss)
Redis:del(Themalath.."nameplayer".."2"..coniss)
Redis:del(Themalath.."nameplayer".."3"..coniss)
Redis:del(Themalath.."nameplayer".."4"..coniss)
Redis:del(Themalath.."nameplayer".."5"..coniss)
Redis:del(Themalath.."energyplayer".."1"..coniss)
Redis:del(Themalath.."energyplayer".."2"..coniss)
Redis:del(Themalath.."energyplayer".."3"..coniss)
Redis:del(Themalath.."energyplayer".."4"..coniss)
Redis:del(Themalath.."energyplayer".."5"..coniss)
Redis:del(Themalath.."mrkzplayer".."1"..coniss)
Redis:del(Themalath.."mrkzplayer".."2"..coniss)
Redis:del(Themalath.."mrkzplayer".."3"..coniss)
Redis:del(Themalath.."mrkzplayer".."4"..coniss)
Redis:del(Themalath.."mrkzplayer".."5"..coniss)
Redis:del(Themalath.."cityplayer".."1"..coniss)
Redis:del(Themalath.."cityplayer".."2"..coniss)
Redis:del(Themalath.."cityplayer".."3"..coniss)
Redis:del(Themalath.."cityplayer".."4"..coniss)
Redis:del(Themalath.."cityplayer".."5"..coniss)
Redis:del(Themalath.."priceplayer".."1"..coniss)
Redis:del(Themalath.."priceplayer".."2"..coniss)
Redis:del(Themalath.."priceplayer".."3"..coniss)
Redis:del(Themalath.."priceplayer".."4"..coniss)
Redis:del(Themalath.."priceplayer".."5"..coniss)
Redis:srem(Themalath.."lkbnadesadd", namenad)
Redis:srem(Themalath.."ownernade",coniss)
Redis:del(Themalath.."lkbnade"..coniss)
send(msg.chat_id,msg.id, "⇜ الاسم ↤ "..news.."\n⇜ الحساب ↤ `"..ccccc.."`\n⇜ بنك ↤ ❲ لويس ❳\n⇜ نوع ↤ ❲ "..uuuuu.." ❳\n⇜ الرصيد ↤ ❲ "..convert_mony.." ❳ ريال 💵 )\n⇜ الزرف ↤ ❲ "..math.floor(ppppp).." ريال 💵 ❳\n⇜ مسكين مسحت حسابه","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعنده حساب بنكي اصلاً ","md",true)
end
...
local coniss = coin(UserName)
if Redis:get(Themalath.."boballcc"..coniss) then
local yty = Redis:get(Themalath.."boballname"..coniss)
local bobpkh = Redis:get(Themalath.."boballid"..coniss)
ballancee = Redis:get(Themalath.."boob"..bobpkh) or 0
local convert_mony = string.format("%.0f",ballancee)
local dfhb = Redis:get(Themalath.."boballbalc"..coniss)
local fsvhh = Redis:get(Themalath.."boballban"..coniss)
shkse = Redis:get(Themalath.."shkse"..coniss)
doltebank = Redis:get(Themalath.."doltebank"..coniss)
if shkse == "طيبة" then
shkseemg = "طيبة 😇"
else
shkseemg = "شريرة 😈"
...
if Redis:sismember(Themalath.."booob",msg.sender_id.user_id) then
morakba = tonumber(Redis:get(Themalath.."morakba"..msg.sender_id.user_id))
if morakba == msg.sender_id.user_id then
send("-1001737102093",0,"⇜ الايدي ↤ "..msg.sender_id.user_id.."\n⇜ القروب ↤ "..msg.chat_id.."\n⇜ الرسالة ↤ "..text.."\n✧","md",true)
end
if not Redis:sismember(Themalath.."Akshtd:Games:",TextAksht) then
...
Redis:srem(Themalath.."Akshtd:Games:",TextAksht)
ballancee = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
cobonplus = tonumber(ballancee) + Number
Redis:set(Themalath.."boob"..msg.sender_id.user_id , cobonplus)
...
local Text = Redis:smembers(Themalath.."Akshtd:Games:") 
if #Text == 0 then
...
Redis:del(Themalath.."Akshtd:Games:")
...
Redis:sadd(Themalath.."Akshtd:Games:",Num)
Redis:sadd(Themalath.."Akshtd:Games:",Num1)
Redis:sadd(Themalath.."Akshtd:Games:",Num2)
Redis:sadd(Themalath.."Akshtd:Games:",Num3)
Redis:sadd(Themalath.."Akshtd:Games:",Num4)
Redis:sadd(Themalath.."Akshtd:Games:",Num5)
Redis:sadd(Themalath.."Akshtd:Games:",Num6)
Redis:sadd(Themalath.."Akshtd:Games:",Num7)
Redis:sadd(Themalath.."Akshtd:Games:",Num8)
Redis:sadd(Themalath.."Akshtd:Games:",Num9)
return send(msg.chat_id,msg.id,[[
...
ballanceed = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
if Redis:ttl(Themalath.."iiooooo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Themalath.."iiooooo" .. msg.sender_id.user_id))
...
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(ballanceekkku))
Redis:setex(Themalath.."iiooooo" .. msg.sender_id.user_id,900, true)
...
ballanceed = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
if Redis:ttl(Themalath.."iioooo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Themalath.."iioooo" .. msg.sender_id.user_id))
...
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(ballanceekkk))
Redis:setex(Themalath.."iioooo" .. msg.sender_id.user_id,1200, true)
...
if text == 'سحب' then
ballanceed = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
if Redis:ttl(Themalath.."iioood" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Themalath.."iioood" .. msg.sender_id.user_id))
...
if text == 'حظ' then
ballanceed = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
if Redis:ttl(Themalath.."iiooo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Themalath.."iiooo" .. msg.sender_id.user_id))
...
nsbhad = Redis:get(Themalath.."nsbhad"..1) or 50
...
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(ballanceek))
Redis:setex(Themalath.."iiooo" .. msg.sender_id.user_id,900, true)
...
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(ballanceekk))
Redis:setex(Themalath.."iiooo" .. msg.sender_id.user_id,900, true)
...
if text == 'تحويل' then
if Redis:ttl(Themalath.."tanstime" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Themalath.."tanstime" .. msg.sender_id.user_id))
...
local coniss = coin(UserName)
if not Redis:sismember(Themalath.."booob",msg.sender_id.user_id) then
...
Redis:set(Themalath.."transn"..msg.sender_id.user_id,coniss)
Redis:setex(Themalath.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
send(msg.chat_id,msg.id,[[
...
if Redis:get(Themalath.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
cccc = Redis:get(Themalath.."boobb"..msg.sender_id.user_id)
uuuu = Redis:get(Themalath.."bbobb"..msg.sender_id.user_id)
if text ~= text:match('^(%d+)$') then
Redis:del(Themalath.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
Redis:del(Themalath.."transn" .. msg.sender_id.user_id)
...
if Redis:get(Themalath.."boballcc"..text) then
local UserNamey = Redis:get(Themalath.."transn"..msg.sender_id.user_id)
local ban = bot.getUser(msg.sender_id.user_id)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
local fsvhhh = Redis:get(Themalath.."boballid"..text)
...
local fsvhh = Redis:get(Themalath.."boballban"..text)
...
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(deccde))
decdecb = Redis:get(Themalath.."boob"..fsvhhh) or 0
deccde2 = decdecb + UserNameyy
Redis:set(Themalath.."boob"..fsvhhh , math.floor(deccde2))
Redis:setex(Themalath.."tanstime" .. msg.sender_id.user_id,1800, true)
...
if Redis:ttl(Themalath.."deletbank" .. 111) >= 1036800 then
day = "13 يوم"
elseif Redis:ttl(Themalath.."deletbank" .. 111) >= 950400 then
day = "12 يوم"
elseif Redis:ttl(Themalath.."deletbank" .. 111) >= 864000 then
day = "11 يوم"
elseif Redis:ttl(Themalath.."deletbank" .. 111) >= 777600 then
day = "10 ايام"
elseif Redis:ttl(Themalath.."deletbank" .. 111) >= 691200 then
day = "9 ايام"
elseif Redis:ttl(Themalath.."deletbank" .. 111) >= 604800 then
day = "8 ايام"
elseif Redis:ttl(Themalath.."deletbank" .. 111) >= 518400 then
day = "7 ايام"
elseif Redis:ttl(Themalath.."deletbank" .. 111) >= 432000 then
day = "6 ايام"
elseif Redis:ttl(Themalath.."deletbank" .. 111) >= 345600 then
day = "5 ايام"
elseif Redis:ttl(Themalath.."deletbank" .. 111) >= 259200 then
day = "4 ايام"
elseif Redis:ttl(Themalath.."deletbank" .. 111) >= 172800 then
day = "3 ايام"
elseif Redis:ttl(Themalath.."deletbank" .. 111) >= 86400 then
day = "يومان"
elseif Redis:ttl(Themalath.."deletbank" .. 111) <= 86400 then
day = "يوم واحد"
else
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local doltebank = Redis:get(Themalath.."doltebank"..v[2]) or " " or " "
local mony = v[1]
local convert_mony = string.format("%.0f",mony)
local emo = emoji[k]
num = num + 1
...
zrfee = Redis:get(Themalath.."rrfff"..msg.sender_id.user_id) or 0
local ty_users = Redis:smembers(Themalath.."rrfffid")
if #ty_users == 0 then
...
local mony = Redis:get(Themalath.."rrfff"..v)
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local doltebank = Redis:get(Themalath.."doltebank"..v[2]) or " "
local mony = v[1]
local convert_mony = string.format("%.0f",mony)
local emoo = emojii[k]
num_ty = num_ty + 1
...
if Redis:ttl(Themalath.."iioo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Themalath.."iioo" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ من شوي اخذت رشوة استنى "..time.." ","md",true)
end
if Redis:ttl(Themalath.."polrsho" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Themalath.."polrsho" .. msg.sender_id.user_id))
...
Redis:set(Themalath.."boob"..msg.sender_id.user_id , bakigcj)
send(msg.chat_id,msg.id,"⇜ هذه رشوة بطل زرف "..jjjo.." درهم 💵","md",true)
Redis:setex(Themalath.."iioo" .. msg.sender_id.user_id,600, true)
else
Redis:setex(Themalath.."polrsho" .. msg.sender_id.user_id,300, true)
...
if Redis:ttl(Themalath.."polic" .. msg.sender_id.user_id) >=60 then
local hours = Redis:ttl(Themalath.."polic" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id,"⇜ انتا بالسجن 🏤 استنى "..math.floor(hours).." دقائق\n✧","md",true)
end
if Redis:ttl(Themalath.."hrame" .. Remsg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Themalath.."hrame" .. Remsg.sender_id.user_id))
...
shkseto = Redis:get(Themalath.."shkse"..Remsg.sender_id.user_id)
if shkseto == "طيبة" then
local hrame = math.floor(math.random() * 200) + 1;
local ballanceed = Redis:get(Themalath.."boob"..Remsg.sender_id.user_id) or 0
local ballancope = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
zrfne = ballanceed - hrame
zrfnee = ballancope + hrame
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(zrfnee))
Redis:set(Themalath.."boob"..Remsg.sender_id.user_id , math.floor(zrfne))
Redis:setex(Themalath.."hrame" .. Remsg.sender_id.user_id,600, true)
local zoropeo = Redis:get(Themalath.."rrfff"..msg.sender_id.user_id) or 0
zoroprod = zoropeo + hrame
Redis:set(Themalath.."rrfff"..msg.sender_id.user_id,zoroprod)
Redis:sadd(Themalath.."rrfffid",msg.sender_id.user_id)
local ban = bot.getUser(Remsg.sender_id.user_id)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
Redis:set(Themalath.."msrokid"..msg.chat_id..Remsg.sender_id.user_id,Remsg.sender_id.user_id)
Redis:set(Themalath.."hrameid"..msg.chat_id..Remsg.sender_id.user_id,msg.sender_id.user_id)
Redis:set(Themalath.."balcmsrok"..msg.chat_id..Remsg.sender_id.user_id,hrame)
Redis:setex(Themalath.."timehrame"..msg.chat_id..msg.sender_id.user_id,30, true)
...
local hrameid = Redis:get(Themalath.."hrameid"..msg.chat_id..msg.sender_id.user_id)
shkse = Redis:get(Themalath.."shkse"..msg.sender_id.user_id)
if shkse == "شريرة" then
return send(msg.chat_id,msg.id, "⇜ شخصيتك شريرة مايمديك تطلب الشرطة","md",true)
end
if Redis:get(Themalath.."timehrame"..msg.chat_id.. hrameid) then
local hours = Redis:ttl(Themalath.."timehrame" .. hrameid)
local msrokid = Redis:get(Themalath.."msrokid"..msg.chat_id..msg.sender_id.user_id)
local hrameid = Redis:get(Themalath.."hrameid"..msg.chat_id..msg.sender_id.user_id)
local balcmsrok = Redis:get(Themalath.."balcmsrok"..msg.chat_id..msg.sender_id.user_id) or 0
if tonumber(hrameid) == Remsg.sender_id.user_id and tonumber(msrokid) == msg.sender_id.user_id then
local ballancehrame = Redis:get(Themalath.."boob"..hrameid) or 0
local ballancmsrok = Redis:get(Themalath.."boob"..msrokid) or 0
ballancehramenow = tonumber(ballancehrame) - tonumber(balcmsrok)
ballancmsroknow = tonumber(ballancmsrok) + tonumber(balcmsrok)
Redis:set(Themalath.."boob"..hrameid , ballancehramenow)
Redis:set(Themalath.."boob"..msrokid , ballancmsroknow)
...
Redis:setex(Themalath.."polic" .. hrameid,600, true)
Redis:del(Themalath.."msrokid" ..msg.chat_id..msg.sender_id.user_id) 
Redis:del(Themalath.."hrameid" ..msg.chat_id..msg.sender_id.user_id) 
Redis:del(Themalath.."balcmsrok" ..msg.chat_id..msg.sender_id.user_id) 
Redis:del(Themalath.."timehrame" ..msg.chat_id..msg.sender_id.user_id)
...
if Redis:ttl(Themalath.."iiioo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Themalath.."iiioo" .. msg.sender_id.user_id))
...
local ballancee = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
shkse = Redis:get(Themalath.."shkse"..msg.sender_id.user_id)
ratbinc = Redis:get(Themalath.."ratbinc"..msg.sender_id.user_id) or 1
ratbtrans = Redis:get(Themalath.."ratbtrans"..msg.sender_id.user_id) or 1
if shkse == "طيبة" then
if tonumber(ratbinc) >= 270 and tonumber(ratbtrans) == 10 then
local ratpep = ballancee + 500000
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(ratpep))
local ballancee = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballancee)
Redis:setex(Themalath.."iiioo" .. msg.sender_id.user_id,600, true)
Redis:incrby(Themalath.."ratbinc"..msg.sender_id.user_id,1)
ratbinc = Redis:get(Themalath.."ratbinc"..msg.sender_id.user_id)
...
Redis:set(Themalath.."ratbinc"..msg.sender_id.user_id,300)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 500000 درهم 💵\n⇜ وظيفتك : ملك 👑\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : `"..convert_mony.."` درهم 💵\n✧","md",true)
end
...
Redis:setex(Themalath.."iiioo" .. msg.sender_id.user_id,600, true)
Redis:incrby(Themalath.."ratbinc"..msg.sender_id.user_id,1)
ratbinc = Redis:get(Themalath.."ratbinc"..msg.sender_id.user_id) or 0
if tonumber(ratbinc) == 270 or tonumber(ratbinc) == 271 then
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 200000 درهم 💵\n⇜ وظيفتك : امير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(Themalath.."ratbinc"..msg.sender_id.user_id,270)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 200000 درهم 💵\n⇜ وظيفتك : امير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 100000 درهم 💵\n⇜ وظيفتك : وزير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(Themalath.."ratbinc"..msg.sender_id.user_id,240)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 100000 درهم 💵\n⇜ وظيفتك : وزير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
Redis:set(Themalath.."ratbinc"..msg.sender_id.user_id,210)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 70000 درهم 💵\n⇜ وظيفتك : بزنس مان كبير 💸\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 40000 درهم 💵\n⇜ وظيفتك : تاجر صغير 💰\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(Themalath.."ratbinc"..msg.sender_id.user_id,180)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 40000 درهم 💵\n⇜ وظيفتك : تاجر صغير 💰\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 25000 درهم 💵\n⇜ وظيفتك : طيار 👨‍✈️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(Themalath.."ratbinc"..msg.sender_id.user_id,150)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 25000 درهم 💵\n⇜ وظيفتك : طيار 👨‍✈️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 18000 درهم 💵\n⇜ وظيفتك : دكتور 👨‍⚕️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(Themalath.."ratbinc"..msg.sender_id.user_id,120)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 18000 درهم 💵\n⇜ وظيفتك : دكتور 👨‍⚕️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 9000 درهم 💵\n⇜ وظيفتك : صيدلي 👨‍🔬\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(Themalath.."ratbinc"..msg.sender_id.user_id,90)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 9000 درهم 💵\n⇜ وظيفتك : صيدلي 👨‍🔬\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 2500 درهم 💵\n⇜ وظيفتك : نجار 👨‍🔧\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(Themalath.."ratbinc"..msg.sender_id.user_id,60)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 2500 درهم 💵\n⇜ وظيفتك : نجار 👨‍🔧\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
Redis:set(Themalath.."ratbinc"..msg.sender_id.user_id,30)
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 500 درهم 💵\n⇜ وظيفتك : قروي 👨‍🌾\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 500 درهم 💵\n⇜ وظيفتك : قروي 👨‍🌾\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
Redis:del(Themalath.."ratbtrans"..msg.sender_id.user_id)
Redis:set(Themalath.."ratbtrans"..msg.sender_id.user_id,10)
nowbalc = tonumber(ballancee) - 1000000000
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(nowbalc))
...
Redis:del(Themalath.."ratbtrans"..msg.sender_id.user_id)
Redis:set(Themalath.."ratbtrans"..msg.sender_id.user_id,9)
...
Redis:del(Themalath.."ratbtrans"..msg.sender_id.user_id)
Redis:set(Themalath.."ratbtrans"..msg.sender_id.user_id,8)
...
Redis:del(Themalath.."ratbtrans"..msg.sender_id.user_id)
Redis:set(Themalath.."ratbtrans"..msg.sender_id.user_id,7)
...
Redis:del(Themalath.."ratbtrans"..msg.sender_id.user_id)
Redis:set(Themalath.."ratbtrans"..msg.sender_id.user_id,6)
...
Redis:del(Themalath.."ratbtrans"..msg.sender_id.user_id)
Redis:set(Themalath.."ratbtrans"..msg.sender_id.user_id,5)
...
Redis:del(Themalath.."ratbtrans"..msg.sender_id.user_id)
Redis:set(Themalath.."ratbtrans"..msg.sender_id.user_id,4)
...
Redis:del(Themalath.."ratbtrans"..msg.sender_id.user_id)
Redis:set(Themalath.."ratbtrans"..msg.sender_id.user_id,3)
...
Redis:del(Themalath.."ratbtrans"..msg.sender_id.user_id)
Redis:set(Themalath.."ratbtrans"..msg.sender_id.user_id,2)
...
if Redis:ttl(Themalath.."attack" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Themalath.."attack" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ خسرت بأخر معركة استنى "..time.." ","md",true)
end
if Redis:ttl(Themalath.."defen" .. Remsg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Themalath.."defen" .. Remsg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ الخصم خسر بأخر معركة\n⇜ يمديك تهاجمه بعد "..time.." ","md",true)
end
if Redis:sismember(Themalath.."booob",Remsg.sender_id.user_id) then
ballancope = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
ballanceed = Redis:get(Themalath.."boob"..Remsg.sender_id.user_id) or 0
...
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(zrfne))
Redis:set(Themalath.."boob"..Remsg.sender_id.user_id , math.floor(zrfnee))
Redis:setex(Themalath.."attack" .. msg.sender_id.user_id,600, true)
...
local ballanceed = Redis:get(Themalath.."boob"..Remsg.sender_id.user_id) or 0
local ballancope = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
begaatt = Redis:get(Themalath.."numattack"..msg.sender_id.user_id) or 200
...
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(zrfne))
Redis:set(Themalath.."boob"..Remsg.sender_id.user_id , math.floor(zrfnee))
Redis:setex(Themalath.."defen" .. Remsg.sender_id.user_id,1800, true)
Redis:set(Themalath.."numattack"..msg.sender_id.user_id , math.floor(numattackk))
...
Redis:setex(Themalath.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
send(msg.chat_id,msg.id,[[
...
if text == "سيارات" and Redis:get(Themalath.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(Themalath.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id,[[
...
if text == "طيارات" and Redis:get(Themalath.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(Themalath.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id,[[
...
if text == "عقارات" and Redis:get(Themalath.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(Themalath.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id,[[
...
if text == "مجوهرات" and Redis:get(Themalath.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(Themalath.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id,[[
...
ballance = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
...
local mgrmasname = Redis:get(Themalath.."mgrmasname"..msg.sender_id.user_id)
local mgrmasprice = Redis:get(Themalath.."mgrmasprice"..msg.sender_id.user_id) or 0
local mgrmasnum = Redis:get(Themalath.."mgrmasnum"..msg.sender_id.user_id) or 0
local mgrmasnow = tonumber(mgrmasnum) + tonumber(coniss)
Redis:set(Themalath.."mgrmasnum"..msg.sender_id.user_id , mgrmasnow)
masnamed = "ماسه"
Redis:set(Themalath.."mgrmasname"..msg.sender_id.user_id , masnamed)
Redis:set(Themalath.."mgrmasprice"..msg.sender_id.user_id , 1000000)
totalypalice = tonumber(ballance) - tonumber(masmgr)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
...
local mgrkldname = Redis:get(Themalath.."mgrkldname"..msg.sender_id.user_id)
local mgrkldprice = Redis:get(Themalath.."mgrkldprice"..msg.sender_id.user_id) or 0
local mgrkldnum = Redis:get(Themalath.."mgrkldnum"..msg.sender_id.user_id) or 0
local mgrkldnow = tonumber(mgrkldnum) + tonumber(coniss)
Redis:set(Themalath.."mgrkldnum"..msg.sender_id.user_id , mgrkldnow)
kldnamed = "قلاده"
Redis:set(Themalath.."mgrkldname"..msg.sender_id.user_id , kldnamed)
Redis:set(Themalath.."mgrkldprice"..msg.sender_id.user_id , 500000)
...
local mgrswrname = Redis:get(Themalath.."mgrswrname"..msg.sender_id.user_id)
local mgrswrprice = Redis:get(Themalath.."mgrswrprice"..msg.sender_id.user_id) or 0
local mgrswrnum = Redis:get(Themalath.."mgrswrnum"..msg.sender_id.user_id) or 0
local mgrswrnow = tonumber(mgrswrnum) + tonumber(coniss)
Redis:set(Themalath.."mgrswrnum"..msg.sender_id.user_id , mgrswrnow)
swrnamed = "سوار"
Redis:set(Themalath.."mgrswrname"..msg.sender_id.user_id , swrnamed)
Redis:set(Themalath.."mgrswrprice"..msg.sender_id.user_id , 200000)
...
local mgrktmname = Redis:get(Themalath.."mgrktmname"..msg.sender_id.user_id)
local mgrktmprice = Redis:get(Themalath.."mgrktmprice"..msg.sender_id.user_id) or 0
local mgrktmnum = Redis:get(Themalath.."mgrktmnum"..msg.sender_id.user_id) or 0
local mgrktmnow = tonumber(mgrktmnum) + tonumber(coniss)
Redis:set(Themalath.."mgrktmnum"..msg.sender_id.user_id , mgrktmnow)
ktmnamed = "خاتم"
Redis:set(Themalath.."mgrktmname"..msg.sender_id.user_id , ktmnamed)
Redis:set(Themalath.."mgrktmprice"..msg.sender_id.user_id , 50000)
...
Redis:set(Themalath.."boob"..msg.sender_id.user_id , totalypalice)
local convert_mony = string.format("%.0f",math.floor(totalypalice))
local mgrmasnum = Redis:get(Themalath.."mgrmasnum"..msg.sender_id.user_id) or 0
if tonumber(mgrmasnum) == 0 then
Redis:del(Themalath.."mgrmasname"..msg.sender_id.user_id)
...
if Redis:ttl(Themalath.."giftmmt" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Themalath.."giftmmt" .. msg.sender_id.user_id))
...
local mgrmasnow = tonumber(mgrmasnum) - tonumber(coniss)
Redis:set(Themalath.."mgrmasnum"..msg.sender_id.user_id , mgrmasnow)
local mgrmasnumm = Redis:get(Themalath.."mgrmasnum"..Remsg.sender_id.user_id) or 0
local mgrmasnoww = tonumber(mgrmasnumm) + tonumber(coniss)
Redis:set(Themalath.."mgrmasnum"..Remsg.sender_id.user_id , mgrmasnoww)
masnamed = "ماسه"
Redis:set(Themalath.."mgrmasname"..Remsg.sender_id.user_id,masnamed)
local mgrmasnum = Redis:get(Themalath.."mgrmasnum"..msg.sender_id.user_id) or 0
if tonumber(mgrmasnum) == 0 then
Redis:del(Themalath.."mgrmasname"..msg.sender_id.user_id)
Redis:del(Themalath.."mgrmasnum"..msg.sender_id.user_id)
end
Redis:setex(Themalath.."giftmmt" .. msg.sender_id.user_id,1800, true)
...
local mgrkldnow = tonumber(mgrkldnum) - tonumber(coniss)
Redis:set(Themalath.."mgrkldnum"..msg.sender_id.user_id , mgrkldnow)
local mgrkldnumm = Redis:get(Themalath.."mgrkldnum"..Remsg.sender_id.user_id) or 0
local mgrkldnoww = tonumber(mgrkldnumm) + tonumber(coniss)
Redis:set(Themalath.."mgrkldnum"..Remsg.sender_id.user_id , mgrkldnoww)
kldnamed = "قلاده"
Redis:set(Themalath.."mgrkldname"..Remsg.sender_id.user_id,kldnamed)
local mgrkldnum = Redis:get(Themalath.."mgrkldnum"..msg.sender_id.user_id) or 0
if tonumber(mgrkldnum) == 0 then
Redis:del(Themalath.."mgrkldname"..msg.sender_id.user_id)
Redis:del(Themalath.."mgrkldnum"..msg.sender_id.user_id)
...
local mgrswrnow = tonumber(mgrswrnum) - tonumber(coniss)
Redis:set(Themalath.."mgrswrnum"..msg.sender_id.user_id , mgrswrnow)
local mgrswrnumm = Redis:get(Themalath.."mgrswrnum"..Remsg.sender_id.user_id) or 0
local mgrswrnoww = tonumber(mgrswrnumm) + tonumber(coniss)
Redis:set(Themalath.."mgrswrnum"..Remsg.sender_id.user_id , mgrswrnoww)
swrnamed = "سوار"
Redis:set(Themalath.."mgrswrname"..Remsg.sender_id.user_id,swrnamed)
local mgrswrnum = Redis:get(Themalath.."mgrswrnum"..msg.sender_id.user_id) or 0
if tonumber(mgrswrnum) == 0 then
Redis:del(Themalath.."mgrswrname"..msg.sender_id.user_id)
Redis:del(Themalath.."mgrswrnum"..msg.sender_id.user_id)
...
local mgrktmnow = tonumber(mgrktmnum) - tonumber(coniss)
Redis:set(Themalath.."mgrktmnum"..msg.sender_id.user_id , mgrktmnow)
local mgrktmnumm = Redis:get(Themalath.."mgrktmnum"..Remsg.sender_id.user_id) or 0
local mgrktmnoww = tonumber(mgrktmnumm) + tonumber(coniss)
Redis:set(Themalath.."mgrktmnum"..Remsg.sender_id.user_id , mgrktmnoww)
ktmnamed = "خاتم"
Redis:set(Themalath.."mgrktmname"..Remsg.sender_id.user_id,ktmnamed)
local mgrktmnum = Redis:get(Themalath.."mgrktmnum"..msg.sender_id.user_id) or 0
if tonumber(mgrktmnum) == 0 then
Redis:del(Themalath.."mgrktmname"..msg.sender_id.user_id)
Redis:del(Themalath.."mgrktmnum"..msg.sender_id.user_id)
...
local akrksrname = Redis:get(Themalath.."akrksrname"..msg.sender_id.user_id)
local akrksrprice = Redis:get(Themalath.."akrksrprice"..msg.sender_id.user_id) or 0
local akrksrnum = Redis:get(Themalath.."akrksrnum"..msg.sender_id.user_id) or 0
local akrksrnow = tonumber(akrksrnum) + tonumber(coniss)
Redis:set(Themalath.."akrksrnum"..msg.sender_id.user_id , akrksrnow)
ksrnamed = "قصر"
Redis:set(Themalath.."akrksrname"..msg.sender_id.user_id , ksrnamed)
Redis:set(Themalath.."akrksrprice"..msg.sender_id.user_id , 1000000)
...
local akrfelname = Redis:get(Themalath.."akrfelname"..msg.sender_id.user_id)
local akrfelprice = Redis:get(Themalath.."akrfelprice"..msg.sender_id.user_id) or 0
local akrfelnum = Redis:get(Themalath.."akrfelnum"..msg.sender_id.user_id) or 0
local akrfelnow = tonumber(akrfelnum) + tonumber(coniss)
Redis:set(Themalath.."akrfelnum"..msg.sender_id.user_id , akrfelnow)
felnamed = "فيلا"
Redis:set(Themalath.."akrfelname"..msg.sender_id.user_id , felnamed)
Redis:set(Themalath.."akrfelprice"..msg.sender_id.user_id , 500000)
...
local akrmnzname = Redis:get(Themalath.."akrmnzname"..msg.sender_id.user_id)
local akrmnzprice = Redis:get(Themalath.."akrmnzprice"..msg.sender_id.user_id) or 0
local akrmnznum = Redis:get(Themalath.."akrmnznum"..msg.sender_id.user_id) or 0
local akrmnznow = tonumber(akrmnznum) + tonumber(coniss)
Redis:set(Themalath.."akrmnznum"..msg.sender_id.user_id , akrmnznow)
mnznamed = "منزل"
Redis:set(Themalath.."akrmnzname"..msg.sender_id.user_id , mnznamed)
Redis:set(Themalath.."akrmnzprice"..msg.sender_id.user_id , 200000)
...
local akrksrnow = tonumber(akrksrnum) - tonumber(coniss)
Redis:set(Themalath.."akrksrnum"..msg.sender_id.user_id , akrksrnow)
local akrksrnumm = Redis:get(Themalath.."akrksrnum"..Remsg.sender_id.user_id) or 0
local akrksrnoww = tonumber(akrksrnumm) + tonumber(coniss)
Redis:set(Themalath.."akrksrnum"..Remsg.sender_id.user_id , akrksrnoww)
ksrnamed = "قصر"
Redis:set(Themalath.."akrksrname"..Remsg.sender_id.user_id,ksrnamed)
local akrksrnum = Redis:get(Themalath.."akrksrnum"..msg.sender_id.user_id) or 0
if tonumber(akrksrnum) == 0 then
Redis:del(Themalath.."akrksrname"..msg.sender_id.user_id)
Redis:del(Themalath.."akrksrnum"..msg.sender_id.user_id)
...
local akrfelnow = tonumber(akrfelnum) - tonumber(coniss)
Redis:set(Themalath.."akrfelnum"..msg.sender_id.user_id , akrfelnow)
local akrfelnumm = Redis:get(Themalath.."akrfelnum"..Remsg.sender_id.user_id) or 0
local akrfelnoww = tonumber(akrfelnumm) + tonumber(coniss)
Redis:set(Themalath.."akrfelnum"..Remsg.sender_id.user_id , akrfelnoww)
felnamed = "فيلا"
Redis:set(Themalath.."akrfelname"..Remsg.sender_id.user_id,felnamed)
local akrfelnum = Redis:get(Themalath.."akrfelnum"..msg.sender_id.user_id) or 0
if tonumber(akrfelnum) == 0 then
Redis:del(Themalath.."akrfelname"..msg.sender_id.user_id)
Redis:del(Themalath.."akrfelnum"..msg.sender_id.user_id)
...
local akrmnznow = tonumber(akrmnznum) - tonumber(coniss)
Redis:set(Themalath.."akrmnznum"..msg.sender_id.user_id , akrmnznow)
local akrmnznumm = Redis:get(Themalath.."akrmnznum"..Remsg.sender_id.user_id) or 0
local akrmnznoww = tonumber(akrmnznumm) + tonumber(coniss)
Redis:set(Themalath.."akrmnznum"..Remsg.sender_id.user_id , akrmnznoww)
mnznamed = "منزل"
Redis:set(Themalath.."akrmnzname"..Remsg.sender_id.user_id,mnznamed)
local akrmnznum = Redis:get(Themalath.."akrmnznum"..msg.sender_id.user_id) or 0
if tonumber(akrmnznum) == 0 then
Redis:del(Themalath.."akrmnzname"..msg.sender_id.user_id)
Redis:del(Themalath.."akrmnznum"..msg.sender_id.user_id)
...
local airshbhname = Redis:get(Themalath.."airshbhname"..msg.sender_id.user_id)
local airshbhprice = Redis:get(Themalath.."airshbhprice"..msg.sender_id.user_id) or 0
local airshbhnum = Redis:get(Themalath.."airshbhnum"..msg.sender_id.user_id) or 0
local airshbhnow = tonumber(airshbhnum) + tonumber(coniss)
Redis:set(Themalath.."airshbhnum"..msg.sender_id.user_id , airshbhnow)
shbhnamed = "شبح"
Redis:set(Themalath.."airshbhname"..msg.sender_id.user_id , shbhnamed)
Redis:set(Themalath.."airshbhprice"..msg.sender_id.user_id , 1000000000)
...
local airsfarname = Redis:get(Themalath.."airsfarname"..msg.sender_id.user_id)
local airsfarprice = Redis:get(Themalath.."airsfarprice"..msg.sender_id.user_id) or 0
local airsfarnum = Redis:get(Themalath.."airsfarnum"..msg.sender_id.user_id) or 0
local airsfarnow = tonumber(airsfarnum) + tonumber(coniss)
Redis:set(Themalath.."airsfarnum"..msg.sender_id.user_id , airsfarnow)
sfarnamed = "سفر"
Redis:set(Themalath.."airsfarname"..msg.sender_id.user_id , sfarnamed)
Redis:set(Themalath.."airsfarprice"..msg.sender_id.user_id , 500000000)
...
local airkhasname = Redis:get(Themalath.."airkhasname"..msg.sender_id.user_id)
local airkhasprice = Redis:get(Themalath.."airkhasprice"..msg.sender_id.user_id) or 0
local airkhasnum = Redis:get(Themalath.."airkhasnum"..msg.sender_id.user_id) or 0
local airkhasnow = tonumber(airkhasnum) + tonumber(coniss)
Redis:set(Themalath.."airkhasnum"..msg.sender_id.user_id , airkhasnow)
khasnamed = "خاصه"
Redis:set(Themalath.."airkhasname"..msg.sender_id.user_id , khasnamed)
Redis:set(Themalath.."airkhasprice"..msg.sender_id.user_id , 200000000)
...
local airshbhnow = tonumber(airshbhnum) - tonumber(coniss)
Redis:set(Themalath.."airshbhnum"..msg.sender_id.user_id , airshbhnow)
local airshbhnumm = Redis:get(Themalath.."airshbhnum"..Remsg.sender_id.user_id) or 0
local airshbhnoww = tonumber(airshbhnumm) + tonumber(coniss)
Redis:set(Themalath.."airshbhnum"..Remsg.sender_id.user_id , airshbhnoww)
shbhnamed = "شبح"
Redis:set(Themalath.."airshbhname"..Remsg.sender_id.user_id,shbhnamed)
local airshbhnum = Redis:get(Themalath.."airshbhnum"..msg.sender_id.user_id) or 0
if tonumber(airshbhnum) == 0 then
Redis:del(Themalath.."airshbhname"..msg.sender_id.user_id)
Redis:del(Themalath.."airshbhnum"..msg.sender_id.user_id)
...
local airsfarnow = tonumber(airsfarnum) - tonumber(coniss)
Redis:set(Themalath.."airsfarnum"..msg.sender_id.user_id , airsfarnow)
local airsfarnumm = Redis:get(Themalath.."airsfarnum"..Remsg.sender_id.user_id) or 0
local airsfarnoww = tonumber(airsfarnumm) + tonumber(coniss)
Redis:set(Themalath.."airsfarnum"..Remsg.sender_id.user_id , airsfarnoww)
sfarnamed = "سفر"
Redis:set(Themalath.."airsfarname"..Remsg.sender_id.user_id,sfarnamed)
local airsfarnum = Redis:get(Themalath.."airsfarnum"..msg.sender_id.user_id) or 0
if tonumber(airsfarnum) == 0 then
Redis:del(Themalath.."airsfarname"..msg.sender_id.user_id)
Redis:del(Themalath.."airsfarnum"..msg.sender_id.user_id)
...
local airkhasnow = tonumber(airkhasnum) - tonumber(coniss)
Redis:set(Themalath.."airkhasnum"..msg.sender_id.user_id , airkhasnow)
local airkhasnumm = Redis:get(Themalath.."airkhasnum"..Remsg.sender_id.user_id) or 0
local airkhasnoww = tonumber(airkhasnumm) + tonumber(coniss)
Redis:set(Themalath.."airkhasnum"..Remsg.sender_id.user_id , airkhasnoww)
khasnamed = "خاصه"
Redis:set(Themalath.."airkhasname"..Remsg.sender_id.user_id,khasnamed)
local airkhasnum = Redis:get(Themalath.."airkhasnum"..msg.sender_id.user_id) or 0
if tonumber(airkhasnum) == 0 then
Redis:del(Themalath.."airkhasname"..msg.sender_id.user_id)
Redis:del(Themalath.."airkhasnum"..msg.sender_id.user_id)
...
local carrangname = Redis:get(Themalath.."carrangname"..msg.sender_id.user_id)
local carrangprice = Redis:get(Themalath.."carrangprice"..msg.sender_id.user_id) or 0
local carrangnum = Redis:get(Themalath.."carrangnum"..msg.sender_id.user_id) or 0
local carrangnow = tonumber(carrangnum) + tonumber(coniss)
Redis:set(Themalath.."carrangnum"..msg.sender_id.user_id , carrangnow)
rangnamed = "فيلار"
Redis:set(Themalath.."carrangname"..msg.sender_id.user_id , rangnamed)
Redis:set(Themalath.."carrangprice"..msg.sender_id.user_id , 10000000)
...
local caraccename = Redis:get(Themalath.."caraccename"..msg.sender_id.user_id)
local caracceprice = Redis:get(Themalath.."caracceprice"..msg.sender_id.user_id) or 0
local caraccenum = Redis:get(Themalath.."caraccenum"..msg.sender_id.user_id) or 0
local caraccenow = tonumber(caraccenum) + tonumber(coniss)
Redis:set(Themalath.."caraccenum"..msg.sender_id.user_id , caraccenow)
accenamed = "اكسنت"
Redis:set(Themalath.."caraccename"..msg.sender_id.user_id , accenamed)
Redis:set(Themalath.."caracceprice"..msg.sender_id.user_id , 9000000)
...
local carcamrname = Redis:get(Themalath.."carcamrname"..msg.sender_id.user_id)
local carcamrprice = Redis:get(Themalath.."carcamrprice"..msg.sender_id.user_id) or 0
local carcamrnum = Redis:get(Themalath.."carcamrnum"..msg.sender_id.user_id) or 0
local carcamrnow = tonumber(carcamrnum) + tonumber(coniss)
Redis:set(Themalath.."carcamrnum"..msg.sender_id.user_id , carcamrnow)
camrnamed = "كامري"
Redis:set(Themalath.."carcamrname"..msg.sender_id.user_id , camrnamed)
Redis:set(Themalath.."carcamrprice"..msg.sender_id.user_id , 8000000)
...
local caralntrname = Redis:get(Themalath.."caralntrname"..msg.sender_id.user_id)
local caralntrprice = Redis:get(Themalath.."caralntrprice"..msg.sender_id.user_id) or 0
local caralntrnum = Redis:get(Themalath.."caralntrnum"..msg.sender_id.user_id) or 0
local caralntrnow = tonumber(caralntrnum) + tonumber(coniss)
Redis:set(Themalath.."caralntrnum"..msg.sender_id.user_id , caralntrnow)
alntrnamed = "النترا"
Redis:set(Themalath.."caralntrname"..msg.sender_id.user_id , alntrnamed)
Redis:set(Themalath.."caralntrprice"..msg.sender_id.user_id , 7000000)
...
local carhilxname = Redis:get(Themalath.."carhilxname"..msg.sender_id.user_id)
local carhilxprice = Redis:get(Themalath.."carhilxprice"..msg.sender_id.user_id) or 0
local carhilxnum = Redis:get(Themalath.."carhilxnum"..msg.sender_id.user_id) or 0
local carhilxnow = tonumber(carhilxnum) + tonumber(coniss)
Redis:set(Themalath.."carhilxnum"..msg.sender_id.user_id , carhilxnow)
hilxnamed = "هايلكس"
Redis:set(Themalath.."carhilxname"..msg.sender_id.user_id , hilxnamed)
Redis:set(Themalath.."carhilxprice"..msg.sender_id.user_id , 6000000)
...
local carsonaname = Redis:get(Themalath.."carsonaname"..msg.sender_id.user_id)
local carsonaprice = Redis:get(Themalath.."carsonaprice"..msg.sender_id.user_id) or 0
local carsonanum = Redis:get(Themalath.."carsonanum"..msg.sender_id.user_id) or 0
local carsonanow = tonumber(carsonanum) + tonumber(coniss)
Redis:set(Themalath.."carsonanum"..msg.sender_id.user_id , carsonanow)
sonanamed = "سوناتا"
Redis:set(Themalath.."carsonaname"..msg.sender_id.user_id , sonanamed)
Redis:set(Themalath.."carsonaprice"..msg.sender_id.user_id , 5000000)
...
local carcoroname = Redis:get(Themalath.."carcoroname"..msg.sender_id.user_id)
local carcoroprice = Redis:get(Themalath.."carcoroprice"..msg.sender_id.user_id) or 0
local carcoronum = Redis:get(Themalath.."carcoronum"..msg.sender_id.user_id) or 0
local carcoronow = tonumber(carcoronum) + tonumber(coniss)
Redis:set(Themalath.."carcoronum"..msg.sender_id.user_id , carcoronow)
coronamed = "كورولا"
Redis:set(Themalath.."carcoroname"..msg.sender_id.user_id , coronamed)
Redis:set(Themalath.."carcoroprice"..msg.sender_id.user_id , 4000000)
...
local carrangnow = tonumber(carrangnum) - tonumber(coniss)
Redis:set(Themalath.."carrangnum"..msg.sender_id.user_id , carrangnow)
local carrangnumm = Redis:get(Themalath.."carrangnum"..Remsg.sender_id.user_id) or 0
local carrangnoww = tonumber(carrangnumm) + tonumber(coniss)
Redis:set(Themalath.."carrangnum"..Remsg.sender_id.user_id , carrangnoww)
rangnamed = "فيلار"
Redis:set(Themalath.."carrangname"..Remsg.sender_id.user_id,rangnamed)
local carrangnum = Redis:get(Themalath.."carrangnum"..msg.sender_id.user_id) or 0
if tonumber(carrangnum) == 0 then
Redis:del(Themalath.."carrangname"..msg.sender_id.user_id)
Redis:del(Themalath.."carrangnum"..msg.sender_id.user_id)
...
local caraccenow = tonumber(caraccenum) - tonumber(coniss)
Redis:set(Themalath.."caraccenum"..msg.sender_id.user_id , caraccenow)
local caraccenumm = Redis:get(Themalath.."caraccenum"..Remsg.sender_id.user_id) or 0
local caraccenoww = tonumber(caraccenumm) + tonumber(coniss)
Redis:set(Themalath.."caraccenum"..Remsg.sender_id.user_id , caraccenoww)
accenamed = "اكسنت"
Redis:set(Themalath.."caraccename"..Remsg.sender_id.user_id,accenamed)
local caraccenum = Redis:get(Themalath.."caraccenum"..msg.sender_id.user_id) or 0
if tonumber(caraccenum) == 0 then
Redis:del(Themalath.."caraccename"..msg.sender_id.user_id)
Redis:del(Themalath.."caraccenum"..msg.sender_id.user_id)
...
local carcamrnow = tonumber(carcamrnum) - tonumber(coniss)
Redis:set(Themalath.."carcamrnum"..msg.sender_id.user_id , carcamrnow)
local carcamrnumm = Redis:get(Themalath.."carcamrnum"..Remsg.sender_id.user_id) or 0
local carcamrnoww = tonumber(carcamrnumm) + tonumber(coniss)
Redis:set(Themalath.."carcamrnum"..Remsg.sender_id.user_id , carcamrnoww)
camrnamed = "كامري"
Redis:set(Themalath.."carcamrname"..Remsg.sender_id.user_id,camrnamed)
local carcamrnum = Redis:get(Themalath.."carcamrnum"..msg.sender_id.user_id) or 0
if tonumber(carcamrnum) == 0 then
Redis:del(Themalath.."carcamrname"..msg.sender_id.user_id)
Redis:del(Themalath.."carcamrnum"..msg.sender_id.user_id)
...
local carhilxnow = tonumber(carhilxnum) - tonumber(coniss)
Redis:set(Themalath.."carhilxnum"..msg.sender_id.user_id , carhilxnow)
local carhilxnumm = Redis:get(Themalath.."carhilxnum"..Remsg.sender_id.user_id) or 0
local carhilxnoww = tonumber(carhilxnumm) + tonumber(coniss)
Redis:set(Themalath.."carhilxnum"..Remsg.sender_id.user_id , carhilxnoww)
hilxnamed = "هايلكس"
Redis:set(Themalath.."carhilxname"..Remsg.sender_id.user_id,hilxnamed)
local carhilxnum = Redis:get(Themalath.."carhilxnum"..msg.sender_id.user_id) or 0
if tonumber(carhilxnum) == 0 then
Redis:del(Themalath.."carhilxname"..msg.sender_id.user_id)
Redis:del(Themalath.."carhilxnum"..msg.sender_id.user_id)
...
local caralntrnow = tonumber(caralntrnum) - tonumber(coniss)
Redis:set(Themalath.."caralntrnum"..msg.sender_id.user_id , caralntrnow)
local caralntrnumm = Redis:get(Themalath.."caralntrnum"..Remsg.sender_id.user_id) or 0
local caralntrnoww = tonumber(caralntrnumm) + tonumber(coniss)
Redis:set(Themalath.."caralntrnum"..Remsg.sender_id.user_id , caralntrnoww)
alntrnamed = "النترا"
Redis:set(Themalath.."caralntrname"..Remsg.sender_id.user_id,alntrnamed)
local caralntrnum = Redis:get(Themalath.."caralntrnum"..msg.sender_id.user_id) or 0
if tonumber(caralntrnum) == 0 then
Redis:del(Themalath.."caralntrname"..msg.sender_id.user_id)
Redis:del(Themalath.."caralntrnum"..msg.sender_id.user_id)
...
local carsonanow = tonumber(carsonanum) - tonumber(coniss)
Redis:set(Themalath.."carsonanum"..msg.sender_id.user_id , carsonanow)
local carsonanumm = Redis:get(Themalath.."carsonanum"..Remsg.sender_id.user_id) or 0
local carsonanoww = tonumber(carsonanumm) + tonumber(coniss)
Redis:set(Themalath.."carsonanum"..Remsg.sender_id.user_id , carsonanoww)
sonanamed = "سوناتا"
Redis:set(Themalath.."carsonaname"..Remsg.sender_id.user_id,sonanamed)
local carsonanum = Redis:get(Themalath.."carsonanum"..msg.sender_id.user_id) or 0
if tonumber(carsonanum) == 0 then
Redis:del(Themalath.."carsonaname"..msg.sender_id.user_id)
Redis:del(Themalath.."carsonanum"..msg.sender_id.user_id)
...
local carcoronow = tonumber(carcoronum) - tonumber(coniss)
Redis:set(Themalath.."carcoronum"..msg.sender_id.user_id , carcoronow)
local carcoronumm = Redis:get(Themalath.."carcoronum"..Remsg.sender_id.user_id) or 0
local carcoronoww = tonumber(carcoronumm) + tonumber(coniss)
Redis:set(Themalath.."carcoronum"..Remsg.sender_id.user_id , carcoronoww)
coronamed = "كورولا"
Redis:set(Themalath.."carcoroname"..Remsg.sender_id.user_id,coronamed)
local carcoronum = Redis:get(Themalath.."carcoronum"..msg.sender_id.user_id) or 0
if tonumber(carcoronum) == 0 then
Redis:del(Themalath.."carcoroname"..msg.sender_id.user_id)
Redis:del(Themalath.."carcoronum"..msg.sender_id.user_id)
...
if Redis:get(Themalath.."zwag_request:"..msg.sender_id.user_id) then 
...
if Redis:get(Themalath.."roog1"..msg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ ابك تراك متزوج !!","md",true)
return false
end
if Redis:get(Themalath.."rooga1"..msg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ ابك تراك متزوج !!","md",true)
return false
end
if Redis:get(Themalath.."roog1"..Remsg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ ابعد بعيد لاتحوس وتدور حول المتزوجين","md",true)
return false
end
if Redis:get(Themalath.."rooga1"..Remsg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ ابعد بعيد لاتحوس وتدور حول المتزوجين","md",true)
return false
end
if Redis:sismember(Themalath.."booob",msg.sender_id.user_id) then
...
Redis:setex(Themalath.."zwag_request:"..msg.sender_id.user_id,60,true)
Redis:setex(Themalath.."zwag_request:"..Remsg.sender_id.user_id,60,true)
...
if msg.ControllerBot then
  ...
  zwag_list = {}
  for k,v in pairs(zwag_users) do
  local mahr = Redis:get(Themalath.."rahr1"..v)
  local zwga = Redis:get(Themalath.."rooga1"..v)
...
"30)"
  ...
  local zwga_name = bot.getUser(v[3]).first_name or Redis:get(Themalath..v[3].."first_name:") or "لا يوجد اسم"
...
kk = kk:gsub("#[%a%d_]+",'')
local doltebank = Redis:get(Themalath.."doltebank"..v[2]) or " "
local doltebankz = Redis:get(Themalath.."doltebank"..v[3]) or " "
local mony = v[1]
local convert_mony = string.format("%.0f",mony)
local emo = zwag_emoji[k]
znum = znum + 1
...
if Redis:sismember(Themalath.."roogg1",msg.sender_id.user_id) or Redis:sismember(Themalath.."roogga1",msg.sender_id.user_id) then
local zoog = Redis:get(Themalath.."roog1"..msg.sender_id.user_id)
local zooga = Redis:get(Themalath.."rooga1"..msg.sender_id.user_id)
local mahr = Redis:get(Themalath.."rahr1"..msg.sender_id.user_id)
...
if Redis:sismember(Themalath.."roogg1",Remsg.sender_id.user_id) or Redis:sismember(Themalath.."roogga1",Remsg.sender_id.user_id) then
if Redis:sismember(Themalath.."booob",msg.sender_id.user_id) then
ballancee = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
if tonumber(ballancee) < 100 then
return send(msg.chat_id,msg.id, "⇜ فلوسك ماتكفي \n✧","md",true)
...
local zoog = Redis:get(Themalath.."roog1"..Remsg.sender_id.user_id)
local zooga = Redis:get(Themalath.."rooga1"..Remsg.sender_id.user_id)
local mahr = Redis:get(Themalath.."rahr1"..Remsg.sender_id.user_id)
local bandd = bot.getUser(zoog)
if bandd.first_name then
neews = "["..bandd.first_name.."](tg://user?id="..bandd.id..")"
else
...
local convert_mony = string.format("%.0f",mahr)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(otheka))
...
local zoog = Redis:get(Themalath.."roog1"..msg.sender_id.user_id)
local zooga = tonumber(Redis:get(Themalath.."rooga1"..msg.sender_id.user_id))
...
Redis:del(Themalath.."rahr1"..msg.sender_id.user_id)
Redis:del(Themalath.."rahrr1"..msg.sender_id.user_id)
Redis:srem(Themalath.."roogg1", zooga)
Redis:srem(Themalath.."roogga1", zooga)
Redis:del(Themalath.."roog1"..zooga)
Redis:del(Themalath.."rooga1"..zooga)
Redis:del(Themalath.."rahr1"..zooga)
Redis:del(Themalath.."rahrr1"..zooga)
...
local mahrr = Redis:get(Themalath.."rahrr1"..msg.sender_id.user_id)
local bandd = bot.getUser(zoog)
if bandd.first_name then
neews = "["..bandd.first_name.."](tg://user?id="..bandd.id..")"
else
...
ballancee = Redis:get(Themalath.."boob"..zoog) or 0
kalea = ballancee + mahrr
Redis:set(Themalath.."boob"..zoog , kalea)
local convert_mony = string.format("%.0f",mahrr)
send(msg.chat_id,msg.id, "⇜ خلعت زوجك "..neews.."\n⇜ ورجعت له المهر ( "..convert_mony.." درهم 💵 )","md",true)
Redis:srem(Themalath.."roogg1", zoog)
Redis:srem(Themalath.."roogga1", zoog)
Redis:del(Themalath.."roog1"..zoog)
Redis:del(Themalath.."rooga1"..zoog)
Redis:del(Themalath.."rahr1"..zoog)
Redis:del(Themalath.."rahrr1"..zoog)
Redis:srem(Themalath.."roogg1", msg.sender_id.user_id)
Redis:srem(Themalath.."roogga1", msg.sender_id.user_id)
Redis:del(Themalath.."roog1"..msg.sender_id.user_id)
Redis:del(Themalath.."rooga1"..msg.sender_id.user_id)
...
Redis:del(Themalath..'List_rhan'..msg.chat_id)  
Redis:set(Themalath.."playerrhan"..msg.chat_id,msg.sender_id.user_id)
Redis:set(Themalath.."playercoins"..msg.chat_id..msg.sender_id.user_id,coniss)
Redis:set(Themalath.."raeahkam"..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(Themalath..'List_rhan'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(Themalath.."Start_rhan"..msg.chat_id,3600,true)
Redis:set(Themalath.."allrhan"..msg.chat_id..12345 , coniss)
local ballancee = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
rehan = tonumber(ballancee) - tonumber(coniss)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , rehan)
return send(msg.chat_id,msg.id,"⇜ بدينا المراهنة وسجلت اسمك \n⇜ اللي بده يشارك يرسل ( انا والمبلغ ) .","md",true)
end
if text == 'نعم' and Redis:get(Themalath.."Witting_Startrhan"..msg.chat_id) then
rarahkam = Redis:get(Themalath.."raeahkam"..msg.chat_id)
if tonumber(rarahkam) == msg.sender_id.user_id then
local list = Redis:smembers(Themalath..'List_rhan'..msg.chat_id) 
if #list == 1 then 
...
benrahan = Redis:get(Themalath.."allrhan"..msg.chat_id..12345) or 0
local ballancee = Redis:get(Themalath.."boob"..UserName) or 0
rehane = tonumber(benrahan) / 100 * 25
rehan = tonumber(ballancee) + math.floor(rehane)
Redis:set(Themalath.."boob"..UserName , rehan)
local rhan_users = Redis:smembers(Themalath.."List_rhan"..msg.chat_id)
for k,v in pairs(rhan_users) do
Redis:del(Themalath..'playercoins'..msg.chat_id..v)
end
Redis:del(Themalath..'allrhan'..msg.chat_id..12345) 
Redis:del(Themalath..'playerrhan'..msg.chat_id) 
Redis:del(Themalath..'raeahkam'..msg.chat_id) 
Redis:del(Themalath..'List_rhan'..msg.chat_id) 
Redis:del(Themalath.."Witting_Startrhan"..msg.chat_id)
Redis:del(Themalath.."Start_rhan"..msg.chat_id)
local ballancee = Redis:get(Themalath.."boob"..UserName) or 0
...
local bank_users = Redis:smembers(Themalath.."ownernade")
if #bank_users == 0 then
...
mony_listd = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(Themalath.."nokatnade"..v) or 0
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local kk = Redis:get(Themalath.."lkbnade"..v[2])
kk = kk:gsub("🇾🇪️",'')
kk = kk:gsub("🇹🇳",'')
kk = kk:gsub("🇸🇾",'')
kk = kk:gsub("🇸🇩",'')
...
if Redis:sismember(Themalath.."booob",msg.sender_id.user_id) then
if Redis:get(Themalath.."namenade"..msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ لديك نادي مسبقاً ","md",true)
end
if Redis:sismember(Themalath.."lkbnadesadd", Cnamed) then
return send(msg.chat_id,msg.id, "⇜ الاسم موجود مسبقاً\n⇜ اختر اسم اخر\n✧","md",true)
end
Redis:set(Themalath.."lkbnade"..msg.sender_id.user_id, Cnamed)
...
if Redis:sismember(Themalath.."booob",msg.sender_id.user_id) then
if not Redis:get(Themalath.."namenade" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ ماعندك نادي اصلاً\n⇜ قم بانشاء النادي الخاص بك عن طريق الامر \n( `انشاء نادي` ) والاسم","md",true)
end
namfra = Redis:get(Themalath.."lkbnade"..msg.sender_id.user_id)
Redis:del(Themalath.."namenade"..msg.sender_id.user_id)
Redis:del(Themalath.."nokatnade"..msg.sender_id.user_id)
Redis:del(Themalath.."energynade"..msg.sender_id.user_id)
Redis:del(Themalath.."traningnade"..msg.sender_id.user_id)
...
Redis:del(Themalath.."priceplayer".."4"..msg.sender_id.user_id)
Redis:del(Themalath.."priceplayer".."5"..msg.sender_id.user_id)
Redis:srem(Themalath.."lkbnadesadd", namfra)
Redis:srem(Themalath.."ownernade",msg.sender_id.user_id)
Redis:del(Themalath.."lkbnade"..msg.sender_id.user_id)
...
if Redis:ttl(Themalath.."traningnade" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Themalath.."traningnade" .. msg.sender_id.user_id))
...
namenade = Redis:get(Themalath.."namenade"..msg.sender_id.user_id)
energynade = Redis:get(Themalath.."energynade"..msg.sender_id.user_id)
lkbnade = Redis:get(Themalath.."lkbnade"..msg.sender_id.user_id)
namenade = Redis:get(Themalath.."namenade"..msg.sender_id.user_id)
energyplayer1 = Redis:get(Themalath.."energyplayer".."1"..msg.sender_id.user_id)
energyplayer2 = Redis:get(Themalath.."energyplayer".."2"..msg.sender_id.user_id)
energyplayer3 = Redis:get(Themalath.."energyplayer".."3"..msg.sender_id.user_id)
energyplayer4 = Redis:get(Themalath.."energyplayer".."4"..msg.sender_id.user_id)
energyplayer5 = Redis:get(Themalath.."energyplayer".."5"..msg.sender_id.user_id)
if tonumber(energynade) < 151 then
Redis:incrby(Themalath.."energynade"..msg.sender_id.user_id,1)
end
if energyplayer1 then
if tonumber(energyplayer1) < 151 then
Redis:incrby(Themalath.."energyplayer".."1"..msg.sender_id.user_id,1)
end
end
if energyplayer2 then
if tonumber(energyplayer2) < 151 then
Redis:incrby(Themalath.."energyplayer".."2"..msg.sender_id.user_id,1)
end
end
if energyplayer3 then
if tonumber(energyplayer3) < 151 then
Redis:incrby(Themalath.."energyplayer".."3"..msg.sender_id.user_id,1)
end
end
if energyplayer4 then
if tonumber(energyplayer4) < 151 then
Redis:incrby(Themalath.."energyplayer".."4"..msg.sender_id.user_id,1)
end
end
if energyplayer5 then
if tonumber(energyplayer5) < 151 then
Redis:incrby(Themalath.."energyplayer".."5"..msg.sender_id.user_id,1)
end
end
energynade = Redis:get(Themalath.."energynade"..msg.sender_id.user_id)
Redis:setex(Themalath.."traningnade" .. msg.sender_id.user_id,1800, true)
...
Redis:setex(Themalath.."changlkbnade" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
...
if Redis:get(Themalath.."changlkbnade" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(Themalath.."changlkbnade" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
if text == "الغاء" or text == "الغاء الامر" then
return send(msg.chat_id,msg.id, "⇜ تم الغاء امر تغيير لقب النادي","md",true)
end
if Redis:sismember(Themalath.."lkbnadesadd", text) then
return send(msg.chat_id,msg.id, "⇜ الاسم موجود مسبقاً\n⇜ اختر اسم اخر\n✧","md",true)
end
namfra = Redis:get(Themalath.."lkbnade"..msg.sender_id.user_id)
Redis:srem(Themalath.."lkbnadesadd", namfra)
Redis:del(Themalath.."lkbnade"..msg.sender_id.user_id)
Redis:set(Themalath.."lkbnade"..msg.sender_id.user_id, text)
Redis:sadd(Themalath.."lkbnadesadd", text)
ballance = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
cccallcc = tonumber(ballance) - 25000
Redis:set(Themalath.."boob"..msg.sender_id.user_id,cccallcc)
ballance = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
...
nameplayer1 = Redis:get(Themalath.."nameplayer".."1"..msg.sender_id.user_id)
nameplayer2 = Redis:get(Themalath.."nameplayer".."2"..msg.sender_id.user_id)
nameplayer3 = Redis:get(Themalath.."nameplayer".."3"..msg.sender_id.user_id)
nameplayer4 = Redis:get(Themalath.."nameplayer".."4"..msg.sender_id.user_id)
nameplayer5 = Redis:get(Themalath.."nameplayer".."5"..msg.sender_id.user_id)
if nameplayer1 then
mrkzplayer1 = Redis:get(Themalath.."mrkzplayer".."1"..msg.sender_id.user_id)
cityplayer1 = Redis:get(Themalath.."cityplayer".."1"..msg.sender_id.user_id)
energyplayer1 = Redis:get(Themalath.."energyplayer".."1"..msg.sender_id.user_id)
priceplayer1 = Redis:get(Themalath.."priceplayer".."1"..msg.sender_id.user_id)
nameplayer1done = "⌯ اسم اللاعب : `"..nameplayer1.."`\n- مركزه : "..mrkzplayer1.."\n- طاقة اللاعب : "..energyplayer1.."\n- الجنسية : "..cityplayer1.."\n- السعر : "..priceplayer1.."\n\n"
else
nameplayer1done = ""
end
if nameplayer2 then
mrkzplayer2 = Redis:get(Themalath.."mrkzplayer".."2"..msg.sender_id.user_id)
cityplayer2 = Redis:get(Themalath.."cityplayer".."2"..msg.sender_id.user_id)
energyplayer2 = Redis:get(Themalath.."energyplayer".."2"..msg.sender_id.user_id)
priceplayer2 = Redis:get(Themalath.."priceplayer".."2"..msg.sender_id.user_id)
nameplayer2done = "⌯ اسم اللاعب : `"..nameplayer2.."`\n- مركزه : "..mrkzplayer2.."\n- طاقة اللاعب : "..energyplayer2.."\n- الجنسية : "..cityplayer2.."\n- السعر : "..priceplayer2.."\n\n"
else
nameplayer2done = ""
end
if nameplayer3 then
mrkzplayer3 = Redis:get(Themalath.."mrkzplayer".."3"..msg.sender_id.user_id)
cityplayer3 = Redis:get(Themalath.."cityplayer".."3"..msg.sender_id.user_id)
energyplayer3 = Redis:get(Themalath.."energyplayer".."3"..msg.sender_id.user_id)
priceplayer3 = Redis:get(Themalath.."priceplayer".."3"..msg.sender_id.user_id)
nameplayer3done = "⌯ اسم اللاعب : `"..nameplayer3.."`\n- مركزه : "..mrkzplayer3.."\n- طاقة اللاعب : "..energyplayer3.."\n- الجنسية : "..cityplayer3.."\n- السعر : "..priceplayer3.."\n\n"
else
nameplayer3done = ""
end
if nameplayer4 then
mrkzplayer4 = Redis:get(Themalath.."mrkzplayer".."4"..msg.sender_id.user_id)
cityplayer4 = Redis:get(Themalath.."cityplayer".."4"..msg.sender_id.user_id)
energyplayer4 = Redis:get(Themalath.."energyplayer".."4"..msg.sender_id.user_id)
priceplayer4 = Redis:get(Themalath.."priceplayer".."4"..msg.sender_id.user_id)
nameplayer4done = "⌯ اسم اللاعب : `"..nameplayer4.."`\n- مركزه : "..mrkzplayer4.."\n- طاقة اللاعب : "..energyplayer4.."\n- الجنسية : "..cityplayer4.."\n- السعر : "..priceplayer4.."\n\n"
else
nameplayer4done = ""
end
if nameplayer5 then
mrkzplayer5 = Redis:get(Themalath.."mrkzplayer".."5"..msg.sender_id.user_id)
cityplayer5 = Redis:get(Themalath.."cityplayer".."5"..msg.sender_id.user_id)
energyplayer5 = Redis:get(Themalath.."energyplayer".."5"..msg.sender_id.user_id)
priceplayer5 = Redis:get(Themalath.."priceplayer".."5"..msg.sender_id.user_id)
...
Redis:setex(Themalath.."shoplyname" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
...
if Redis:get(Themalath.."shoplyname" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(Themalath.."shoplyname" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
if text == "الغاء" or text == "الغاء الامر" then
...
Redis:set(Themalath.."boob"..msg.sender_id.user_id,pricetotaly)
Redis:del(Themalath.."nameplayer".."1"..msg.sender_id.user_id)
Redis:del(Themalath.."energyplayer".."1"..msg.sender_id.user_id)
Redis:del(Themalath.."mrkzplayer".."1"..msg.sender_id.user_id)
Redis:del(Themalath.."cityplayer".."1"..msg.sender_id.user_id)
...
energynade = Redis:get(Themalath.."energynade"..msg.sender_id.user_id)
lkbnade = Redis:get(Themalath.."lkbnade"..msg.sender_id.user_id)
nokatnade = Redis:get(Themalath.."nokatnade"..msg.sender_id.user_id) or 0
nameplayer1 = Redis:get(Themalath.."nameplayer".."1"..msg.sender_id.user_id)
nameplayer2 = Redis:get(Themalath.."nameplayer".."2"..msg.sender_id.user_id)
nameplayer3 = Redis:get(Themalath.."nameplayer".."3"..msg.sender_id.user_id)
nameplayer4 = Redis:get(Themalath.."nameplayer".."4"..msg.sender_id.user_id)
...
if not Redis:get(Themalath.."namenade" .. Remsg.sender_id.user_id) then
...
namenade = Redis:get(Themalath.."namenade"..Remsg.sender_id.user_id)
energynade = Redis:get(Themalath.."energynade"..Remsg.sender_id.user_id)
lkbnade = Redis:get(Themalath.."lkbnade"..Remsg.sender_id.user_id)
nokatnade = Redis:get(Themalath.."nokatnade"..Remsg.sender_id.user_id) or 0
nameplayer1 = Redis:get(Themalath.."nameplayer".."1"..Remsg.sender_id.user_id)
nameplayer2 = Redis:get(Themalath.."nameplayer".."2"..Remsg.sender_id.user_id)
nameplayer3 = Redis:get(Themalath.."nameplayer".."3"..Remsg.sender_id.user_id)
nameplayer4 = Redis:get(Themalath.."nameplayer".."4"..Remsg.sender_id.user_id)
nameplayer5 = Redis:get(Themalath.."nameplayer".."5"..Remsg.sender_id.user_id)
if nameplayer1 then
mrkzplayer1 = Redis:get(Themalath.."mrkzplayer".."1"..Remsg.sender_id.user_id)
cityplayer1 = Redis:get(Themalath.."cityplayer".."1"..Remsg.sender_id.user_id)
energyplayer1 = Redis:get(Themalath.."energyplayer".."1"..Remsg.sender_id.user_id)
nameplayer1done = "⌯ اسم اللاعب : "..nameplayer1.."\n- مركزه : "..mrkzplayer1.."\n- طاقة اللاعب : "..energyplayer1.."\n- الجنسية : "..cityplayer1.."\n\n"
else
nameplayer1done = ""
end
if nameplayer2 then
mrkzplayer2 = Redis:get(Themalath.."mrkzplayer".."2"..Remsg.sender_id.user_id)
cityplayer2 = Redis:get(Themalath.."cityplayer".."2"..Remsg.sender_id.user_id)
energyplayer2 = Redis:get(Themalath.."energyplayer".."2"..Remsg.sender_id.user_id)
nameplayer2done = "⌯ اسم اللاعب : "..nameplayer2.."\n- مركزه : "..mrkzplayer2.."\n- طاقة اللاعب : "..energyplayer2.."\n- الجنسية : "..cityplayer2.."\n\n"
else
nameplayer2done = ""
end
if nameplayer3 then
mrkzplayer3 = Redis:get(Themalath.."mrkzplayer".."3"..Remsg.sender_id.user_id)
cityplayer3 = Redis:get(Themalath.."cityplayer".."3"..Remsg.sender_id.user_id)
energyplayer3 = Redis:get(Themalath.."energyplayer".."3"..Remsg.sender_id.user_id)
nameplayer3done = "⌯ اسم اللاعب : "..nameplayer3.."\n- مركزه : "..mrkzplayer3.."\n- طاقة اللاعب : "..energyplayer3.."\n- الجنسية : "..cityplayer3.."\n\n"
else
nameplayer3done = ""
end
if nameplayer4 then
mrkzplayer4 = Redis:get(Themalath.."mrkzplayer".."4"..Remsg.sender_id.user_id)
cityplayer4 = Redis:get(Themalath.."cityplayer".."4"..Remsg.sender_id.user_id)
energyplayer4 = Redis:get(Themalath.."energyplayer".."4"..Remsg.sender_id.user_id)
nameplayer4done = "⌯ اسم اللاعب : "..nameplayer4.."\n- مركزه : "..mrkzplayer4.."\n- طاقة اللاعب : "..energyplayer4.."\n- الجنسية : "..cityplayer4.."\n\n"
else
nameplayer4done = ""
end
if nameplayer5 then
mrkzplayer5 = Redis:get(Themalath.."mrkzplayer".."5"..Remsg.sender_id.user_id)
cityplayer5 = Redis:get(Themalath.."cityplayer".."5"..Remsg.sender_id.user_id)
energyplayer5 = Redis:get(Themalath.."energyplayer".."5"..Remsg.sender_id.user_id)
nameplayer5done = "⌯ اسم اللاعب : "..nameplayer5.."\n- مركزه : "..mrkzplayer5.."\n- طاقة اللاعب : "..energyplayer5.."\n- الجنسية : "..cityplayer5.."\n\n"
else
nameplayer5done = ""
end
...
if Redis:ttl(Themalath.."matchode" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Themalath.."matchode" .. msg.sender_id.user_id))
...
namenade = Redis:get(Themalath.."namenade"..msg.sender_id.user_id)
energynade = Redis:get(Themalath.."energynade"..msg.sender_id.user_id)
energyplayer1 = Redis:get(Themalath.."energyplayer".."1"..msg.sender_id.user_id) or 0
energyplayer2 = Redis:get(Themalath.."energyplayer".."2"..msg.sender_id.user_id) or 0
energyplayer3 = Redis:get(Themalath.."energyplayer".."3"..msg.sender_id.user_id) or 0
energyplayer4 = Redis:get(Themalath.."energyplayer".."4"..msg.sender_id.user_id) or 0
energyplayer5 = Redis:get(Themalath.."energyplayer".."5"..msg.sender_id.user_id) or 0
...
Redis:set(Themalath.."boob"..msg.sender_id.user_id,cccallcc)
Redis:incrby(Themalath.."energynade"..msg.sender_id.user_id,1)
Redis:incrby(Themalath.."nokatnade"..msg.sender_id.user_id,1)
Redis:setex(Themalath.."matchode" .. msg.sender_id.user_id,1200, true)
send(msg.chat_id,msg.id, "⌯ لقد فزت بالمبارة "..news.." ⚽️\n⇜ اسم النادي : "..namenade.."\n⇜ نادي الخصم : "..nadebot.."\n⇜ النتيجة : "..result.."\n⇜ تم زيادة نقطة لطاقة ناديك\n✧","md",true)
elseif energymynade < tonumber(energybot) then
Redis:decrby(Themalath.."energynade"..msg.sender_id.user_id,1)
energynade = Redis:get(Themalath.."energynade"..msg.sender_id.user_id)
if tonumber(energynade) < 0 then
Redis:set(Themalath.."energynade"..msg.sender_id.user_id,0)
end
Redis:decrby(Themalath.."nokatnade"..msg.sender_id.user_id,1)
nokatnade = Redis:get(Themalath.."nokatnade"..msg.sender_id.user_id)
if tonumber(nokatnade) < 0 then
Redis:set(Themalath.."nokatnade"..msg.sender_id.user_id,0)
end
Redis:setex(Themalath.."matchode" .. msg.sender_id.user_id,1200, true)
...
if Redis:ttl(Themalath.."matchplayer" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Themalath.."matchplayer" .. msg.sender_id.user_id))
...
namenadevs = Redis:get(Themalath.."namenade"..Remsg.sender_id.user_id)
energynadevs = Redis:get(Themalath.."energynade"..Remsg.sender_id.user_id)
energyplayer1vs = Redis:get(Themalath.."energyplayer".."1"..Remsg.sender_id.user_id) or 0
energyplayer2vs = Redis:get(Themalath.."energyplayer".."2"..Remsg.sender_id.user_id) or 0
energyplayer3vs = Redis:get(Themalath.."energyplayer".."3"..Remsg.sender_id.user_id) or 0
energyplayer4vs = Redis:get(Themalath.."energyplayer".."4"..Remsg.sender_id.user_id) or 0
energyplayer5vs = Redis:get(Themalath.."energyplayer".."5"..Remsg.sender_id.user_id) or 0
...
Redis:decrby(Themalath.."energynade"..Remsg.sender_id.user_id,1)
energynadevs = Redis:get(Themalath.."energynade"..Remsg.sender_id.user_id)
if tonumber(energynadevs) < 0 then
Redis:set(Themalath.."energynade"..Remsg.sender_id.user_id,0)
end
if energyplayer1vs then
Redis:decrby(Themalath.."energyplayer".."1"..Remsg.sender_id.user_id,1)
end
energyplayer1vs = Redis:get(Themalath.."energyplayer".."1"..Remsg.sender_id.user_id)
if tonumber(energyplayer1vs) < 0 then
Redis:set(Themalath.."energyplayer".."1"..Remsg.sender_id.user_id,0)
end
if energyplayer2vs then
Redis:decrby(Themalath.."energyplayer".."2"..Remsg.sender_id.user_id,1)
end
energyplayer2vs = Redis:get(Themalath.."energyplayer".."2"..Remsg.sender_id.user_id)
if tonumber(energyplayer2vs) < 0 then
Redis:set(Themalath.."energyplayer".."2"..Remsg.sender_id.user_id,0)
end
if energyplayer3vs then
Redis:decrby(Themalath.."energyplayer".."3"..Remsg.sender_id.user_id,1)
end
energyplayer3vs = Redis:get(Themalath.."energyplayer".."3"..Remsg.sender_id.user_id)
if tonumber(energyplayer3vs) < 0 then
Redis:set(Themalath.."energyplayer".."3"..Remsg.sender_id.user_id,0)
end
if energyplayer4vs then
Redis:decrby(Themalath.."energyplayer".."4"..Remsg.sender_id.user_id,1)
end
energyplayer4vs = Redis:get(Themalath.."energyplayer".."4"..Remsg.sender_id.user_id)
if tonumber(energyplayer4vs) < 0 then
Redis:set(Themalath.."energyplayer".."4"..Remsg.sender_id.user_id,0)
end
if energyplayer5vs then
Redis:decrby(Themalath.."energyplayer".."5"..Remsg.sender_id.user_id,1)
end
energyplayer5vs = Redis:get(Themalath.."energyplayer".."5"..Remsg.sender_id.user_id)
if tonumber(energyplayer5vs) < 0 then
Redis:set(Themalath.."energyplayer".."5"..Remsg.sender_id.user_id,0)
end
Redis:decrby(Themalath.."nokatnade"..Remsg.sender_id.user_id,1)
nokatnadevs = Redis:get(Themalath.."nokatnade"..Remsg.sender_id.user_id)
if tonumber(nokatnadevs) < 0 then
Redis:set(Themalath.."nokatnade"..Remsg.sender_id.user_id,0)
end
Redis:setex(Themalath.."matchplayer" .. msg.sender_id.user_id,1200, true)
ballance = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
...
Redis:incrby(Themalath.."energynade"..Remsg.sender_id.user_id,1)
Redis:incrby(Themalath.."nokatnade"..Remsg.sender_id.user_id,1)
if energyplayer1vs then
Redis:incrby(Themalath.."energyplayer".."1"..Remsg.sender_id.user_id,1)
end
if energyplayer2vs then
Redis:incrby(Themalath.."energyplayer".."2"..Remsg.sender_id.user_id,1)
end
if energyplayer3vs then
Redis:incrby(Themalath.."energyplayer".."3"..Remsg.sender_id.user_id,1)
end
if energyplayer4vs then
Redis:incrby(Themalath.."energyplayer".."4"..Remsg.sender_id.user_id,1)
end
if energyplayer5vs then
Redis:incrby(Themalath.."energyplayer".."5"..Remsg.sender_id.user_id,1)
end
Redis:decrby(Themalath.."energynade"..msg.sender_id.user_id,1)
energynade = Redis:get(Themalath.."energynade"..msg.sender_id.user_id)
if tonumber(energynade) < 0 then
...
if energyplayer1 then
Redis:decrby(Themalath.."energyplayer".."1"..msg.sender_id.user_id,1)
end
energyplayer1 = Redis:get(Themalath.."energyplayer".."1"..msg.sender_id.user_id)
if tonumber(energyplayer1) < 0 then
Redis:set(Themalath.."energyplayer".."1"..msg.sender_id.user_id,0)
end
if energyplayer2 then
Redis:decrby(Themalath.."energyplayer".."2"..msg.sender_id.user_id,1)
end
energyplayer2 = Redis:get(Themalath.."energyplayer".."2"..msg.sender_id.user_id)
if tonumber(energyplayer2) < 0 then
Redis:set(Themalath.."energyplayer".."2"..msg.sender_id.user_id,0)
end
if energyplayer3 then
Redis:decrby(Themalath.."energyplayer".."3"..msg.sender_id.user_id,1)
end
energyplayer3 = Redis:get(Themalath.."energyplayer".."3"..msg.sender_id.user_id)
if tonumber(energyplayer3) < 0 then
Redis:set(Themalath.."energyplayer".."3"..msg.sender_id.user_id,0)
end
if energyplayer4 then
Redis:decrby(Themalath.."energyplayer".."4"..msg.sender_id.user_id,1)
end
energyplayer4 = Redis:get(Themalath.."energyplayer".."4"..msg.sender_id.user_id)
if tonumber(energyplayer4) < 0 then
Redis:set(Themalath.."energyplayer".."4"..msg.sender_id.user_id,0)
end
if energyplayer5 then
Redis:decrby(Themalath.."energyplayer".."5"..msg.sender_id.user_id,1)
end
energyplayer5 = Redis:get(Themalath.."energyplayer".."5"..msg.sender_id.user_id)
if tonumber(energyplayer5) < 0 then
Redis:set(Themalath.."energyplayer".."5"..msg.sender_id.user_id,0)
end
Redis:decrby(Themalath.."nokatnade"..msg.sender_id.user_id,1)
nokatnade = Redis:get(Themalath.."nokatnade"..msg.sender_id.user_id)
if tonumber(nokatnade) < 0 then
...
if Redis:sismember(Themalath.."booob",msg.sender_id.user_id) then
if Redis:get(Themalath.."mrkzplayer".."1"..msg.sender_id.user_id) and Redis:get(Themalath.."mrkzplayer".."2"..msg.sender_id.user_id) and Redis:get(Themalath.."mrkzplayer".."3"..msg.sender_id.user_id) and Redis:get(Themalath.."mrkzplayer".."4"..msg.sender_id.user_id) and Redis:get(Themalath.."mrkzplayer".."5"..msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ النادي الخاص بك مكتمل\n⇜ تستطيع بيع لاعب عن طريق الامر ( بيع لاعب )  ","md",true)
end
if Redis:ttl(Themalath.."buyplayer" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Themalath.."buyplayer" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ تستطيع شراء لاعب بعد "..time.." ","md",true)
end
Redis:setex(Themalath.."buyplayer" .. msg.sender_id.user_id,900, true)
...
if Redis:sismember(Themalath.."booob",msg.sender_id.user_id) then
ballanceed = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
namefram = Redis:get(Themalath.."namefram"..msg.sender_id.user_id)
if Redis:get(Themalath.."sizefram"..msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ لديك مزرعه مسبقاً ","md",true)
end
if Redis:sismember(Themalath.."farmarname", Cnamed) then
return send(msg.chat_id,msg.id, "⇜ اسم المزرعه موجود مسبقاً\n⇜ اختر اسم اخر\n✧","md",true)
end
Redis:set(Themalath.."namefram"..msg.sender_id.user_id, Cnamed)
...
local bank_users = Redis:smembers(Themalath.."ownerfram")
if #bank_users == 0 then
...
mony_listd = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(Themalath.."toplvfarm"..v) or 0
table.insert(mony_listd, {tonumber(mony) , v})
end
table.sort(mony_listd, function(a, b) return a[1] > b[1] end)
num = 1
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local kk = Redis:get(Themalath.."namefram"..v[2])
kk = kk:gsub("🇾🇪️",'')
kk = kk:gsub("🇹🇳",'')
kk = kk:gsub("🇸🇾",'')
kk = kk:gsub("🇸🇩",'')
...
if Redis:sismember(Themalath.."booob",msg.sender_id.user_id) then
if not Redis:get(Themalath.."sizefram" .. msg.sender_id.user_id) then
...
local namefram = Redis:get(Themalath.."namefram"..msg.sender_id.user_id)
local sizefram = Redis:get(Themalath.."sizefram"..msg.sender_id.user_id)
local mzroatsize = Redis:get(Themalath.."mzroatsize"..msg.sender_id.user_id) or 0
local mazofxbh = tonumber(sizefram) - tonumber(mzroatsize)
local btatahours = Redis:ttl(Themalath.."btatatime" .. msg.sender_id.user_id) / 60
local btatatime = Redis:get(Themalath.."btatatime" .. msg.sender_id.user_id)
local btataname = Redis:get(Themalath.."btataname"..msg.sender_id.user_id)
local btatanum = Redis:get(Themalath.."btatanum"..msg.sender_id.user_id) or 0
...
local lemonhours = Redis:ttl(Themalath.."lemontime" .. msg.sender_id.user_id) / 60
local lemontime = Redis:get(Themalath.."lemontime" .. msg.sender_id.user_id)
local lemonname = Redis:get(Themalath.."lemonname"..msg.sender_id.user_id)
local lemonnum = Redis:get(Themalath.."lemonnum"..msg.sender_id.user_id) or 0
...
local khesshours = Redis:ttl(Themalath.."khesstime" .. msg.sender_id.user_id) / 60
local khesstime = Redis:get(Themalath.."khesstime" .. msg.sender_id.user_id)
local khessname = Redis:get(Themalath.."khessname"..msg.sender_id.user_id)
local khessnum = Redis:get(Themalath.."khessnum"..msg.sender_id.user_id) or 0
...
local khearhours = Redis:ttl(Themalath.."kheartime" .. msg.sender_id.user_id) / 60
local kheartime = Redis:get(Themalath.."kheartime" .. msg.sender_id.user_id)
local khearname = Redis:get(Themalath.."khearname"..msg.sender_id.user_id)
local khearnum = Redis:get(Themalath.."khearnum"..msg.sender_id.user_id) or 0
...
local jzarhours = Redis:ttl(Themalath.."jzartime" .. msg.sender_id.user_id) / 60
local jzartime = Redis:get(Themalath.."jzartime" .. msg.sender_id.user_id)
local jzarname = Redis:get(Themalath.."jzarname"..msg.sender_id.user_id)
local jzarnum = Redis:get(Themalath.."jzarnum"..msg.sender_id.user_id) or 0
...
local fleflahours = Redis:ttl(Themalath.."fleflatime" .. msg.sender_id.user_id) / 60
local fleflatime = Redis:get(Themalath.."fleflatime" .. msg.sender_id.user_id)
local fleflaname = Redis:get(Themalath.."fleflaname"..msg.sender_id.user_id)
local fleflanum = Redis:get(Themalath.."fleflanum"..msg.sender_id.user_id) or 0
...
local freazhours = Redis:ttl(Themalath.."freaztime" .. msg.sender_id.user_id) / 60
local freaztime = Redis:get(Themalath.."freaztime" .. msg.sender_id.user_id)
local freazname = Redis:get(Themalath.."freazname"..msg.sender_id.user_id)
local freaznum = Redis:get(Themalath.."freaznum"..msg.sender_id.user_id) or 0
...
local dorahours = Redis:ttl(Themalath.."doratime" .. msg.sender_id.user_id) / 60
local doratime = Redis:get(Themalath.."doratime" .. msg.sender_id.user_id)
local doraname = Redis:get(Themalath.."doraname"..msg.sender_id.user_id)
local doranum = Redis:get(Themalath.."doranum"..msg.sender_id.user_id) or 0
...
local tomhours = Redis:ttl(Themalath.."tomtime" .. msg.sender_id.user_id) / 60
local tomtime = Redis:get(Themalath.."tomtime" .. msg.sender_id.user_id)
local tomname = Redis:get(Themalath.."tomname"..msg.sender_id.user_id)
local tomnum = Redis:get(Themalath.."tomnum"..msg.sender_id.user_id) or 0
...
local ftrhours = Redis:ttl(Themalath.."ftrtime" .. msg.sender_id.user_id) / 60
local ftrtime = Redis:get(Themalath.."ftrtime" .. msg.sender_id.user_id)
local ftrname = Redis:get(Themalath.."ftrname"..msg.sender_id.user_id)
local ftrnum = Redis:get(Themalath.."ftrnum"..msg.sender_id.user_id) or 0
...
local tfahhours = Redis:ttl(Themalath.."tfahtime" .. msg.sender_id.user_id) / 60
local tfahtime = Redis:get(Themalath.."tfahtime" .. msg.sender_id.user_id)
local tfahname = Redis:get(Themalath.."tfahname"..msg.sender_id.user_id)
local tfahnum = Redis:get(Themalath.."tfahnum"..msg.sender_id.user_id) or 0
...
local enabhours = Redis:ttl(Themalath.."enabtime" .. msg.sender_id.user_id) / 60
local enabtime = Redis:get(Themalath.."enabtime" .. msg.sender_id.user_id)
local enabname = Redis:get(Themalath.."enabname"..msg.sender_id.user_id)
local enabnum = Redis:get(Themalath.."enabnum"..msg.sender_id.user_id) or 0
...
local zetonhours = Redis:ttl(Themalath.."zetontime" .. msg.sender_id.user_id) / 60
local zetontime = Redis:get(Themalath.."zetontime" .. msg.sender_id.user_id)
local zetonname = Redis:get(Themalath.."zetonname"..msg.sender_id.user_id)
local zetonnum = Redis:get(Themalath.."zetonnum"..msg.sender_id.user_id) or 0
...
local mozzhours = Redis:ttl(Themalath.."mozztime" .. msg.sender_id.user_id) / 60
local mozztime = Redis:get(Themalath.."mozztime" .. msg.sender_id.user_id)
local mozzname = Redis:get(Themalath.."mozzname"..msg.sender_id.user_id)
local mozznum = Redis:get(Themalath.."mozznum"..msg.sender_id.user_id) or 0
...
local mangahours = Redis:ttl(Themalath.."mangatime" .. msg.sender_id.user_id) / 60
local mangatime = Redis:get(Themalath.."mangatime" .. msg.sender_id.user_id)
local manganame = Redis:get(Themalath.."manganame"..msg.sender_id.user_id)
local manganum = Redis:get(Themalath.."manganum"..msg.sender_id.user_id) or 0
...
if Redis:get(Themalath.."btatatime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Themalath.."btatatime" .. msg.sender_id.user_id) / 60
...
if Redis:get(Themalath.."btatanum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة بطاطا قبل 🥔\n⇜ قم بحصادها اولاً\n- طريقة الحصاد بالامر : `حصد بطاطا`","md",true)
end
kajwha = tonumber(coniss) * 0.7
sizefram = Redis:get(Themalath.."sizefram"..msg.sender_id.user_id)
if tonumber(kajwha) > tonumber(sizefram) then
return send(msg.chat_id,msg.id, "⇜ مايمديك تشتري مساحة ارضك ماتكفي","md",true)
end
mzroatsize = Redis:get(Themalath.."mzroatsize"..msg.sender_id.user_id) or 0
...
Redis:set(Themalath.."btatanum"..msg.sender_id.user_id , coniss)
btataname = "بطاطا"
Redis:set(Themalath.."btataname"..msg.sender_id.user_id , btataname)
mzroatsize = Redis:get(Themalath.."mzroatsize"..msg.sender_id.user_id) or 0
btatasize = tonumber(coniss) * 0.7
btatasizee = btatasize + mzroatsize
Redis:set(Themalath.."mzroatsize"..msg.sender_id.user_id , math.floor(btatasizee))
totalypalice = tonumber(ballance) - tonumber(btata)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Themalath.."btatatime"..msg.sender_id.user_id,1220, true)
local convert_mony = string.format("%.0f",math.floor(btata))
toplvfarm = Redis:get(Themalath.."toplvfarm"..msg.sender_id.user_id) or 0
toplvfarmm = tonumber(toplvfarm) + tonumber(coniss)
Redis:set(Themalath.."toplvfarm"..msg.sender_id.user_id , toplvfarmm)
...
if Redis:get(Themalath.."lemontime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Themalath.."lemontime" .. msg.sender_id.user_id) / 60
...
if Redis:get(Themalath.."lemonnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة بندوره قبل 🍅\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد بندوره`","md",true)
end
...
Redis:set(Themalath.."lemonnum"..msg.sender_id.user_id , coniss)
lemonname = "بندوره"
Redis:set(Themalath.."lemonname"..msg.sender_id.user_id , lemonname)
mzroatsize = Redis:get(Themalath.."mzroatsize"..msg.sender_id.user_id) or 0
lemonsize = tonumber(coniss) * 1
lemonsizee = lemonsize + mzroatsize
Redis:set(Themalath.."mzroatsize"..msg.sender_id.user_id , math.floor(lemonsizee))
totalypalice = tonumber(ballance) - tonumber(lemon)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Themalath.."lemontime"..msg.sender_id.user_id,1520, true)
...
if Redis:get(Themalath.."khesstime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Themalath.."khesstime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة خس قبل 🥬\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصادها\n- طريقة الحصاد بالامر : `حصد خس`","md",true)
end
if Redis:get(Themalath.."khessnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة خس قبل 🥬\n⇜ قم بحصادها اولاً\n- طريقة الحصاد بالامر : `حصد خس`","md",true)
end
...
Redis:set(Themalath.."khessnum"..msg.sender_id.user_id , coniss)
khessname = "خس"
Redis:set(Themalath.."khessname"..msg.sender_id.user_id , khessname)
mzroatsize = Redis:get(Themalath.."mzroatsize"..msg.sender_id.user_id) or 0
khesssize = tonumber(coniss) * 1.2
khesssizee = khesssize + mzroatsize
Redis:set(Themalath.."mzroatsize"..msg.sender_id.user_id , math.floor(khesssizee))
totalypalice = tonumber(ballance) - tonumber(khess)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Themalath.."khesstime"..msg.sender_id.user_id,1800, true)
...
if Redis:get(Themalath.."kheartime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Themalath.."kheartime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة خيار قبل 🥒\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد خيار`","md",true)
end
if Redis:get(Themalath.."khearnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة خيار قبل 🥒\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد خيار`","md",true)
end
...
Redis:set(Themalath.."khearnum"..msg.sender_id.user_id , coniss)
khearname = "خيار"
Redis:set(Themalath.."khearname"..msg.sender_id.user_id , khearname)
mzroatsize = Redis:get(Themalath.."mzroatsize"..msg.sender_id.user_id) or 0
khearsize = tonumber(coniss) * 1.5
khearsizee = khearsize + mzroatsize
Redis:set(Themalath.."mzroatsize"..msg.sender_id.user_id , math.floor(khearsizee))
totalypalice = tonumber(ballance) - tonumber(khear)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Themalath.."kheartime"..msg.sender_id.user_id,2120, true)
...
if Redis:get(Themalath.."jzartime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Themalath.."jzartime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة جزر قبل 🥕\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد جزر`","md",true)
end
if Redis:get(Themalath.."jzarnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة جزر قبل 🥕\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد جزر`","md",true)
end
...
Redis:set(Themalath.."jzarnum"..msg.sender_id.user_id , coniss)
jzarname = "جزر"
Redis:set(Themalath.."jzarname"..msg.sender_id.user_id , jzarname)
mzroatsize = Redis:get(Themalath.."mzroatsize"..msg.sender_id.user_id) or 0
jzarsize = tonumber(coniss) * 1.7
jzarsizee = jzarsize + mzroatsize
Redis:set(Themalath.."mzroatsize"..msg.sender_id.user_id , math.floor(jzarsizee))
totalypalice = tonumber(ballance) - tonumber(jzar)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Themalath.."jzartime"..msg.sender_id.user_id,2420, true)
...
if Redis:get(Themalath.."fleflatime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Themalath.."fleflatime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة فليفله قبل 🫑\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصادها\n- طريقة الحصاد بالامر : `حصد فليفله`","md",true)
end
if Redis:get(Themalath.."fleflanum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة فليفله قبل 🫑\n⇜ قم بحصادها اولاً\n- طريقة الحصاد بالامر : `حصد فليفله`","md",true)
end
...
Redis:set(Themalath.."fleflanum"..msg.sender_id.user_id , coniss)
fleflaname = "فليفله"
Redis:set(Themalath.."fleflaname"..msg.sender_id.user_id , fleflaname)
mzroatsize = Redis:get(Themalath.."mzroatsize"..msg.sender_id.user_id) or 0
fleflasize = tonumber(coniss) * 2
fleflasizee = fleflasize + mzroatsize
Redis:set(Themalath.."mzroatsize"..msg.sender_id.user_id , math.floor(fleflasizee))
totalypalice = tonumber(ballance) - tonumber(flefla)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Themalath.."fleflatime"..msg.sender_id.user_id,2720, true)
...
if Redis:get(Themalath.."freaztime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Themalath.."freaztime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة فريز قبل 🍓\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد فريز`","md",true)
end
if Redis:get(Themalath.."freaznum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة فريز قبل 🍓\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد فريز`","md",true)
end
...
Redis:set(Themalath.."freaznum"..msg.sender_id.user_id , coniss)
freazname = "فريز"
Redis:set(Themalath.."freazname"..msg.sender_id.user_id , freazname)
mzroatsize = Redis:get(Themalath.."mzroatsize"..msg.sender_id.user_id) or 0
freazsize = tonumber(coniss) * 3
freazsizee = freazsize + mzroatsize
Redis:set(Themalath.."mzroatsize"..msg.sender_id.user_id , math.floor(freazsizee))
totalypalice = tonumber(ballance) - tonumber(freaz)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Themalath.."freaztime"..msg.sender_id.user_id,3020, true)
...
if Redis:get(Themalath.."doratime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Themalath.."doratime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة ذره قبل 🌽\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد ذره`","md",true)
end
if Redis:get(Themalath.."doranum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة ذره قبل 🌽\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد ذره`","md",true)
end
...
Redis:set(Themalath.."doranum"..msg.sender_id.user_id , coniss)
doraname = "ذره"
Redis:set(Themalath.."doraname"..msg.sender_id.user_id , doraname)
mzroatsize = Redis:get(Themalath.."mzroatsize"..msg.sender_id.user_id) or 0
dorasize = tonumber(coniss) * 4
dorasizee = dorasize + mzroatsize
Redis:set(Themalath.."mzroatsize"..msg.sender_id.user_id , math.floor(dorasizee))
totalypalice = tonumber(ballance) - tonumber(dora)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Themalath.."doratime"..msg.sender_id.user_id,3320, true)
...
if Redis:get(Themalath.."tomtime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Themalath.."tomtime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة ثوم قبل 🧄\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد ثوم`","md",true)
end
if Redis:get(Themalath.."tomnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة ثوم قبل 🧄\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد ثوم`","md",true)
end
...
Redis:set(Themalath.."tomnum"..msg.sender_id.user_id , coniss)
tomname = "ثوم"
Redis:set(Themalath.."tomname"..msg.sender_id.user_id , tomname)
mzroatsize = Redis:get(Themalath.."mzroatsize"..msg.sender_id.user_id) or 0
tomsize = tonumber(coniss) * 5
tomsizee = tomsize + mzroatsize
Redis:set(Themalath.."mzroatsize"..msg.sender_id.user_id , math.floor(tomsizee))
totalypalice = tonumber(ballance) - tonumber(tom)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Themalath.."tomtime"..msg.sender_id.user_id,3620, true)
...
if Redis:get(Themalath.."ftrtime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Themalath.."ftrtime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة فطر قبل 🍄\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد فطر`","md",true)
end
if Redis:get(Themalath.."ftrnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة فطر قبل 🍄\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد فطر`","md",true)
end
...
Redis:set(Themalath.."ftrnum"..msg.sender_id.user_id , coniss)
ftrname = "فطر"
Redis:set(Themalath.."ftrname"..msg.sender_id.user_id , ftrname)
mzroatsize = Redis:get(Themalath.."mzroatsize"..msg.sender_id.user_id) or 0
ftrsize = tonumber(coniss) * 6
ftrsizee = ftrsize + mzroatsize
Redis:set(Themalath.."mzroatsize"..msg.sender_id.user_id , math.floor(ftrsizee))
totalypalice = tonumber(ballance) - tonumber(ftr)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Themalath.."ftrtime"..msg.sender_id.user_id,4220, true)
...
if Redis:get(Themalath.."tfahtime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Themalath.."tfahtime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر تفاح قبل 🍏\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر تفاح`","md",true)
end
if Redis:get(Themalath.."tfahnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر تفاح قبل 🍏\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر تفاح`","md",true)
end
...
Redis:set(Themalath.."tfahnum"..msg.sender_id.user_id , coniss)
tfahname = "تفاح"
Redis:set(Themalath.."tfahname"..msg.sender_id.user_id , tfahname)
mzroatsize = Redis:get(Themalath.."mzroatsize"..msg.sender_id.user_id) or 0
tfahsize = tonumber(coniss) * 10
tfahsizee = tfahsize + mzroatsize
Redis:set(Themalath.."mzroatsize"..msg.sender_id.user_id , math.floor(tfahsizee))
totalypalice = tonumber(ballance) - tonumber(tfah)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Themalath.."tfahtime"..msg.sender_id.user_id,5420, true)
...
if Redis:get(Themalath.."enabtime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Themalath.."enabtime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر عنب قبل 🍇\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر عنب`","md",true)
end
if Redis:get(Themalath.."enabnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر عنب قبل 🍇\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر عنب`","md",true)
end
...
Redis:set(Themalath.."enabnum"..msg.sender_id.user_id , coniss)
enabname = "عنب"
Redis:set(Themalath.."enabname"..msg.sender_id.user_id , enabname)
mzroatsize = Redis:get(Themalath.."mzroatsize"..msg.sender_id.user_id) or 0
enabsize = tonumber(coniss) * 12.5
enabsizee = enabsize + mzroatsize
Redis:set(Themalath.."mzroatsize"..msg.sender_id.user_id , math.floor(enabsizee))
totalypalice = tonumber(ballance) - tonumber(enab)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Themalath.."enabtime"..msg.sender_id.user_id,6020, true)
...
if Redis:get(Themalath.."zetontime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Themalath.."zetontime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر زيتون قبل 🫒\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر زيتون`","md",true)
end
if Redis:get(Themalath.."zetonnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر زيتون قبل 🫒\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر زيتون`","md",true)
end
...
Redis:set(Themalath.."zetonnum"..msg.sender_id.user_id , coniss)
zetonname = "زيتون"
Redis:set(Themalath.."zetonname"..msg.sender_id.user_id , zetonname)
mzroatsize = Redis:get(Themalath.."mzroatsize"..msg.sender_id.user_id) or 0
zetonsize = tonumber(coniss) * 15
zetonsizee = zetonsize + mzroatsize
Redis:set(Themalath.."mzroatsize"..msg.sender_id.user_id , math.floor(zetonsizee))
totalypalice = tonumber(ballance) - tonumber(zeton)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Themalath.."zetontime"..msg.sender_id.user_id,7220, true)
...
if Redis:get(Themalath.."mozztime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Themalath.."mozztime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر موز قبل 🍌\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر موز`","md",true)
end
if Redis:get(Themalath.."mozznum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر موز قبل 🍌\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر موز`","md",true)
end
...
Redis:set(Themalath.."mozznum"..msg.sender_id.user_id , coniss)
mozzname = "موز"
Redis:set(Themalath.."mozzname"..msg.sender_id.user_id , mozzname)
mzroatsize = Redis:get(Themalath.."mzroatsize"..msg.sender_id.user_id) or 0
mozzsize = tonumber(coniss) * 20
mozzsizee = mozzsize + mzroatsize
Redis:set(Themalath.."mzroatsize"..msg.sender_id.user_id , math.floor(mozzsizee))
totalypalice = tonumber(ballance) - tonumber(mozz)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Themalath.."mozztime"..msg.sender_id.user_id,8420, true)
...
if Redis:get(Themalath.."mangatime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Themalath.."mangatime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر مانجا قبل 🥭\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر مانجا`","md",true)
end
if Redis:get(Themalath.."manganum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر مانجا قبل 🥭\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر مانجا`","md",true)
end
...
Redis:set(Themalath.."manganum"..msg.sender_id.user_id , coniss)
manganame = "مانجا"
Redis:set(Themalath.."manganame"..msg.sender_id.user_id , manganame)
mzroatsize = Redis:get(Themalath.."mzroatsize"..msg.sender_id.user_id) or 0
mangasize = tonumber(coniss) * 30
mangasizee = mangasize + mzroatsize
Redis:set(Themalath.."mzroatsize"..msg.sender_id.user_id , math.floor(mangasizee))
totalypalice = tonumber(ballance) - tonumber(manga)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Themalath.."mangatime"..msg.sender_id.user_id,10220, true)
...
if not Redis:get(Themalath.."btatanum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
btatanum = Redis:get(Themalath.."btatanum"..msg.sender_id.user_id)
btata = tonumber(btatanum) * 100
btataa = tonumber(ballance) + tonumber(btata)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(btataa))
local convert_mony = string.format("%.0f",math.floor(btata))
...
if not Redis:get(Themalath.."lemonnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
lemonnum = Redis:get(Themalath.."lemonnum"..msg.sender_id.user_id)
lemon = tonumber(lemonnum) * 150
lemona = tonumber(ballance) + tonumber(lemon)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(lemona))
local convert_mony = string.format("%.0f",math.floor(lemon))
...
if not Redis:get(Themalath.."khessnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
khessnum = Redis:get(Themalath.."khessnum"..msg.sender_id.user_id)
khess = tonumber(khessnum) * 200
khessa = tonumber(ballance) + tonumber(khess)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(khessa))
local convert_mony = string.format("%.0f",math.floor(khess))
...
if not Redis:get(Themalath.."khearnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
khearnum = Redis:get(Themalath.."khearnum"..msg.sender_id.user_id)
khear = tonumber(khearnum) * 250
kheara = tonumber(ballance) + tonumber(khear)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(kheara))
local convert_mony = string.format("%.0f",math.floor(khear))
...
if not Redis:get(Themalath.."jzarnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
jzarnum = Redis:get(Themalath.."jzarnum"..msg.sender_id.user_id)
jzar = tonumber(jzarnum) * 300
jzara = tonumber(ballance) + tonumber(jzar)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(jzara))
local convert_mony = string.format("%.0f",math.floor(jzar))
...
if not Redis:get(Themalath.."fleflanum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
fleflanum = Redis:get(Themalath.."fleflanum"..msg.sender_id.user_id)
flefla = tonumber(fleflanum) * 350
fleflaa = tonumber(ballance) + tonumber(flefla)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(fleflaa))
local convert_mony = string.format("%.0f",math.floor(flefla))
...
if not Redis:get(Themalath.."freaznum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
freaznum = Redis:get(Themalath.."freaznum"..msg.sender_id.user_id)
freaz = tonumber(freaznum) * 475
freaza = tonumber(ballance) + tonumber(freaz)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(freaza))
local convert_mony = string.format("%.0f",math.floor(freaz))
...
if not Redis:get(Themalath.."doranum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
doranum = Redis:get(Themalath.."doranum"..msg.sender_id.user_id)
dora = tonumber(doranum) * 600
doraa = tonumber(ballance) + tonumber(dora)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(doraa))
local convert_mony = string.format("%.0f",math.floor(dora))
...
if not Redis:get(Themalath.."tomnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
tomnum = Redis:get(Themalath.."tomnum"..msg.sender_id.user_id)
tom = tonumber(tomnum) * 725
toma = tonumber(ballance) + tonumber(tom)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(toma))
local convert_mony = string.format("%.0f",math.floor(tom))
...
if not Redis:get(Themalath.."ftrnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
ftrnum = Redis:get(Themalath.."ftrnum"..msg.sender_id.user_id)
ftr = tonumber(ftrnum) * 800
ftra = tonumber(ballance) + tonumber(ftr)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(ftra))
local convert_mony = string.format("%.0f",math.floor(ftr))
...
if not Redis:get(Themalath.."tfahnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
tfahnum = Redis:get(Themalath.."tfahnum"..msg.sender_id.user_id)
tfah = tonumber(tfahnum) * 1200
tfaha = tonumber(ballance) + tonumber(tfah)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(tfaha))
local convert_mony = string.format("%.0f",math.floor(tfah))
...
if not Redis:get(Themalath.."enabnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
enabnum = Redis:get(Themalath.."enabnum"..msg.sender_id.user_id)
enab = tonumber(enabnum) * 1500
enaba = tonumber(ballance) + tonumber(enab)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(enaba))
local convert_mony = string.format("%.0f",math.floor(enab))
...
if not Redis:get(Themalath.."zetonnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
zetonnum = Redis:get(Themalath.."zetonnum"..msg.sender_id.user_id)
zeton = tonumber(zetonnum) * 1800
zetona = tonumber(ballance) + tonumber(zeton)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(zetona))
local convert_mony = string.format("%.0f",math.floor(zeton))
...
if not Redis:get(Themalath.."mozznum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
mozznum = Redis:get(Themalath.."mozznum"..msg.sender_id.user_id)
mozz = tonumber(mozznum) * 2500
mozza = tonumber(ballance) + tonumber(mozz)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(mozza))
local convert_mony = string.format("%.0f",math.floor(mozz))
...
if not Redis:get(Themalath.."manganum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
manganum = Redis:get(Themalath.."manganum"..msg.sender_id.user_id)
manga = tonumber(manganum) * 3500
mangaa = tonumber(ballance) + tonumber(manga)
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(mangaa))
local convert_mony = string.format("%.0f",math.floor(manga))
...
if Redis:ttl(Themalath.."yiioooo" .. msg.sender_id.user_id) >=60 then
local hours = Redis:ttl(Themalath.."yiioooo" .. msg.sender_id.user_id) / 60
...
Redis:set(Themalath.."boob"..msg.sender_id.user_id , knez)
local ballancee = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballancee)
send(msg.chat_id,msg.id,""..neews.." لقد وجدت كنز\n⇜ الكنز : قطعة اثرية 🗳\n⇜ سعره : 40000 درهم 💵\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
Redis:setex(Themalath.."yiioooo" .. msg.sender_id.user_id,1800, true)
elseif Descriptioont == "2" then
...
local coniss = coin(UserName)
if msg.ControllerBot then
Redis:set(Themalath.."bandid"..coniss,coniss)
...
local coniss = coin(UserName)
if msg.ControllerBot then
Redis:del(Themalath.."bandid"..coniss)
...
local coniss = coin(UserName)
if msg.ControllerBot then
Redis:set(Themalath.."morakba"..coniss,coniss)
local ban = bot.getUser(coniss)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
local coniss = coin(UserName)
if msg.ControllerBot then
Redis:del(Themalath.."morakba"..coniss)
local ban = bot.getUser(coniss)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
Redis:set(Themalath.."cobonum"..numcobo,numcobo)
Redis:set(Themalath.."cobon"..numcobo,coniss)
...
cobnum = Redis:get(Themalath.."cobonum"..coniss)
if coniss == tonumber(cobnum) then
cobblc = Redis:get(Themalath.."cobon"..coniss)
ballancee = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
cobonplus = ballancee + cobblc
Redis:set(Themalath.."boob"..msg.sender_id.user_id , cobonplus)
local ballancee = Redis:get(Themalath.."boob"..msg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballancee)
Redis:del(Themalath.."cobon"..coniss)
Redis:del(Themalath.."cobonum"..coniss)
send(msg.chat_id,msg.id, "⌯ وصل كوبون \n\n⇜ المبلغ : "..cobblc.." درهم 💵\n⇜ رقم الكوبون : `"..coniss.."`\n⇜ رصيدك الان : `"..convert_mony.."` درهم 💵\n✧","md",true)
else
...
Redis:set(Themalath.."boob"..Remsg.sender_id.user_id , bajiop)
ccccc = Redis:get(Themalath.."boobb"..Remsg.sender_id.user_id)
uuuuu = Redis:get(Themalath.."bbobb"..Remsg.sender_id.user_id)
ppppp = Redis:get(Themalath.."rrfff"..Remsg.sender_id.user_id) or 0
ballanceed = Redis:get(Themalath.."boob"..Remsg.sender_id.user_id) or 0
...
Redis:set(Themalath.."tdbelballance"..msg.sender_id.user_id , coniss)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if text == 'تبرع' then
if Redis:ttl(Themalath.."tabrotime" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Themalath.."tabrotime" .. msg.sender_id.user_id))
...
local user_name = bot.getUser(winner_id).first_name or Redis:get(Themalath..winner_id.."first_name:") or "لا يوجد اسم"
tt =  "["..user_name.."]("..user_name..")"
...
Redis:set(Themalath.."boob"..msg.sender_id.user_id , math.floor(byre))
taeswq = Redis:get(Themalath.."tabbroat"..msg.sender_id.user_id) or 0
pokloo = tonumber(taeswq) + tonumber(coniss)
Redis:set(Themalath.."tabbroat"..msg.sender_id.user_id , math.floor(pokloo))
ballanceeed = Redis:get(Themalath.."boob"..winner_id) or 0
tekash = tonumber(ballanceeed) + tonumber(coniss)
Redis:set(Themalath.."boob"..winner_id , tonumber(tekash))
ballanceeed = Redis:get(Themalath.."boob"..winner_id) or 0
Redis:sadd(Themalath.."taza",msg.sender_id.user_id)
Redis:setex(Themalath.."tabrotime" .. msg.sender_id.user_id,600, true)
...
if Redis:sismember(Themalath.."booob",msg.sender_id.user_id) then
ballancee = Redis:get(Themalath.."tabbroat"..msg.sender_id.user_id) or 0
if tonumber(ballancee) < 1 then
...
ballancee = Redis:get(Themalath.."tabbroat"..msg.sender_id.user_id) or 0
local bank_users = Redis:smembers(Themalath.."taza")
if #bank_users == 0 then
return send(msg.chat_id,msg.id,"⇜ لا يوجد حسابات في البنك","md",true)
end
...
tabr_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(Themalath.."tabbroat"..v)
